...
* 세그먼트에 대한 제한 사항은 가상 보고서 세트에도 적용됩니다

   가상 보고서 세트는 보고서 세트에 적용되는 세그먼트에 불과합니다. 각 보고서 세트에는 자체 Data Warehouse과 자체 데이터 피드가 있으므로, 여러 보고서 세트를 사용하면 세그먼트가 제공하지 않는 몇 가지 이점이 있습니다.
* 실시간 보고서
* 설정 및 변수 이름은 전체 보고서 세트에서처럼 사용자 지정할 수 없습니다.
...
## 가상 보고서 세트 및 다중 세트 태그 지정 결합 {#section_026FA3FCD7314DD18220E73EC5702AFF}

경우에 따라 가상 보고서 세트와 다중 세트 태깅을 모두 사용할 수 있습니다.
