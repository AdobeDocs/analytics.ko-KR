...
* **모바일 앱 방문 설정:** [Adobe Mobile SDK](https://www.adobe.io/apis/cloudplatform/mobile.html)를 통해 모바일 앱에서 생성된 데이터가 들어 있는 보고서 세트에 대해 추가적인 방문 설정을 사용할 수 있습니다. 이 설정은 비파괴적이고 Mobile SDK를 통해 수집된 히트에만 영향을 줍니다. 또한 Mobile SDK의 외부에서 수집된 데이터에는 영향을 주지 않습니다.
...
보고서 처리 시간이 기존 Analytics 보고에서 사용 가능한 모든 지표 및 차원을 지원하는 것은 아닙니다. 보고서 처리 시간을 활용하는 가상 보고서 세트는 Analysis Workspace에서만 액세스할 수 있으며 [!UICONTROL Reports &amp; Analytics], Data Warehouse, Report Builder, 데이터 피드 또는 Reporting API에서는 액세스할 수 없습니다.
