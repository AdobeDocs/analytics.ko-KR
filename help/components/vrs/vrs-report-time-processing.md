...
* **(낮은 트래픽) 또는 &quot;고유 수가 초과되었습니다.&quot;를 사용하는 Dimension:** (낮은 트래픽) 라인 항목은 보고서 처리 시간을 사용할 때 약간 다르게 결정되며 기본 보고서 세트에 대해 보고할 때 관찰되는 내용과 일치하지 않을 수도 있습니다. 또한 낮은 트래픽에 속하지 않는 차원 라인 항목은 기본 보고서 세트와 달리 해당 라인 항목에 대한 데이터의 100%를 나타낼 수 없습니다. 이러한 차이는 차원에 고유한 값의 수가 더 많을수록 더 두드러집니다.
