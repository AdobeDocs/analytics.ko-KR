...
1. **[!UICONTROL 공유를 클릭합니다]**.
   ...
   관리자는 **[!UICONTROL 모두]**&#x200B;를 선택하거나 조직의 **[!UICONTROL 그룹]및**&#x200B;사용자]를 선택할 수 있습니다. **[!UICONTROL ** 관리자가 아닌 사용자는 개별 사용자만 볼 수 있습니다. **[!UICONTROL 검색]필드를 사용하여 그룹 또는 사용자를 검색합니다.** 1. **[!UICONTROL 공유]**&#x200B;를 클릭합니다.
