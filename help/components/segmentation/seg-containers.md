...
사용 *Page = 겨울 코트* 아래의 세그먼트 예는 컨테이너 데이터가 적용되는 방식과 데이터 범위가 세그먼트 유형과 일치하는 방식을 기반으로 이 세그먼트의 결과에 대한 예입니다.
...
방문자 컨테이너에서 페이지 보고서는 *Referring Domain equals &quot;aol.com&quot;*&#x200B;이 참인 모든 방문자가 열람한 모든 페이지를 표시합니다. 따라서 방문자에게 *&quot;aol.com&quot;* 내역(정의된 시간 내)에서 언제든지 참조 도메인으로, 방문자 컨테이너의 모든 페이지(다른 방문의 페이지 보기 포함)가 나열됩니다. 기본 조건과 일치하지 않는 페이지도 방문자 컨테이너에 포함되므로 보고서에 표시됩니다. 이전에 발생했고 조건을 특별히 충족하지 않더라도 방문자 컨테이너의 모든 페이지가 보고서에 나열됩니다.

참조 도메인 보고서에서 4개의 페이지 보기에서는 *Referring Domain = &quot;aol.com&quot;*&#x200B;이 적용되지만, 방문자가 방문한 다른 페이지에서는 *Referring Domain = &quot;weather.com&quot;*&#x200B;이 적용됩니다. 방문자 컨테이너에서 &quot;aol.com&quot;이 참인 방문자 목록을 가져옵니다. 하지만 참조 도메인이 세그먼트의 초기 요청과 일치하지 않는 &quot;weather.com&quot; 인 페이지도 제공합니다.

| 방문 1<br/>참조 도메인 = &#39;aol.com&#39; | <br/>페이지 조회수 |
|----|---:|
| 홈 | 1 |
| 겨울용 의류 | 1 |
| 겨울 코트 | 1 |
...
| 방문자 컨테이너<br/>참조 도메인 = &#39;aol.com&#39; | 페이지 조회수 |
|----|---:|
