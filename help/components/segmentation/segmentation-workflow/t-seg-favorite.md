...
즐겨찾기로 세그먼트 목록을 정렬할 수 있습니다. ![세그먼트](/help/assets/icons/Filter.svg) **[!UICONTROL 세그먼트]** 패널에서 **[!UICONTROL 다른 세그먼트]**&#x200B;를 선택하고 **[!UICONTROL 즐겨찾기]**&#x200B;를 선택합니다. 자세한 내용은 [세그먼트 목록](t-seg-filter.md)을 참조하세요.
