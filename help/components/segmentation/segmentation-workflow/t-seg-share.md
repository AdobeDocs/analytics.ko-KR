...
* 관리자는 세그먼트가 팀에게 유용한 비즈니스 가치를 제공하는 경우 특정 **[!UICONTROL 그룹]**&#x200B;과 세그먼트를 공유할 수 있습니다. 이 유형의 세그먼트를 공식적으로 승인하지 마십시오.
* 관리자 또는 개인 사용자로서 다른 개인과 세그먼트를 공유하여 세그먼트를 수정하고 유효성을 확인합니다. 유용하지 않다고 확인되면 삭제할 수 있습니다. 이 유형의 세그먼트를 공식적으로 승인하지 마십시오.
