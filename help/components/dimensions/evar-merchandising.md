...
*이 도움말 페이지에서는 머천다이징 eVar가 차원으로 작동하는 방식을 설명합니다. 머천다이징 eVar 구현 방법에 대한 자세한 내용은 [eVar (머천다이징 변수)](/help/implement/vars/page-vars/evar-merchandising.md) 구현 사용 안내서에서 확인할 수 있습니다.*
