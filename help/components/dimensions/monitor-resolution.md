...
&#39;모니터 해상도&#39; [차원](overview.md) 활성 디스플레이의 높이와 너비를 픽셀 단위로 표시합니다. 이 차원은 방문자에 대한 사이트에서 폴드 (fold)가 있는 위치나 방문자가 브라우저 창을 만들 수 있는 너비를 알려 할 때 유용합니다. 폴드 위치를 알면 콘텐츠를 보는 데 최적화할 수 있습니다.
