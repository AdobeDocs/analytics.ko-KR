...
Adobe은 방문자의 IP 주소에서 서버측에서 이 차원을 파생하여 내부 조회 테이블에 대해 일치시킵니다. Adobe은 IP 주소와 지역 간에 조회를 유지 관리하기 위해 [Digital Element](https://www.digitalelement.com/)와(과) 파트너 관계를 맺고 있습니다. 설정할 변수가 없습니다. 이 차원은 모든 구현에 대해 즉시 작동합니다.
