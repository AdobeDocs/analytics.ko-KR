...
>[!IMPORTANT]
>
>Device Co-op과 관련된 사용자 지표는 2023년 3월 8일부터 더 이상 사용되지 않습니다. 이 페이지에 설명된 CDA 관련 사용자 지표는 여전히 활성 상태입니다.

&#39;사람&#39; [지표](overview.md)은(는) [크로스 디바이스 분석](../cda/overview.md) 가상 보고서 세트와 관련이 있습니다. 보고서에서 확인된 개인 사용자의 합계와 개인의 소유로 확인되지 않은 디바이스의 수를 나타냅니다.
