...
* [[!UICONTROL 광고 완료]](https://experienceleague.adobe.com/ko/docs/media-analytics/using/reporting/metrics/ad-completes)
* [[!UICONTROL 광고 시작]](https://experienceleague.adobe.com/ko/docs/media-analytics/using/reporting/metrics/ad-starts)
* [[!UICONTROL 광고 체류 시간]](https://experienceleague.adobe.com/ko/docs/media-analytics/using/reporting/metrics/ad-time-spent)
* [[!UICONTROL 미디어 체류 시간]](https://experienceleague.adobe.com/ko/docs/media-analytics/using/reporting/metrics/media-time-spent)
