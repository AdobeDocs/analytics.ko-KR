...
| 지표 | 정의 | 사용할 수 있는 곳 |
|---|---|---|
| [[!UICONTROL 총 체류 시간 (초)]](total-seconds-spent.md) | 방문자가 특정 차원 항목과 상호 작용하는 총 시간을 나타냅니다. 모든 후속 히트에서의 값 및 지속성 인스턴스를 포함합니다. Prop의 경우, 체류 시간은 후속 링크 이벤트에서도 계산됩니다. | Analysis Workspace, Report Builder(&#39;총 체류 시간&#39;이라고 함), Data Warehouse |
...
| 차원 | 정의 | 사용할 수 있는 곳 |
| --- | --- | --- |
| [[!UICONTROL 방문당 체류 시간 - 세부기간]](../dimensions/time-spent-per-visit.md) | 방문하는 동안 소요된 총 시간을 가장 가까운 두 번째 방문으로 자르며, 방문에 포함되는 모든 조회에 적용합니다. 방문 수준 차원입니다. | Analysis Workspace |
...
| [[!UICONTROL 페이지 체류 시간 - 세부기간]](../dimensions/time-spent-on-page.md) | 각 조회에서 소요된 총 시간을 가장 가까운 두 번째 방문으로 자릅니다. 페이지 보기 수와 링크 이벤트를 모두 포함하는 히트 수준 차원입니다. 이 차원의 이름에도 불구하고 이 차원은 &quot;페이지&quot; 차원으로 제한되지 않습니다. | Analysis Workspace |
