...
| [!UICONTROL 페이지에서 보낸 평균 시간] | 더 이상 사용되지 않는 지표.Adobe <br> 대신, 차원 항목에 대한 평균 시간이 필요한 경우 [[!UICONTROL 사이트에서 보낸 평균 시간]](average-time-on-site.md)을 사용하는 것이 좋습니다. | Report Builder (요청에 차원이 있을 때) |
...
+++[!UICONTROL 사이트에서 보낸 평균 시간]은 방문당 체류 시간과 어떻게 다릅니까?
