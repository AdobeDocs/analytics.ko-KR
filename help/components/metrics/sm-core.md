...
스트리밍 미디어 서비스 핵심 지표는 스트리밍 미디어 컬렉션 라이브러리를 통해 수집된 데이터에 대한 기본 보고 기능을 제공합니다. 이러한 지표를 사용하려면 **[!UICONTROL 스트리밍 미디어용 Adobe Analytics 추가 기능]**&#x200B;이 필요합니다. 자세한 내용은 Adobe 계정 팀에 문의하십시오.

이 지표를 사용하려면 보고서 세트에 대해 [[!UICONTROL 미디어 보고]](/help/admin/tools/manage-rs/edit-settings/media-management.md)에서 **[!UICONTROL 미디어 코어]**&#x200B;을(를) 사용하도록 설정하십시오.
