...
Analysis Workspace에서 지표를 사용하는 방법에 대한 자세한 내용은 [지표](/help/analyze/analysis-workspace/components/apply-create-metrics.md)의 “Analysis Workspace에서 지표 사용”을 참조하십시오.
