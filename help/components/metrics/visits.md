...
* **100초에 100히트**: 방문의 처음 100초에 발생하는 히트가 100개가 넘는 경우 방문이 자동으로 끝납니다. 이 동작은 일반적으로 보트 활동을 나타내며, 보고서 성과를 높이기 위해 이 제한이 적용됩니다.
...
* 대상 [가상 보고서 세트](../vrs/vrs-about.md)를 사용하여 방문 시간 초과를 변경할 수 있습니다 [!UICONTROL 방문 시간 초과] 드롭다운 목록. 방문 시간 초과를 임의의 합리적인 값으로 변경할 수 있습니다.
