...
각 [사용자](people.md)(확인되거나 미확인된)을 고려하여, 히트에 [ 쿼리 문자열이 포함된 경우 이 ](overview.md)지표`mid`이(가) 증가합니다([`s_ecid`](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-analytics.html) 쿠키 기반).
