...
[계산된 지표 빌더](/help/components/calculated-metrics/workflow/c-build-metrics/cm-build-metrics.md)를 사용하면 통계 및 수학 함수를 적용할 수 있습니다. 이 문서는 고급 함수 및 그 정의를 알파벳 순서로 나열한 것입니다.
