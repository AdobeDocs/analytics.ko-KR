...
* **분류 세트**&#x200B;는 데이터를 분류하는 기본 구성 요소입니다. [분류 세트](/help/components/classifications/sets/overview.md)를 사용하면 간소화된 단일 인터페이스로 분류를 만들고 관리할 수 있습니다.

* **이전 분류**&#x200B;는 데이터를 분류하는 이전 분류 방법을 문서화합니다. 이 방법은 더 이상 사용되지 않으며 2026년 8월 31일 이후 더 이상 액세스할 수 없습니다.
