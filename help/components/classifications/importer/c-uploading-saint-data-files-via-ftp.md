...
월 고유 수를 초과하는 경우, 초과한 고유 값에 해당하는 분류 데이터는 보고에 표시되지 않습니다. Data Warehouse에서 해당 분류를 볼 수 있습니다.
...
>[!NOTE]
>
>가져오기에서 분류를 변경하지 않으면 알림이 전송되지 않습니다. 이메일은 성공적인 이메일 전송으로 분류가 변경되는 경우에만 전송됩니다.
