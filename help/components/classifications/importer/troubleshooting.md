...
* **.tab 또는 .txt 파일 대신 스프레드시트(.xlsx)를 업로드합니다**.잘못된 형식으로 분류 파일을 업로드할 때 *&quot;첫 번째 열은 키가 되어야* 합니다&quot;라는 오류 메시지가 표시될 수 있습니다. 분류 가져오기에서 .xls 또는 .xlsx 파일을 처리하는 방법을 알지 못합니다. Excel의 &#39;다른 이름으로 저장&#39; 대화 상자에서는 올바른 다른 이름으로 저장 유형을 설정하십시오.
