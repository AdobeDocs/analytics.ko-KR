...
| 열 | 설명 |
|---|---|
| **[!UICONTROL 분류 집합]** | 분류 세트의 이름입니다. [분류 집합을 편집](create-set.md#edit-a-classification-set)할 이름을 선택하십시오. |
...
* ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL 새로 만들기]**&#x200B;를 선택하여 [새 분류 집합을 만들기](create-set.md#create-a-classification-set)합니다.
...
분류 집합 목록을 필터링할 수 있는 필터 패널 ➍을(를) 표시하려면 ![필터](/help/assets/icons/Filter.svg)를 선택하십시오. 다음을 필터링할 수 있습니다.
