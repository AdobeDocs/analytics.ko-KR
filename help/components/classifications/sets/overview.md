...
이 메뉴 항목을 보려면 제품 관리자이거나 권한 항목 [!UICONTROL 보고서 세트 도구] > [!UICONTROL 분류]를 포함하는 제품 프로필에 속해 있어야 합니다. 이전 분류 관리 인터페이스는 [!UICONTROL 관리자] 메뉴에 있지만 분류 세트는 [!UICONTROL 구성 요소] 메뉴에 있습니다.
