...
* [**[!UICONTROL 분류 세트]**](manage-sets.md): 분류 세트를 작성, 편집 및 삭제합니다.
...
1. 하나 이상의 보고서 세트와 제품을 식별하는 키 차원 조합에 대한 구독이 포함된 [분류 세트를 만듭니다](/help/components/classifications/sets/create-set.md). 예:
