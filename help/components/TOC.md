...
+ 세그먼테이션 {#segmentation}
   ...
   + {hide-from-toc}[하위 히트 분석](segmentation/sub-hit.md)
...
+ 분류 {#classifications}
   ...
   + 분류 세트 {#sets}
      ...
      + [만들기 및 편집](/help/components/classifications/sets/create-set.md)
      + [관리](/help/components/classifications/sets/manage-sets.md)
      + 분류 세트 {#set}
...
+ 위치 {#locations}
   ...
   + [클라우드 계정 구성](/help/components/locations/configure-import-accounts.md)
   + [클라우드 위치 구성](/help/components/locations/configure-import-locations.md)
