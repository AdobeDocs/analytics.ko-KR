...
Device Graph 방법을 사용하여 크로스 디바이스 분석을 구현하려는 경우 다음 조건을 충족해야 합니다. 조직 내 팀 및 Adobe 계정 팀과 협력하여 다음 사항을 모두 충족하도록 하십시오.
...
* 조직은 [Adobe Experience Platform Identity 서비스 개인 그래프](https://business.adobe.com/products/experience-platform/identity-service.html). 다음을 참조하십시오. [홈 페이지](https://experienceleague.adobe.com/docs/experience-platform/sources/home.html?lang=ko-KR) 을 참조하십시오.
* 구현에서 최신 버전의 ECID(Experience Cloud ID 서비스)를 사용해야 합니다. 자세한 내용은 [홈 페이지](https://experienceleague.adobe.com/docs/id-service/using/home.html) 를 참조하십시오. 를 사용하는 대부분의 구현 [태그](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html) Adobe Experience Platform에서 이미 ID 서비스를 배포했을 수 있습니다.
