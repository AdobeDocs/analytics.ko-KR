...
[사용자 지정 방문자 ID](/help/implement/js-implementation/c-unique-visitors/visid-custom.md)는 [장치 간에 사용자를 연결](/help/implement/js-implementation/xdevice-visid/xdevice-connecting.md)하는 이전 방법입니다. 사용자 지정 방문자 ID를 사용하는 경우 이 `s.visitorID` 변수를 사용하여 방문자 로직에 사용되는 ID를 명시적으로 설정합니다. 이 `s.visitorID` 변수는 존재하는 쿠키 기반 ID를 무시합니다. 자세한 내용은 구현 사용 안내서의 [고유 방문자 식별](/help/implement/js-implementation/c-unique-visitors/visid-overview.md)을 참조하십시오.
