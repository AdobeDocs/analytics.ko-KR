...
* **사용자 기반 세그먼트**: 장치별 데이터를 볼 수 있는 세그먼트 드롭다운 목록이 포함되어 있습니다. 이 패널에서는 디바이스 유형을 포함하거나 제외하는 것이 보고서에 어떤 영향을 미치는지 세그먼트로 실험해 볼 것을 권장합니다.
* **크로스 디바이스 움직임 분석**: 디바이스 유형에 따라 플로우 및 폴아웃 보고서를 제공합니다.
* **크로스 디바이스 속성**: 여정 IQ와 기여도 분석의 기능을 결합합니다.
