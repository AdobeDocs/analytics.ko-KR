...
## 고객 지원 센터에서 티켓을 열어 CDA가 크로스 디바이스 보고서 세트에서 프로비저닝되도록 합니다.

CDA는 Adobe 엔지니어링 팀을 통해 크로스 디바이스 보고서 세트에 생성됩니다. 이 프로세스를 시작하려면 고객 지원 센터에 연락하여 다음 정보를 제공해야 합니다.
...
고객 지원 센터에 이 정보를 제공하면, 고객 지원 센터는 CDA 처리를 위해 선택한 보고서 세트를 사용하도록 Adobe 엔지니어링 팀과 협력하게 됩니다.
