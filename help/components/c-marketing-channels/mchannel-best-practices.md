...
마케팅 채널 차원은 기존 방문 정의(처리 규칙으로 정의됨)에 따라 다르므로 이 차원의 방문 정의는 가상 보고서 세트를 사용하여 변경할 수 없습니다. 이러한 수정된 사례는 Attribution IQ 및 Customer Journey Analytics을 통해 명확하고 통제된 전환 확인 기간을 가능하게 합니다.
