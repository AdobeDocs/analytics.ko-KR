...
* [내부](/help/components/c-marketing-channels/c-rules.md) 히트 및 [직접](/help/components/c-marketing-channels/c-rules.md) 히트 카테고리에 대한 채널을 포함시키십시오.
...
Adobe는 [자동 설정](/help/components/c-marketing-channels/c-getting-started-mchannel.md) 중에 사전 정의된 여러 채널을 제공하는데 이 채널은 사용자의 요구 사항에 맞게 편집할 수 있습니다. 또한, 이 설정을 수정하고 [마케팅 채널 처리 규](/help/components/c-marketing-channels/c-rules.md) 내에서 사용자 지정 규칙을 정의할 수 있습니다.
