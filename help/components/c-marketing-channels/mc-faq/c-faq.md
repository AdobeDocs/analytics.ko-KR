...
1. **[!UICONTROL Referrer]** 및 **[!UICONTROL Does Not Exist]** 를 **[!UICONTROL Is First Page of Visit]**&#x200B;참조하십시오. [직접 방문](/help/components/c-marketing-channels/mc-faq/c-faq.md) 참조.

2. **[!UICONTROL Referrer Matches Internal URL Filters]** 및 **[!UICONTROL Is First page of Visit]**. ([내부 방문](/help/components/c-marketing-channels/mc-faq/c-faq.md) 참조)

3. **[!UICONTROL Referrer]** 및 **[!UICONTROL Exists]** 를 **[!UICONTROL Referrer Does Not Match Internal URL Filters]**&#x200B;참조하십시오.

끝으로, [식별된 채널 없음](/help/components/c-marketing-channels/mc-faq/c-faq.md#no-channel-identified)에 설명된 대로, 나머지 히트를 캡처하는 *다른* 채널을 만듭니다.
