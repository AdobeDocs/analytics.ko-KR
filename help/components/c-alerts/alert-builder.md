...
* 보고서 내에서 > [!UICONTROL Reports & Analytics] 로 **[!UICONTROL More]** **[!UICONTROL Add Alert]**&#x200B;이동합니다.
...
* &quot;예외 항목 초과&quot;는 기존(정적) 임계값을 벗어나는 새로운 조건입니다. 트리거를 동적으로 정의하는 예외 항목 탐지 알고리즘을 가져옵니다. 90%, 95%, 99%, 99.75% 및 99.9%의 임계값을 설정할 수 있습니다.
* 시간별 세부기간은 99.75% 임계값으로 설정되며 일별 세부기간은 99%로 설정됩니다.
* 계산된 지표를 사용할 수도 있습니다.
