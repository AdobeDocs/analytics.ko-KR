...
1. 다음 옵션을 지정하여 경고를 구성합니다.
   ...
   | [!UICONTROL **시간 세부기간**] | 지표를 확인할 빈도를 시간별, 일별, 주별 또는 월별 중에서 선택합니다.<p><b>참고:</b>사용자 지정 달력이 있는 데이터 보기의 경우 경고 빌더에서 월별 세부기간을 지원하지 않습니다.<!--true?--></p> |
