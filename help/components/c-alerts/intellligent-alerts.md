...
<table id="table_B3AA85E1DE3543DCA34966A52E3CE4AB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Workspace에서는 얻을 수 없지만 Report Builder에서는 얻을 수 있습니다(<a href="https://www.youtube.com/watch?v=-a-8W6GQZnU"  >Report Builder의 예외 항목 탐지</a>에서 이 비디오 참조 ). </p> <p>Report Builder는 보다 덜 복잡한 예외 항목 탐지 방법을 사용한다는 점을 기억하십시오. 이 방법은 고정된 30일 교육 기간, 고정된 95% 간격을 사용하며 <a href="https://marketing.adobe.com/resources/help/ko_KR/reference/anomaly.html"  > <span class="uicontrol">Reports &amp; Analytics</span> 예외 항목 탐지</a>와 유사합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
