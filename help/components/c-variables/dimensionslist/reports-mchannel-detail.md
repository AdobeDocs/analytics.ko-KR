...
이 보고서는 사이트에 가장 효과적인 특정 캠페인이나 키워드에 대한 인사이트를 제공합니다. 이 보고서를 사용하면 성공 지표 및 매출액을 전반적인 해당 채널과 상관없이 다양한 채널 세부 사항에 할당할 수 있습니다. 예를 들어 특정 유료 검색 키워드를 이메일 캠페인과 비교하는 방법을 볼 수 있습니다. 마케팅 채널 개요 보고서와는 대조적으로, 이 보고서는 표준 보고서와 유사합니다.
...
* *첫 번째 터치*&#x200B;와 *마지막 터치*&#x200B;의 차이점은 [마케팅 채널 보고서 정보](/help/components/c-marketing-channels/analyze-mc.md)에 나와 있습니다.
