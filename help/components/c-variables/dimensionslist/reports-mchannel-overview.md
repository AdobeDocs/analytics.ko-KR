...
* 이 보고서는 마케팅 채널 [처리 규칙](/help/components/c-marketing-channels/c-rules.md)에 의해서만 결정됩니다. 이러한 규칙을 변경하면 보고서의 데이터를 계산하는 방법이 변경됩니다.
...
* [분류](/help/components/c-classifications2/c-classifications.md)를 사용하면 라인 항목을 통합하고 이름을 변경할 수 있습니다.
* 이 보고서에서는 조직 및 보고서 세트 설정에 따라 다음 지표를 사용할 수 있습니다.

   * ****&#x200B;클릭스루: *`s.campaign`* 변수가 정의된 횟수.
   * [새 참여 횟수](https://docs.adobe.com/content/help/ko-KR/analytics/components/variables/metrics/metrics-new-engagements.html): 새로 첫 번째 터치 채널을 받은 방문자의 수
   ...
   * **예산** 및 **비용**: 마케팅 채널에 해당되는 지표. [비용 및 예산](https://docs.adobe.com/content/help/ko-KR/analytics/components/marketing-channels/analyze-mc.html)을 참조하십시오.
