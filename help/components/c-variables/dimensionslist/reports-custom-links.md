...
[모바일 SDK](https://marketing.adobe.com/resources/help/en_US/mobile/home.html)에서는 사용자 지정 링크를 사용하여 작업 및 라이프사이클 지표를 추적합니다. 모바일 앱을 측정하는 데 사용되는 보고서 세트에서는 SDK에서 설정된 다음 링크 이름을 볼 수도 있습니다.
