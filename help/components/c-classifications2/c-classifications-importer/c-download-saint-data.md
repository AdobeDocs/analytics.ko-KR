...
| Numeric 2 내보내기 | 가져오기를 통해 Numeric 2 분류를 시스템으로 가져올 수 있습니다. Numeric 2 분류는 [!UICONTROL 마케팅 채널] 보고서의 비용 및 예산 가치 등 여러 항목에 대한 시간에 따라 변하는 변수에 유용합니다. Numeric 2 분류를 사용한 데이터 업로드에 대한 내용은 [Numeric 2 분류](/help/components/c-classifications2/c-numeric-2/c-numeric-2-classifications.md)를 참조하십시오. |
