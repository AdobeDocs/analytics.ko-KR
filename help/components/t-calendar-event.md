...
1. 클릭 **[!UICONTROL Analytics]** > **[!UICONTROL Components]** > **[!UICONTROL Calendar Events]**.
1. 클릭 **[!UICONTROL Add New]**.
   1. **[!UICONTROL Title]**&#x200B;에서 달력 이벤트 이름을 지정합니다.
   1. 활동에 대한 **[!UICONTROL Event Date]**.
   1. 이 이벤트가 적용되는 **[!UICONTROL Report Suite]**&#x200B;를 선택합니다.
   1. (선택 사항) 이 이벤트 에 대해 **[!UICONTROL Note Text]**&#x200B;를 추가합니다.
   1. 표시 아이콘 및 색상을 선택합니다.
   1. 클릭 **[!UICONTROL Save]**.
1. (선택 사항) 달력 이벤트는 공유되지 않는 한 사용자별로 다릅니다. 이 이벤트를 공유하려면 **[!UICONTROL Share]**&#x200B;를 선택합니다.
1. (선택 사항) 캘린더 이벤트를 사용자에게 적용합니다. 이제 공유됨으로 표시된 달력 이벤트에는 다른 사용자에게 &quot;전달&quot;하는 옵션이 있습니다. 달력 이벤트를 적용하면 이 이벤트가 받는 사용자의 트렌드 및 시간별 그래프에 나타납니다.
   ...
   1. **[!UICONTROL Check All]**&#x200B;을 클릭하거나 사용자 이름의 옆에 있는 상자를 선택합니다.
   1. 클릭 **[!UICONTROL Save]**.
   이렇게 되면 달력 이벤트를 훨씬 다양하게 사용할 수 있게 됩니다. 이제 분석가는 사용자의 보고서에 오버레이를 적용하여 더 많은 컨텍스트를 제공할 수 있습니다.
1. 클릭 **[!UICONTROL Analytics]** > **[!UICONTROL Components]** > **[!UICONTROL Calendar Events]**.
1. **[!UICONTROL Shared Calendar Events]**&#x200B;에서 다음 옵션 중 하나를 지정합니다.
