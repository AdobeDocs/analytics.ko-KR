...
1. Analysis Workspace에서 프로젝트를 연 상태에서 **[!UICONTROL 프로젝트]**&#x200B;를 선택하고 다음 옵션 중에서 선택합니다.
   ...
   | **[!UICONTROL 회사 보고서로 저장]** | 프로젝트를 다음으로 저장 [회사 보고서](/help/analyze/analysis-workspace/reports/create-company-reports.md) 다음 기간 내에 조직에서 사용할 수 있게 됩니다. **[!UICONTROL 프로젝트 > 새로 만들기]** |
