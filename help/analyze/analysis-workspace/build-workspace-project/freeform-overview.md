...
When you first go to **[!UICONTROL Analytics]** > **[!UICONTROL Workspace]**, the page lists all the projects you own or have been shared to you. 이전에 사용자 지정 랜딩 페이지를 설정하지 않은 한 이 페이지는 Adobe Analytics의 랜딩 페이지입니다.
...
| 요소 | 설명 |
|---|---|
| [새 프로젝트 만들기](/help/analyze/analysis-workspace/home.md) | 이 링크를 클릭하여 새 프로젝트를 처음부터 시작하거나 대신 만든 [템플릿을](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=en#analysis-workspace) 통해 시작할 수 있습니다. |
...
| [자습서 보기](https://docs.adobe.com/content/help/en/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-introduction.html) | Analysis Workspace 비디오 튜토리얼을 살펴봅니다. |
| 이름 | 작업 공간 프로젝트의 이름. |
| 소유자 | 이 프로젝트를 만든 사람(귀하 또는 프로젝트를 귀하와 공유한 사용자) |
| 유형 | 이것이 작업 공간 프로젝트인지 [모바일 스코어카드인지를 나타냅니다](https://docs.adobe.com/content/help/ko-KR/analytics/analyze/mobapp/home.html). |
| [프로젝트 역할](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/share-projects.html) | 소유자, 편집, 복제, 보기 등 프로젝트의 역할을 나타냅니다. |
| 태그 | 프로젝트에 적용된 태그입니다. |
...
| 템플릿 | 마지막 작업을 실행 취소 또는 다시 실행합니다. 모두 지우기를 사용하면 프로젝트가 빈 시작점으로 재설정됩니다. |
...
| 도움말 | 도움말 문서, 비디오 및 Analytics [Experience League 커뮤니티에 액세스할 수 있습니다](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics/ct-p/adobe-analytics-community). 작업 공간 팁과 [디버거의 가시성을 관리합니다](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/reporting-tricks.md). 프로젝트 [성능에 영향을 주는 작업 공간 및 요소에 대한 세부 정보를 확인할 수 있습니다](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/optimizing-performance.html). |
| 공유 단추 또는 소유자 | 프로젝트에 대해 [자체] 또는 [편집]을 사용하고 있는 경우 오른쪽 상단의 [공유] 단추를 사용하면 한 번의 클릭으로 프로젝트 받는 사람을 관리할 수 있습니다. 프로젝트의 복제 또는 보기 역할을 하는 경우 프로젝트 소유자의 이름이 표시됩니다. |
...
| [프로젝트 색상 팔레트](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/color-palettes.html) | Workspace에서 사용되는 카테고리 색상 팔레트를 변경하거나 색맹용으로 최적화된 기본 팔레트에서 선택하거나 사용자 정의 팔레트를 지정하여 변경할 수 있습니다. 이 기능은 대부분의 시각화를 포함하여 작업 공간의 많은 사항에 영향을 줍니다. |
...
Within a project, [panels](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/panels.html), tables, [visualizations](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.html), and [components](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/components/analysis-workspace-components.html) are accessed from the left rail. 이는 프로젝트 구성 요소입니다.

또한 [빈 패널에서도 시각화 및 패널에 액세스할](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/blank-panel.html) 수 있습니다.
...
패널은 기간, 보고서 세트 또는 분석 사용 사례에 따라 프로젝트를 구성할 때 유용합니다. 활성 패널에는 파란색 테두리가 표시되어 왼쪽 레일에 사용할 수 있는 구성 요소를 결정합니다.
...
| 작업 | 설명 |
|---|---|
| 이벤트가 복제되지 않도록 하면서 현재 이벤트 변수에  | 처음부터 새로 만들거나 [템플릿에서](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html)시작할 수 있습니다. |
...
| 삭제 | 프로젝트를 삭제합니다. |
| 이름 변경 | 프로젝트 이름을 편집합니다. |
| 복사 | 프로젝트의 복사본을 만듭니다. 그러면 새 프로젝트 및 프로젝트 ID가 만들어집니다. 원본 프로젝트에 연결된 공유 또는 일정은 복사되지 않습니다. |
