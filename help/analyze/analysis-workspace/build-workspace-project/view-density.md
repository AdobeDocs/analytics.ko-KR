...
조정 [!UICONTROL 보기 밀도] 자유 형식 테이블 및 집단 테이블에서 왼쪽 레일의 수직 안쪽 여백을 줄여 화면에서 더 많은 데이터를 볼 수 있습니다. 라디오 단추를 통해 보기 밀도를 토글할 때 다음과 같은 3개의 선택 사항이 표시됩니다.
...
다음은 사용에 대한 비디오입니다 [!UICONTROL 보기 밀도]:
