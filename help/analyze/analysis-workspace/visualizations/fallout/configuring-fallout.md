...
<table id="table_A91D99D9364B41929CC5A5BC907E8985"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>방문자 수(또는 방문 횟수)는 경로에 있는 다음 터치포인트에 최종적으로 도달할 때 계산됩니다. 터치 포인트 사이에 우회가 허용됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>다음 히트 </p> </td> 
   <td colname="col2"> <p>방문자 수(또는 방문 횟수)는 경로에 있는 다음 터치포인트에 즉시 도달할 때 계산됩니다. 다음 히트에는 히트 유형(페이지 조회수 또는 링크)이 포함됩니다. 터치 포인트 사이에 우회는 허용되지 않습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
