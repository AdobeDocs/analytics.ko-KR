...
1. (조건부) 여러 열을 동시에 편집하려면 Shift 키를 누른 상태에서 편집할 각 열을 선택합니다.

1. 편집할 열 위로 마우스를 가져간 다음 톱니바퀴 아이콘을 선택합니다.

   여러 열을 선택한 경우 선택한 열에 대한 톱니바퀴 아이콘을 클릭합니다. 변경한 내용은 선택한 모든 열에 적용됩니다.

   ![](assets/column_settings.png)

1. 계속 [열 설정](#column-settings).
...
| 예외 항목 | 이 열의 값에 대해 예외 항목 탐지가 실행되는지 여부를 결정합니다. 자세한 내용은 [Analysis Workspace에서 예외 항목 보기](/help/analyze/analysis-workspace/virtual-analyst/c-anomaly-detection/view-anomalies.md). |
...
Analysis Workspace은 거의 모든 지표에 대한 [속성](/help/analyze/analysis-workspace/attribution/overview.md)을 지원합니다.
