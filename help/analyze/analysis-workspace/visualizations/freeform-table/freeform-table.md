...
**[!UICONTROL **&#x200B;여기에 지표 삭제&#x200B;**]**&#x200B;에서 **[!UICONTROL **&#x200B;방문 횟수&#x200B;**]** 지표를 삭제하면 자유 형식 테이블이 선택한 일정 기간의 일별 방문 횟수로 자동으로 채워집니다.

![자유 형식 테이블 방문](assets/freeform-table-2.png)

그런 다음 **[!UICONTROL **&#x200B;페이지&#x200B;**]** 차원을 끌어 **[!UICONTROL **&#x200B;일&#x200B;**]** 차원 열을 바꾸면 자유 형식 테이블에 각 페이지의 방문이 자동으로 반영됩니다.

![페이지 자유 형식 테이블별 방문](assets/freeform-table-3.png)

그런 다음 **[!UICONTROL ** category:5 **]** 행에 **[!UICONTROL **&#x200B;마케팅 채널&#x200B;**]** 차원을 놓아 **[!UICONTROL ** category:5 **]** 페이지를 분류할 수 있습니다.

![페이지 자유 형식 테이블별 방문 수 분석](assets/freeform-table-4.png)


## 자동화된 테이블

위에서 보듯이 테이블을 만드는 가장 빠른 방법은 구성 요소를 빈 프로젝트, 패널 또는 자유 형식 테이블에 직접 놓는 것입니다. 자유 형식 테이블은 권장 형식으로 자동으로 만들어집니다. [튜토리얼을 확인하십시오](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/auto-build-freeform-tables-in-analysis-workspace.html?lang=ko-KR).

![](assets/automated-table.png)

## 자유 형식 테이블 빌더

먼저 테이블에 여러 구성 요소를 추가한 다음 데이터를 렌더링하려는 경우 자유 형식 테이블 빌더를 활성화할 수 있습니다. 빌더를 활성화한 상태에서 많은 차원, 분류, 지표 및 세그먼트를 끌어다 놓아 보다 복잡한 질문에 대한 답변을 제공하는 표를 작성할 수 있습니다. 데이터는 즉시 업데이트되지 않고 **[!UICONTROL 빌드]**&#x200B;를 클릭하면 업데이트됩니다.
