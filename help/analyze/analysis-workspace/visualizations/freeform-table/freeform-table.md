...
그러면 **[!UICONTROL **&#x200B;페이지&#x200B;**]** 바꿀 차원 **[!UICONTROL **&#x200B;일&#x200B;**]** 차원 열의 자유 형식 테이블은 각 페이지에 대한 방문을 자동으로 반영합니다.
...
먼저 테이블에 여러 구성 요소를 추가한 다음 데이터를 렌더링하려는 경우 자유 형식 테이블 빌더를 활성화할 수 있습니다. 빌더를 활성화한 상태에서 많은 차원, 분류, 지표 및 세그먼트를 끌어다 놓아 더 복잡한 질문에 대한 답변을 제공하는 표를 작성할 수 있습니다. 데이터는 즉시 업데이트되지 않고 **[!UICONTROL 빌드]**.
...
* 마우스 오른쪽 단추 클릭 > **[!UICONTROL 프로젝트 > 항목을 CSV로 다운로드]** 선택한 차원에 대해 최대 50,000개의 차원 항목을 내보냅니다.
