...
| 이동 평균 | 평균 세트를 기반으로 매끄러운 트렌드를 만듭니다. 여기에는 7일의 이동 평균 또는 4주의 이동 평균이 포함됩니다. 롤링 평균이라고도 하는 이동 평균은 이전 범위의 평균을 계산하고, 트렌드 라인 데이터 포인트로 사용한 다음 다음 반복하기 위해 다음 기간으로 이동합니다. &#39;마침표&#39; 입력은 전체 평균을 계산하는 범위를 정의합니다. |
