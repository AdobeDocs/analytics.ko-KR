...
| 시각화 이름 | 설명 |
|---|---|
| [영역](/help/analyze/analysis-workspace/visualizations/area.md) | 선 그래프 모양이며 선 아래에 색칠된 영역이 있습니다. 여러 개의 지표가 있고 두 개 이상 지표의 교차 지점으로 표시되는 영역을 시각화하려는 경우 영역 그래프를 사용하십시오. |
