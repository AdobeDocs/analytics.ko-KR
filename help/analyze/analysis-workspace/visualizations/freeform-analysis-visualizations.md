...
| 시각화 이름 | 설명 |
| --- | --- |
| [영역](/help/analyze/analysis-workspace/visualizations/area.md) | 선 그래프처럼 표시되지만 선 아래에는 색상 영역이 표시됩니다. 여러 개의 지표가 있고 두 개 이상 지표의 교차 지점으로 표시되는 영역을 시각화하려는 경우 영역 그래프를 사용하십시오. |
...
| [폴아웃](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md) | 폴아웃 보고서는 방문자가 페이지의 사전 정의된 순서를 떠나고(폴아웃) 계속 따라가는(폴스루) 위치를 보여줍니다. 최종 또는 정확한 시퀀스로 설정 가능 |
...
| [히스토그램](/help/analyze/analysis-workspace/visualizations/histogram.md) | 히스토그램은 방문자, 방문 또는 히트를 지표 볼륨을 기반으로 버킷으로 버킷합니다. |
...
| [요약 번호](/help/analyze/analysis-workspace/visualizations/summary-number-change.md) | 선택한 셀을 큰 숫자로 표시합니다. |
| [요약 변경](/help/analyze/analysis-workspace/visualizations/summary-number-change.md) | 선택한 셀 간의 변경 내용을 1 큰 숫자/퍼센트로 표시합니다. |
...
시각화 범례는 소스 테이블의 날짜를 시각화에서 계열을 표시하는 데 도움이 됩니다. 범례는 대화형입니다. 시각화에서 범례 항목을 클릭하여 시리즈를 표시하거나 숨길 수 있습니다. 시각화 중인 데이터를 단순화하려는 경우 유용합니다.

또한 범례 레이블의 이름을 변경하여 비주얼을 보다 소비할 수 있도록 할 수 있습니다. Note: legend editing does **not** apply to: Treemap, Bullet, Summary Change/Number, Text, Freeform, Histogram, Cohort or Flow visualizations.
...
| 시각화 링크 가져오기 | 프로젝트 내의 특정 시각화로 사람을 안내할 수 있습니다. 링크를 클릭하면 수신자는 연결된 정확한 시각화로 이동되기 전에 로그인해야 합니다. |
| 시작 | (흐름, 벤, 히스토그램에 사용) 현재 시각화에 대한 구성을 삭제하여 처음부터 다시 구성할 수 있습니다. |
