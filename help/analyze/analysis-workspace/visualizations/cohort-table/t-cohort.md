...
Analysis Workspace의 다른 시각화와 마찬가지로 집단 시각화를 CSV 또는 PDF 파일로 다운로드할 수 있습니다. 자세한 내용은 [PDF 또는 CSV 파일 다운로드](/help/analyze/analysis-workspace/curate-share/download-send.md)를 참조하십시오.
