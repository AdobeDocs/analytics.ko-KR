...
| --- | --- | --- |
| [!UICONTROL 시스템 오류가 발생했습니다. 도움말 > **[!UICONTROL 지원 티켓 제출]** 아래에 고객 지원 요청을 로그인하여 오류 코드를 포함시키십시오.] | Adobe에서 해결해야 하는 문제가 발생했습니다. | 오류 코드를 고객 지원 센터에 제출합니다. |
| [!UICONTROL 오류 500:페이지를 로드하지 못했습니다.] | 회사 [방화벽 설정](https://docs.adobe.com/content/help/en/analytics/technotes/ip-addresses.html)등 로컬 네트워크 문제가 이 오류에 기여하고 있습니다. 또한 Adobe에 해결해야 하는 문제가 발생할 수 있습니다. | 몇 분 후에 다시 로그인하십시오. 문제가 지속되면 EIM 인스턴스 ID 코드를 고객 지원 센터에 제출합니다. |
