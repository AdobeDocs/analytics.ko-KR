...
| [!UICONTROL 이 차원은 현재 기본이 아닌 속성 모델을 지원하지 않습니다.] | 기본 속성이 아니면 사용 중인 차원이 지원되지 않습니다. | 테이블의 차원을 [속성 ](/help/analyze/analysis-workspace/attribution/overview.md)와 호환되는 차원으로 바꿉니다. |
