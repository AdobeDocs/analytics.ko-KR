...
| 확장된 시각화(전체 시각화 중) | 프로젝트의 총계에서 확장된 표 및 시각화의 수입니다. 숨겨진 데이터 소스를 제외합니다. 가이드라인은 15개다. | 프로젝트를 단순화하는 단계를 수행한 후 로드 시 볼 필요가 없는 프로젝트의 시각화를 축소합니다. 보고서 소비자에게 가장 중요한 시각 효과를 우선시하고 필요한 경우 지원 시각적 요소를 보다 세부적인 별도 패널이나 프로젝트로 분류할 수 있습니다. |
