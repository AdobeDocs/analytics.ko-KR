...
| [!UICONTROL 만료 날짜] | 예약된 프로젝트 빈도에 대해서는 최대 1년간 향후에 만료 날짜를 설정할 수 있습니다. |
...
예약된 프로젝트 관리자는 특정 사용자가 만든 항목을 보여 줍니다. 애플리케이션에서 사용자 계정이 비활성화된 경우 모든 예약된 게재가 중지됩니다. 예약된 프로젝트 소유권은 **관리 > Analytics 사용자 및 에셋 > 에셋 전송**&#x200B;에서 새 사용자에게 **양도**&#x200B;할 수 있습니다.
