...
| 기능 | Target 날짜 | 설명 |
| --- | --- | --- |
| 구성 요소 선택 | 2021년 2월 4일 | 빠른 통찰력에 있는 드롭다운/드롭 영역 구성 요소는 작업 공간의 모든 드롭 영역에 추가됩니다. 이 개선 사항을 통해 호환되는 구성 요소의 드롭다운 목록에서 선택하거나 공간을 드롭 영역으로 계속 사용할 수 있습니다. |
...
| 시각화에 대한 소스 및 설정 관리자의 결합 | 2021년 1월 14일 | 시각화에 대한 데이터 소스 관리자(도트) 및 설정 관리자(톱니바퀴)가 하나의 팝오버로 결합되었으므로 동일한 위치에서 소스와 설정을 쉽게 관리할 수 있습니다. |
