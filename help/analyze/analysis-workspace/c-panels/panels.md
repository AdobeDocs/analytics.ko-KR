...
![필터](/help/admin/admin/assets/filter.png)
...
드롭다운 필터를 사용하면 제어된 방식으로 데이터와 상호 작용할 수 있습니다. 예를 들어 태블릿, 휴대폰 또는 데스크탑 별로 패널을 분할할 수 있도록 모바일 디바이스 유형에 대한 드롭다운 필터를 추가할 수 있습니다.
...
![마우스 오른쪽 버튼 클릭 메뉴](assets/right-click-menu.png)
