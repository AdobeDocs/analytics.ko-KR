...
>title="모든 주문 내에서 구매된 총 장치 수를 확인합니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다."
>abstract="**시간이 지남에 따라 단위 판매량이 증가 또는 감소하는 방식을 이해하는 데 도움이 됩니다**. 세그먼트를 적용하여 어떤 고객 또는 지역에서 가장 많은 장치를 구매하고 있으며 시간이 지남에 따라 이러한 장치 판매의 경향이 어떻게 되는지 알아볼 수 있습니다.<br/>**학습한 내용에 따라** 캠페인 시작 전과 후의 단위 매출을 비교하여 최근에 시작한 마케팅 캠페인의 효과를 평가하는 등 여러 가지 작업을 수행할 수 있습니다. 또는 연휴 기간 동안 전년 대비 판매량을 비교할 수 있습니다.<br/>이 템플릿은 일 차원과 단위 지표를 사용합니다."
...
| [!UICONTROL **페이지**] | <!--duplicated in Engagement section--> 최고 인기 페이지와 방문 빈도가 낮은 페이지를 파악합니다. <p>**이를 통해** 대상자와 대상자가 가장 관심을 갖는 정보의 유형을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 조회수가 적은 페이지의 가시성을 높이기 위해 페이지 메타데이터를 조정하거나 가장 많이 조회된 페이지의 콘텐츠를 향상시키는 데 시간을 할애하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [페이지 차원](/help/components/dimensions/page.md) 및 [페이지 보기 횟수 지표](/help/components/metrics/page-views.md)를 사용합니다.</p> |
...
| [!UICONTROL **판매량**] | 모든 주문 내에서 구매된 총 장치 수를 확인합니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다. <p>**시간이 지남에 따라 단위 판매량이 증가 또는 감소하는 방식을 이해하는 데 도움이 됩니다**. 세그먼트를 적용하여 어떤 고객 또는 지역에서 가장 많은 장치를 구매하고 있으며 시간이 지남에 따라 이러한 장치 판매의 경향이 어떻게 되는지 알아볼 수 있습니다.</p><p>**학습한 내용에 따라** 캠페인 시작 전과 후의 단위 매출을 비교하여 최근에 시작한 마케팅 캠페인의 효과를 평가하는 등 여러 가지 작업을 수행할 수 있습니다. 또는 연휴 기간 동안 전년 대비 판매량을 비교할 수 있습니다.</p><p>이 템플릿은 [일 차원](/help/components/dimensions/day.md) 및 [단위 지표](/help/components/metrics/units.md)을 사용합니다.</p> |
...
>title="방문자가 각 방문 동안 사이트에서 보낸 평균 시간을 봅니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다."
>abstract="**방문자 참여 수준과 방문자가 사이트에서 보낸 시간을 더 잘 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라** 사이트 변경 사항이 방문자로 하여금 사이트에서 더 많은 시간을 소비하게 하는지 여부를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.<br/>이 템플릿은 일 차원과 방문당 체류 시간(초) 지표를 사용합니다."
...
>title="성공 이벤트까지 사용자가 소비한 평균 시간을 확인합니다."
>abstract="**이렇게 하면 방문자가 구매 등 원하는 작업을 수행하는 데 걸리는 시간을 더 잘 이해하는 데**&#x200B;도움이 됩니다.<br/>**학습한 내용을 바탕으로** 사이트 변경이 방문자의 성공 이벤트에 빠르게 도달할 수 있는지를 평가하는 등 다양한 작업을 수행할 수 있습니다.<br/>이 템플릿에서는 이벤트까지 남은 시간 차원과 고유 방문자 수 지표를 사용합니다."
...
>title="미리 정의된 페이지 순서를 통해 사람들이 떠나거나 계속 진행하는 위치를 봅니다."
>abstract="**이를 통해**&#x200B;사람들이 사용자 여정에서 빠져 나가는 위치를 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라** 사이트의 특정 프로세스(예: 구매 또는 등록 프로세스)를 통해 전환율을 분석하거나 사이트의 이벤트 간 상관 관계를 분석하는 등 여러 가지 작업을 수행할 수 있습니다. (예를 들어, 개인정보 처리방침을 본 사람 중 몇 퍼센트가 제품을 계속 구매했는가?) 이 템플릿을 사용하여 동일한 보고서에서 서로 다른 두 세그먼트의 병렬 비교를 수행할 수도 있습니다.<br/>이 템플릿은 폴아웃 시각화를 사용합니다."
...
>title="여정의 모든 지점에서 사람들이 사용한 장치를 봅니다."
>abstract="**이를 통해** 브랜드와 상호 작용하는 사람 수, 사용하는 장치 유형, 여러 장치를 사용하는 것이 경험에 미치는 영향을 더 잘 이해할 수 있습니다. 예를 들어, 사람들이 모바일 디바이스에서 작업을 시작한 다음 나중에 데스크탑으로 이동하여 작업을 완료하는 빈도는 얼마나 됩니까? 사용자가 하나의 디바이스에서 다른 디바이스로 이동하는 가장 일반적인 경로는 무엇입니까? 어디에서 중단됩니까? 어디에서 성공합니까? 기타.<br/>**학습한 내용에 따라 모바일 환경을 위해 사용자 여정의 특정 부분을 최적화하는 등 여러 가지 작업을 수행할 수 있습니다**.<br/>이 템플릿에서는 흐름 시각화, 폴아웃 시각화, 집단 분석, 사람 지표 및 고유 장치 지표를 사용합니다."
...
>title="충성도 높은 사용자가 누구이며 사이트에서 어떤 작업을 수행하는지 확인합니다."
>abstract="**이를 통해 평균 사용자가 사이트를 방문한 횟수, 사이트를 다시 방문하는 빈도 및 다시 방문하는 기간(일)을 더 잘 파악할 수 있습니다**.<br/>**학습한 내용에 따라** 사람들을 사이트로 다시 불러오는 데 가장 효과적인 콘텐츠를 분석하는 등 여러 작업을 수행할 수 있습니다.<br/>이 템플릿에서는 방문 횟수 지표와 고유 방문자 수 지표를 사용합니다."
...
>abstract="**이를 통해**&#x200B;방문자가 사이트에서 오디오 콘텐츠를 어떻게 사용하고 있는지 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라** 가장 많이 소비되는 콘텐츠를 분석하는 등 여러 작업을 수행할 수 있습니다.<br/>이 템플릿에서는 방문 횟수 지표와 고유 방문자 수 지표를 사용합니다."
...
>title="다시 로드 중 차원 항목이 있었던 횟수를 봅니다. 방문자가 브라우저를 새로 고치는 것이 다시 로드를 트리거하는 가장 일반적인 방법입니다."
>abstract="**특정 페이지에서 방문자에게 페이지를 다시 로드하라는 메시지가 표시되는 문제가 발생하는 시기를 식별하는 데 도움이 될 수 있습니다**.<br/>**학습한 내용에 따라** 해결해야 할 문제가 있는 페이지를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.<br/>이 템플릿은 다시 로드 지표를 사용합니다."
...
>title="방문자의 라이프타임 동안 사용자가 사이트를 처음 방문할 때 액세스하는 상위 페이지를 봅니다."
>abstract="**이를 통해** 사이트에 가장 많은 트래픽이 유입되는 페이지를 더 잘 이해하거나 방문자가 사이트에 대해 갖는 첫인상을 더 잘 이해할 수 있습니다.<br/>**학습한 내용을 바탕으로** 사람들이 사이트에서 처음 접하는 초기 경험을 최적화하거나 사이트에 들어갈 때 처음 보는 페이지가 환영하는 분위기이고 사이트의 다른 영역에 대한 필요한 링크를 제공하는 등 다양한 작업을 수행할 수 있습니다.<br/>이 템플릿은 세션 지표를 사용합니다. 또한 막대 시각화와 자유 형식 테이블 시각화도 사용합니다."
...
>title="하나의 고유 페이지로 이루어진 방문 횟수를 봅니다."
>abstract="**방문자 참여 수준과 방문자가 사이트에서 보낸 시간을 더 잘 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라** 사이트 변경 사항이 방문자로 하여금 사이트에서 더 많은 시간을 소비하게 하는지 여부를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.<br/>이 템플릿은 단일 페이지 방문 횟수 차원을 사용합니다."
...
>title="Adobe Experience Manager 사이트에 대한 성능 데이터를 봅니다."
>abstract="**Adobe Experience Manager의 가치 실현을 더 잘 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라** Experience Manager 설정을 최적화하는 등 여러 가지 작업을 수행할 수 있습니다."
...
>title="ITP(Intelligent Tracking Prevention)가 데이터 수집 및 보고에 미치는 영향을 보고 분석할 수 있습니다."
>abstract="**ITP에서 적용되는 쿠키 제한으로 인해 발생할 수 있는 데이터 손실을 이해하는 데**&#x200B;도움이 됩니다.<br/>**학습한 내용에 따라 ITP의 영향을 최소화하기 위해 분석 설정을 조정하는 등**&#x200B;할 수 있습니다."
...
| [!UICONTROL **페이지**] | <!--duplicated in Most popular section-->최고 인기 페이지와 방문 빈도가 낮은 페이지를 파악합니다. <p>**이를 통해** 대상자와 대상자가 가장 관심을 갖는 정보의 유형을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 조회수가 적은 페이지의 가시성을 높이기 위해 페이지 메타데이터를 조정하거나 가장 많이 조회된 페이지의 콘텐츠를 향상시키는 데 시간을 할애하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [페이지 차원](/help/components/dimensions/page.md) 및 [페이지 보기 횟수 지표](/help/components/metrics/page-views.md)를 사용합니다.</p> |
...
| [!UICONTROL **방문당 체류 시간**] | 방문자가 각 방문 동안 사이트에서 보낸 평균 시간을 봅니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다. <p>**방문자 참여 수준과 방문자가 사이트에서 보낸 시간을 더 잘 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** 사이트 변경 사항이 방문자로 하여금 사이트에서 더 많은 시간을 소비하게 하는지 여부를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [일 차원](/help/components/dimensions/day.md)과 [방문당 체류 시간(초) 지표](/help/components/metrics/time-spent-per-visit.md)을 사용합니다.</p> |
| [!UICONTROL **이벤트까지 남은 시간**] | 성공 이벤트까지 사용자가 소비한 평균 시간을 확인합니다. <p>**이렇게 하면 방문자가 구매 등 원하는 작업을 수행하는 데 걸리는 시간을 더 잘 이해하는 데**&#x200B;도움이 됩니다.</p><p>**학습한 내용을 바탕으로** 사이트 변경이 방문자의 성공 이벤트에 빠르게 도달할 수 있는지를 평가하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [이벤트까지 남은 시간](/help/components/dimensions/time-prior-to-event.md) 및 [고유 방문자 수 지표](/help/components/metrics/unique-visitors.md)를 사용합니다.</p> |
...
| [!UICONTROL **다음 및 이전 페이지 흐름**] | 특정 장소를 방문하기 전이나 후에 사람들이 가는 가장 일반적인 장소를 봅니다.<p>**이렇게 하면 사용자가 사이트에 처음 들어왔을 때 어디로 이동하는지, 사람들이 가장 많이 방문하는 사이트 섹션과 사이트를 떠나기 전에 방문할 가능성이 가장 높은 페이지를 더 잘 파악할 수 있습니다**.</p><p>**학습한 내용에 따라** 사이트에서 어떤 경로로 사람들을 가장 중요한 페이지로 유도하는지, 어떤 페이지로 인해 사람들이 사이트 <!-- not sure about these takeaways... -->에서 멀어지게 하는지 등 여러 가지 작업을 수행할 수 있습니다.</p> <p>이 템플릿은 [페이지 차원](/help/components/dimensions/page.md) 및 [페이지 보기 수 지표](/help/components/metrics/page-views.md), [방문 횟수 지표](/help/components/metrics/visits.md), [고유 방문자 수 지표](/help/components/metrics/unique-visitors.md), [시작 비율 지표](/help/components/metrics/entries.md), [바운스 비율 지표](/help/components/metrics/bounce-rate.md), [종료 비율 지표](/help/components/metrics/exits.md) 및 [콘텐츠 속도 지표](/help/components/metrics/content-velocity.md)를 사용합니다. 또한 시작, 종료 및 상단 섹션에 대해 [플로우 시각화](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md), 가장 일반적인 페이지에 대한 페이지 보기를 표시하는 [산점도 시각화](/help/analyze/analysis-workspace/visualizations/scatterplot.md), 버킷 시간별로 페이지 보기를 표시하는 [막대 시각화](/help/analyze/analysis-workspace/visualizations/bar.md), 사이트에서 보낸 평균 시간의 트렌드 보기를 표시하는 [선 시각화](/help/analyze/analysis-workspace/visualizations/line.md)를 사용합니다.</p> |
| [!UICONTROL **폴아웃**] | 미리 정의된 페이지 순서를 통해 사람들이 떠나거나 계속 진행하는 위치를 봅니다.<p>**이를 통해**&#x200B;사람들이 사용자 여정에서 빠져 나가는 위치를 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라** 사이트의 특정 프로세스(예: 구매 또는 등록 프로세스)를 통해 전환율을 분석하거나 사이트의 이벤트 간 상관 관계를 분석하는 등 여러 가지 작업을 수행할 수 있습니다. (예를 들어, 개인정보 처리방침을 본 사람 중 몇 퍼센트가 제품을 계속 구매했는가?) 이 템플릿을 사용하여 동일한 보고서에서 서로 다른 두 세그먼트의 병렬 비교를 수행할 수도 있습니다.</p> <p>이 템플릿은 [폴아웃 시각화](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md)를 사용합니다.</p> |
| [!UICONTROL **장치 간 분석**] | 여정의 모든 지점에서 사람들이 사용한 장치를 봅니다.<p>**이를 통해** 브랜드와 상호 작용하는 사람 수, 사용하는 장치 유형, 여러 장치를 사용하는 것이 경험에 미치는 영향을 더 잘 이해할 수 있습니다. 예를 들어, 사람들이 모바일 디바이스에서 작업을 시작한 다음 나중에 데스크탑으로 이동하여 작업을 완료하는 빈도는 얼마나 됩니까? 사용자가 하나의 디바이스에서 다른 디바이스로 이동하는 가장 일반적인 경로는 무엇입니까? 어디에서 중단됩니까? 어디에서 성공합니까? 기타.</p><p>**학습한 내용에 따라 모바일 환경을 위해 사용자 여정의 특정 부분을 최적화하는 등 여러 가지 작업을 수행할 수 있습니다**.</p> <p>이 템플릿은 [흐름 시각화](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md), [폴아웃 시각화](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md), [집단 분석](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md), [사람 지표](/help/components/metrics/people.md) 및 [고유 장치 지표](/help/components/metrics/unique-devices.md)를 사용합니다.</p> |
| [!UICONTROL **웹 유지**] | 충성도 높은 사용자가 누구이며 사이트에서 어떤 작업을 수행하는지 확인합니다.<p>**이를 통해 평균 사용자가 사이트를 방문한 횟수, 사이트를 다시 방문하는 빈도 및 다시 방문하는 기간(일)을 더 잘 파악할 수 있습니다**.</p><p>**학습한 내용에 따라** 사람들을 사이트로 다시 불러오는 데 가장 효과적인 콘텐츠를 분석하는 등 여러 작업을 수행할 수 있습니다.<p>이 템플릿은 [방문 횟수 지표](/help/components/metrics/visits.md) 및 [고유 방문자 수 지표](/help/components/metrics/unique-visitors.md)을 사용합니다.</p> |
| [!UICONTROL **미디어 오디오 소비**] | 모든 디지털 기기에서 미디어 오디오 사용의 트렌드와 주요 지표를 볼 수 있습니다.<p>**이를 통해**&#x200B;방문자가 사이트에서 오디오 콘텐츠를 어떻게 사용하고 있는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라** 가장 많이 소비되는 콘텐츠를 분석하는 등 여러 작업을 수행할 수 있습니다.<p>이 템플릿은 [방문 횟수 지표](/help/components/metrics/visits.md) 및 [고유 방문자 수 지표](/help/components/metrics/unique-visitors.md)을 사용합니다.</p> |
| [!UICONTROL **미디어 최신성, 빈도, 충성도**] | 모든 디지털 기기에서 미디어 사용에 대한 경향과 최상위 지표를 볼 수 있습니다.<p>**이를 통해 평균 사용자가 사이트를 방문한 횟수, 사이트를 다시 방문하는 빈도 및 다시 방문하는 기간(일)을 더 잘 파악할 수 있습니다**.</p><p>**학습한 내용에 따라** 사람들을 사이트로 다시 불러오는 데 가장 효과적인 콘텐츠를 분석하는 등 여러 작업을 수행할 수 있습니다.<p>이 템플릿은 [방문 횟수 지표](/help/components/metrics/visits.md) 및 [고유 방문자 수 지표](/help/components/metrics/unique-visitors.md)을 사용합니다.</p> |
| **[!UICONTROL 페이지 분석]** > [!UICONTROL **페이지 요약**] | 방문자가 각 방문 동안 사이트에서 보낸 평균 시간을 봅니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다. <p>**방문자 참여 수준과 방문자가 사이트에서 보낸 시간을 더 잘 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** 사이트 변경 사항이 방문자로 하여금 사이트에서 더 많은 시간을 소비하게 하는지 여부를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [일 차원](/help/components/dimensions/day.md)과 [방문당 체류 시간(초) 지표](/help/components/metrics/time-spent-per-visit.md)을 사용합니다.</p> |
| **[!UICONTROL 페이지 분석]** > [!UICONTROL **다시 로드**] | 다시 로드 중 차원 항목이 있었던 횟수를 봅니다. 방문자가 브라우저를 새로 고치는 것이 다시 로드를 트리거하는 가장 일반적인 방법입니다. <p>**특정 페이지에서 방문자에게 페이지를 다시 로드하라는 메시지가 표시되는 문제가 발생하는 시기를 식별하는 데 도움이 될 수 있습니다**.</p><p>**학습한 내용에 따라** 해결해야 할 문제가 있는 페이지를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [다시 로드 지표](https://experienceleague.adobe.com/en/docs/analytics/components/metrics/reloads)를 사용합니다.</p> |
| **[!UICONTROL 페이지 분석]** > [!UICONTROL **페이지에서 보낸 시간**] | 방문자가 각 방문 동안 사이트에서 보낸 평균 시간을 봅니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다. <p>**방문자 참여 수준과 방문자가 사이트에서 보낸 시간을 더 잘 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** 사이트 변경 사항이 방문자로 하여금 사이트에서 더 많은 시간을 소비하게 하는지 여부를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [일 차원](/help/components/dimensions/day.md)과 [방문당 체류 시간(초) 지표](/help/components/metrics/time-spent-per-visit.md)을 사용합니다.</p> |
...
| **[!UICONTROL 시작 및 종료]** > [!UICONTROL **원래 시작 페이지**] | 방문자의 라이프타임 동안 사용자가 사이트를 처음 방문할 때 액세스하는 상위 페이지를 봅니다. <p>**이를 통해** 사이트에 가장 많은 트래픽이 유입되는 페이지를 더 잘 이해하거나 방문자가 사이트에 대해 갖는 첫인상을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 사람들이 사이트에서 처음 접하는 초기 경험을 최적화하거나 사이트에 들어갈 때 처음 보는 페이지가 환영하는 분위기이고 사이트의 다른 영역에 대한 필요한 링크를 제공하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 세션 지표를 사용합니다. 또한 막대 시각화와 자유 형식 테이블 시각화도 사용합니다.</p> |
| **[!UICONTROL 시작 및 종료]** > [!UICONTROL **단일 페이지 방문**] | 하나의 고유 페이지로 이루어진 방문 횟수를 봅니다. <p>**방문자 참여 수준과 방문자가 사이트에서 보낸 시간을 더 잘 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** 사이트 변경 사항이 방문자로 하여금 사이트에서 더 많은 시간을 소비하게 하는지 여부를 평가하는 등 여러 가지 작업을 수행할 수 있습니다.</p><p>이 템플릿은 [단일 페이지 방문 횟수 차원](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/single-page-visits)을 사용합니다.</p> |
...
| [!UICONTROL **AEM**] > [!UICONTROL **사이트 성능**] > [!UICONTROL **AEM 사이트 성능**] | Adobe Experience Manager 사이트에 대한 성능 데이터를 봅니다.  <p>**Adobe Experience Manager의 가치 실현을 더 잘 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** Experience Manager 설정을 최적화하는 등 여러 가지 작업을 수행할 수 있습니다.</p> |
| [!UICONTROL **ITP 영향**] | ITP(Intelligent Tracking Prevention)가 데이터 수집 및 보고에 미치는 영향을 보고 분석할 수 있습니다. <p>**ITP에서 적용되는 쿠키 제한으로 인해 발생할 수 있는 데이터 손실을 이해하는 데**&#x200B;도움이 됩니다.</p><p>**학습한 내용에 따라 ITP의 영향을 최소화하기 위해 분석 설정을 조정하는 등**&#x200B;할 수 있습니다.</p> |
...
| **[!UICONTROL 참여]** | <ul><li>주요 지표 (내 가장 중요한 지표의 성과는 어떻습니까?)</li><li>페이지 조회수 (얼마나 많은 페이지 조회수를 생성하고 있습니까?)</li><li>페이지 (내 상위 페이지는 무엇입니까?)</li><li>방문수 (얼마나 많은 방문을 받고 있습니까?)</li><li>방문자수 (얼마나 많은 방문자를 얻고 있습니까?)</li><li>방문당 체류 시간 (내 사용자는 방문당 얼마나 많은 시간을 소비합니까?)</li><li>이벤트 이전 시간 (내 사용자는 성공 이벤트 전에 얼마나 많은 시간을 소비합니까?)</li><li>사이트 섹션 (내 사이트의 어느 섹션에서 가장 많은 페이지 조회수가 생성되었습니까?)</li><li>웹 콘텐츠 사용량 (어떤 콘텐츠가 가장 많이 소비되고 사용자의 관심을 끌고 있습니까?)</li><li>미디어 콘텐츠 사용량 (어떤 콘텐츠가 가장 많이 소비되고 사용자의 관심을 끌고 있습니까?)</li><li>다음 및 이전 페이지 흐름 (내 방문자가 선택한/선택했던 다음/이전 경로는 무엇입니까?)</li><li>폴아웃 (내 디지털 속성 전체에서 어디에 폴아웃이 보입니까?)</li><li>디바이스 간 분석 (Analysis Workspace에서 디바이스 간 분석 사용)</li><li>웹 유지 (충성도가 높은 사용자는 누구이며 그들이 무슨 작업을 수행합니까?)</li><li>미디어 오디오 사용량 (오디오 사용량의 트렌드 및 주요 지표는 무엇입니까?)</li><li>미디어 최신성, 빈도, 충성도 (충성도 높은 독자는 누구입니까?)</li><li>페이지 분석 > 다시 로드 (어떤 페이지가 가장 많은 다시 로드를 발생시킵니까?)</li><li>페이지 분석 > 방문당 체류 시간 (내 사용자가 내 페이지에서 보내는 시간은 얼마입니까?)</li><li>시작 및 종료 > 시작 페이지 (상위 시작 페이지는 무엇입니까?)</li><li>시작 및 종료 > 원래 시작 페이지 (내 방문자가 원래 어떤 페이지에서 입장했습니까?)</li><li>시작 및 종료 >단일 페이지 방문 (단일 페이지 방문이 가장 많이 발생한 페이지는 무엇입니까?)</li><li>시작 및 종료 > 종료 페이지 (상위 종료 페이지는 무엇입니까?)</li><li>페이지 분석 > 페이지 요약</li></ul> |
...
>title="상거래 활동에 대한 소매점을 위해 미리 빌드된 통찰력을 확인하여 판매 개선에 도움이 됩니다. 이는 Magento 사용자를 대상으로 하지만 모든 온라인 소매점에서 활용할 수 있습니다."
>abstract="**이를 통해**&#x200B;상거래 활동이 매출액 증가에 어떻게 기여하고 있는지 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라, 가장 많은 ROI를 얻고 있는 활동에 대한 예산 조정과 같은 다양한 작업을**&#x200B;할 수 있습니다."
...
| [!UICONTROL **판매량**] | 모든 주문 내에서 구매된 총 장치 수를 확인합니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다. <p>**시간이 지남에 따라 단위 판매량이 증가 또는 감소하는 방식을 이해하는 데 도움이 됩니다**. 세그먼트를 적용하여 어떤 고객 또는 지역에서 가장 많은 장치를 구매하고 있으며 시간이 지남에 따라 이러한 장치 판매의 경향이 어떻게 되는지 알아볼 수 있습니다.</p><p>**학습한 내용에 따라** 캠페인 시작 전과 후의 단위 매출을 비교하여 최근에 시작한 마케팅 캠페인의 효과를 평가하는 등 여러 가지 작업을 수행할 수 있습니다. 또는 연휴 기간 동안 전년 대비 판매량을 비교할 수 있습니다.</p><p>이 템플릿은 [일 차원](/help/components/dimensions/day.md) 및 [단위 지표](/help/components/metrics/units.md)을 사용합니다.</p> |
| [!UICONTROL **Magento: 마케팅 및 Commerce**] | 상거래 활동에 대한 소매점을 위해 미리 빌드된 통찰력을 확인하여 판매 개선에 도움이 됩니다. 이는 Magento 사용자를 대상으로 하지만 모든 온라인 소매점에서 활용할 수 있습니다. <p>**이를 통해**&#x200B;상거래 활동이 매출액 증가에 어떻게 기여하고 있는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라, 가장 많은 ROI를 얻고 있는 활동에 대한 예산 조정과 같은 다양한 작업을**&#x200B;할 수 있습니다.</p> |
...
>title="사이트에 액세스하는 방문자의 최상위 시간대를 봅니다."
>abstract="**이를 통해** 방문자가 라이브하는 시간대를 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라 최소 인원수에 영향을 주는 사이트 유지 관리 조정과 같은 여러 가지 작업을 수행할 수 있습니다**."
...
>title="사이트에 액세스하는 방문자의 상위 도메인을 봅니다."
>abstract="**이를 통해**&#x200B;방문자가 속한 조직을 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라 최대 고객을 대상으로 하는 등** 다양한 작업을 수행할 수 있습니다."
...
>title="사람들이 사이트에 액세스하는 데 사용하는 상위 브라우저 너비를 봅니다."
>abstract="**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라 가장 일반적인 브라우저 너비를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등** 여러 가지 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.<br/>이 템플릿은 브라우저 차원을 사용합니다."
...
>title="사람들이 사이트에 액세스하는 데 사용하는 상위 브라우저 높이를 봅니다."
>abstract="**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라, 가장 일반적인 브라우저 높이를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등**&#x200B;다양한 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.<br/>이 템플릿은 브라우저 차원을 사용합니다. "
...
>title="사람들이 사이트에 액세스하는 데 사용하는 운영 체제 및 버전 이름을 봅니다."
>abstract="**이를 통해** 방문자가 사용하는 가장 일반적인 운영 체제와 버전을 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라, 상위 운영 체제와 버전을 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등** 여러 가지 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다."
...
>title="사람들이 사이트에 액세스하는 데 사용하는 운영 체제의 이름을 봅니다."
>abstract="**이를 통해** 방문자가 사용하는 가장 일반적인 운영 체제를 더 잘 이해할 수 있습니다.<br/>**학습한 내용에 따라** 최상위 운영 체제를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등 여러 가지 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다."
...
>title="방문자가 사이트를 몇 번 방문했는지 확인합니다."
>abstract="**이를 통해** 사이트로 돌아올 때 방문자의 참여도를 더 잘 이해할 수 있습니다. 이는 프로젝트 날짜 범위와 상관없이 방문자의 라이프타임에 적용됩니다.<br/>**학습한 내용에 따라** 빈번한 방문자를 위한 마케팅 활동 조정과 같은 다양한 작업을 수행할 수 있습니다.<br/>이 서식 파일은 방문 번호 차원을 사용합니다."
...
>title="이전 구매 횟수가 0회, 이전 구매 횟수가 1회, 이전 구매 횟수가 2회 또는 이전 구매 횟수가 3회 이상인 사이트 방문자 수를 표시합니다."
>abstract="**사이트가 구매 행동에 미치는 영향을 더 잘 이해하는 데**&#x200B;도움이 됩니다. .<br/>**학습한 내용에 따라, 새 방문자에게 유사한 행동을 장려할 수 있도록 구매하기 위해 돌아오는 방문자에게 집중하는 등 여러 가지 작업을**&#x200B;할 수 있습니다.<br/>이 템플릿은 고객 충성도 차원을 사용합니다."
...
>title="방문자가 사이트에 처음 도달하고 구매하기까지 경과되는 일 수를 확인합니다. 예를 들어 방문자가 처음 방문한 후 하루 후에 구매하면 그 이후의 모든 방문 또는 이벤트는 1일 차원 항목에 속합니다."
>abstract="**방문자가 구매하는 데 걸리는 시간을 이해하는 데**&#x200B;도움이 됩니다.<br/>**학습한 내용에 따라** 더 빠른 습득을 장려하기 위해 사이트 업데이트와 같은 다양한 작업을 수행할 수 있습니다.<br/>이 템플릿은 첫 구매까지 소요된 일수 차원을 사용합니다."
...
>title="방문자의 현재 히트와 해당 시간의 가장 최근 구매 사이에 경과된 시간을 봅니다."
>abstract="**이렇게 하면 사이트에서 제품을 구입한 후 방문자의 행동을 더 잘 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라** 사이트를 업데이트하여 후속 구매를 장려하는 등 여러 작업을 수행할 수 있습니다.<br/>이 서식 파일은 마지막 구매 이후 일 수 차원을 사용합니다."
...
>title="사람들이 사이트에 액세스하는 데 사용하는 모바일 화면 크기를 표시합니다."
>abstract="**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라, 가장 일반적인 모바일 화면 크기를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등**&#x200B;다양한 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다."
...
>title="사람들이 사이트에 액세스하는 데 사용하는 모바일 화면 상단 높이를 봅니다."
>abstract="**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라, 가장 일반적인 모바일 화면 높이를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등의 여러 가지 작업을 수행할 수 있습니다**. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다."
...
>title="사람들이 사이트에 액세스하는 데 사용하는 모바일 화면 너비를 표시합니다."
>abstract="**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라, 가장 일반적인 모바일 화면 너비를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등 여러 가지 작업을 수행할 수 있습니다**. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다."
...
| 템플릿 이름 | 이 템플릿 <!-- What do you do with it? What can it help you learn? and What are the potential actions? -->을(를) 사용하는 이유 |
| --- | --- | 
| [!UICONTROL **사용자 메트릭**] | 내 브랜드와 상호 작용하는 사람 수를 봅니다. <p>**이를 통해** 사이트의 사용 트렌드를 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라** 사이트에 대한 새 방문자를 생성하는 데 있어 최근 마케팅 노력의 효과를 측정하는 것과 같이 여러 가지 작업을 수행할 수 있습니다.</p> |
| **방문자 프로필** > **위치 개요** | 맵 시각화에서 방문자 위치의 개요를 봅니다.<p>**이를 통해**&#x200B;사이트를 방문하는 방문자의 위치를 더 잘 파악할 수 있습니다. </p><p>**학습한 내용에 따라, 가장 흥미와 기회가 있는 곳에서 집중 마케팅 리소스와 같은 여러 가지 작업을 수행할 수 있습니다**.</p><!-- This template uses the --> |
| **방문자 프로필** > **지역 국가** | 사이트를 방문하는 사람들의 출신 국가를 확인할 수 있습니다.<p>**이를 통해** 어느 국가에서 가장 많이 사이트에 방문하는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 데이터를 사용하여 해당 국가에서 마케팅 활동에 집중하거나 기본 언어가 다른 국가에서 사이트 경험이 최적화되도록 하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿에서는 국가 차원을 사용합니다. </p> |
| **방문자 프로필** > **미국 지역** | 사이트를 방문하는 사람들이 (미국) 어느 주에서 왔는지 확인할 수 있습니다. 이 차원은 미국에만 해당된다는 점을 제외하면 지리적 지역 템플릿과 유사합니다.<p>**이를 통해** 미국 어디에서 가장 많이 사이트에 방문하는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 데이터를 사용하여 해당 주에서 마케팅 활동에 집중하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 미국 주 차원을 사용합니다. </p> |
| **방문자 프로필** > **지역** | 사이트를 방문한 사람들이 어느 지리적 지역에서 왔는지 확인할 수 있습니다. 한 지역은 국가보다는 작지만 도시보다는 큰 지리적 영역입니다. 일부 국가의 경우 지역이 주, 도 또는 현입니다. 기타 영역에서는 자치국, 부서 또는 대도시권입니다. <p>**이를 통해** 어느 지역에서 가장 많이 사이트에 방문하는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라 데이터를 사용하여 해당 지역의 마케팅 활동에 주력하거나 기본 언어가 다른 지역에서 사이트 경험이 최적인지 확인하는 등 여러 가지 작업을 수행할 수 있습니다**. </p><p>이 템플릿은 ID(변수/지역) 및 지역 차원을 사용합니다. </p> |
| **방문자 프로필** > **지리적 도시** | 사이트를 방문하는 사람들의 출신 도시를 확인할 수 있습니다. <p>**이를 통해** 어느 도시에서 가장 많이 사이트에 방문하는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라 데이터를 사용하여 해당 도시에서의 마케팅 활동에 집중하는 등 여러 가지 작업을 수행할 수 있습니다**. </p><p>이 템플릿은 도시 차원을 사용합니다. </p> |
| **방문자 프로필** > **지역 US DMA** | 사이트 방문자가 미국 내 지정 마케팅 지역(DMA) 중 어디에서 가장 많이 방문했는지 확인할 수 있습니다.<p>**이를 통해** 어느 지역에서 가장 많이 사이트에 방문하는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 데이터를 사용하여 가장 성공적인 지역에서 마케팅 활동에 집중하는 등 다양한 작업을 수행할 수 있습니다. </p><!-- This template uses the --> |
...
| **방문자 프로필** > **시간대** | 사이트에 액세스하는 방문자의 최상위 시간대를 봅니다. <p>**이를 통해** 방문자가 라이브하는 시간대를 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라 최소 인원수에 영향을 주는 사이트 유지 관리 조정과 같은 여러 가지 작업을 수행할 수 있습니다**.</p> |
| **방문자 프로필** > **도메인** | 사이트에 액세스하는 방문자의 상위 도메인을 봅니다. <p>**이를 통해**&#x200B;방문자가 속한 조직을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라 최대 고객을 대상으로 하는 등** 다양한 작업을 수행할 수 있습니다.</p> |
| **방문자 프로필** > **최상위 도메인** | 사이트에 액세스하는 방문자의 최상위 도메인을 확인합니다. <p>**이를 통해**&#x200B;방문자가 속한 조직을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라 최대 고객을 대상으로 하는 등** 다양한 작업을 수행할 수 있습니다.</p> |
| **방문자 프로필** > **기술** > **기술 개요** | <p>**더 잘 이해할 수 있도록**</p><p>**학습한 내용에 따라** 다음과 같은 여러 가지 작업을 수행할 수 있습니다 </p><p>이 템플릿은 </p> |
...
| **방문자 프로필** > **기술** > **브라우저 너비** | 사람들이 사이트에 액세스하는 데 사용하는 상위 브라우저 너비를 봅니다.<p>**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라 가장 일반적인 브라우저 너비를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등** 여러 가지 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p><p>이 템플릿은 브라우저 차원을 사용합니다. </p> |
| **방문자 프로필** > **기술** > **브라우저 높이** | 사람들이 사이트에 액세스하는 데 사용하는 상위 브라우저 높이를 봅니다.<p>**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라, 가장 일반적인 브라우저 높이를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등**&#x200B;다양한 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p><p>이 템플릿은 브라우저 차원을 사용합니다. </p> |
| **방문자 프로필** > **기술** > **운영 체제** | 사람들이 사이트에 액세스하는 데 사용하는 운영 체제 및 버전 이름을 봅니다.<p>**이를 통해** 방문자가 사용하는 가장 일반적인 운영 체제와 버전을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라, 상위 운영 체제와 버전을 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등** 여러 가지 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p> |
| **방문자 프로필** > **기술** > **운영 체제 유형** | 사람들이 사이트에 액세스하는 데 사용하는 운영 체제의 이름을 봅니다.<p>**이를 통해** 방문자가 사용하는 가장 일반적인 운영 체제를 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라** 최상위 운영 체제를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등 여러 가지 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p> |
...
| **방문자 유지** > **방문 횟수** | 방문자가 사이트를 몇 번 방문했는지 확인합니다.<p>**이를 통해** 사이트로 돌아올 때 방문자의 참여도를 더 잘 이해할 수 있습니다. 이는 프로젝트 날짜 범위와 상관없이 방문자의 라이프타임에 적용됩니다.</p><p>**학습한 내용에 따라** 빈번한 방문자를 위한 마케팅 활동 조정과 같은 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 방문 횟수 차원을 사용합니다.</p> |
| **방문자 유지** > **판매 주기** > **고객 충성도** | 이전 구매 횟수가 0회, 이전 구매 횟수가 1회, 이전 구매 횟수가 2회 또는 이전 구매 횟수가 3회 이상인 사이트 방문자 수를 표시합니다. <p>**사이트가 구매 행동에 미치는 영향을 더 잘 이해하는 데**&#x200B;도움이 됩니다. .</p><p>**학습한 내용에 따라, 새 방문자에게 유사한 행동을 장려할 수 있도록 구매하기 위해 돌아오는 방문자에게 집중하는 등 여러 가지 작업을**&#x200B;할 수 있습니다.</p><p>이 템플릿은 고객 충성도 차원을 사용합니다.</p> |
| **방문자 유지** > **판매 주기** > **첫 구매까지 소요된 일** | 방문자가 사이트에 처음 도달하고 구매하기까지 경과되는 일 수를 확인합니다. 예를 들어 방문자가 처음 방문한 다음 하루 후에 구매한다면 그 이후의 모든 방문 또는 이벤트는 &quot;1일&quot; 차원 항목에 속합니다.<p>**방문자가 구매하는 데 걸리는 시간을 이해하는 데**&#x200B;도움이 됩니다.</p><p>**학습한 내용에 따라** 더 빠른 습득을 장려하기 위해 사이트 업데이트와 같은 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 첫 구매까지 소요된 일수 차원을 사용합니다.</p> |
| **방문자 유지** > **판매 주기** > **마지막 구매 이후 일수** | 방문자의 현재 히트와 해당 시간의 가장 최근 구매 사이에 경과된 시간을 봅니다.<p>**이렇게 하면 사이트에서 제품을 구입한 후 방문자의 행동을 더 잘 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** 사이트를 업데이트하여 후속 구매를 장려하는 등 여러 작업을 수행할 수 있습니다.</p><p>이 템플릿은 마지막 구매 이후 일 수 차원을 사용합니다.</p> |
| **모바일** > **모바일 장치** | 사람들이 귀하의 사이트에 접속하는 데 사용하는 모바일 디바이스의 제조사와 모델을 확인할 수 있습니다.<p>**이를 통해** 사용자 사이에서 가장 인기 있는 모바일 디바이스를 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 가장 일반적인 모바일 디바이스에 맞게 사이트 렌더링을 최적화하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 모바일 장치 이름 차원을 사용합니다.</p> |
| **모바일** > **모바일 장치 유형** | 휴대폰 및 태블릿과 같이 사용자가 사이트에 액세스하는 데 사용하는 모바일 디바이스 유형을 확인할 수 있습니다.<p>**이를 통해** 사이트에 액세스하는 데 사용되는 다양한 종류의 모바일 디바이스를 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 가장 많이 사용되는 모바일 디바이스 유형에 맞게 사이트를 최적화하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 모바일 디바이스 유형 차원을 사용합니다.</p> |
...
| **모바일** > **화면 크기** | 사람들이 사이트에 액세스하는 데 사용하는 모바일 화면 크기를 표시합니다.<p>**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라, 가장 일반적인 모바일 화면 크기를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등**&#x200B;다양한 작업을 수행할 수 있습니다. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p> |
| **모바일** > **화면 높이** | 사람들이 사이트에 액세스하는 데 사용하는 모바일 화면 상단 높이를 봅니다.<p>**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라, 가장 일반적인 모바일 화면 높이를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등의 여러 가지 작업을 수행할 수 있습니다**. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p> |
| **모바일** > **화면 너비** | 사람들이 사이트에 액세스하는 데 사용하는 모바일 화면 너비를 표시합니다.<p>**방문자에게 콘텐츠가 표시되는 방식을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라, 가장 일반적인 모바일 화면 너비를 사용하여 사이트의 새 버전을 테스트하여 사이트 품질을 개선하는 등 여러 가지 작업을 수행할 수 있습니다**. 이렇게 하면 품질 관리 노력의 효과를 극대화할 수 있습니다.</p> |
...
>title="웹 사이트가 모바일 장치에서 방문자를 확보하는 방법을 봅니다."
...
>title="모든 Google 및 Bing 유료 검색 데이터를 나란히 볼 수 있습니다."
>abstract="**이렇게 하면 사이트로 전송되는 트래픽의 양과 고객이 전환하는지 여부를 더 잘 이해할 수 있습니다**.<br/>**학습한 내용에 따라** 광고 캠페인의 비용 효율성 예측과 같은 여러 가지 작업을 수행할 수 있습니다."
...
>title="방문자가 사이트에 도달하기 위해 클릭스루한 검색 결과 페이지를 표시합니다. 예를 들어 사이트가 검색 엔진의 검색 결과 중 두 번째 페이지에 나타나는 경우 이 변수의 차원 항목은 검색 페이지 2입니다."
>abstract="**검색 결과의 페이지 순위를 더 잘 이해하는 데**&#x200B;도움이 됩니다.<br/>**학습한 내용에 따라 여러 가지 작업을 수행할 수 있습니다** 검색 결과의 첫 페이지에 콘텐츠가 표시되도록 SEO 전략을 개선합니다."
...
| **모바일 획득** | 사이트가 모바일 장치에서 방문자를 확보하는 방법을 봅니다.<p>**이를 통해** 검색 키워드, 참조 도메인 등 확보로 이어지는 다양한 요인에 대해 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 가장 효과적인 채널에 마케팅 활동을 집중하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 바운스 비율 지표와 바운스 수 지표를 사용합니다. 또한 검색 엔진 차원, 검색 키워드 차원, 진입 페이지 차원, 참조 도메인 차원, 추적 코드 차원 및 참조자 차원도 사용합니다.  </p> |
...
| **Advertising Analytics: 유료 검색** | 모든 Google 및 Bing 유료 검색 데이터를 나란히 볼 수 있습니다. <p>**이렇게 하면 사이트로 전송되는 트래픽의 양과 고객이 전환하는지 여부를 더 잘 이해할 수 있습니다**.</p><p>**학습한 내용에 따라** 광고 캠페인의 비용 효율성 예측과 같은 여러 가지 작업을 수행할 수 있습니다.</p> |
...
| **모든 검색 페이지 순위** | 방문자가 사이트에 도달하기 위해 클릭스루한 검색 결과 페이지를 표시합니다. 예를 들어, 사이트가 검색 엔진의 검색 결과 중 두 번째 페이지에 나타나는 경우 이 변수의 차원 항목은 &quot;검색 페이지 2&quot;입니다.<p>**검색 결과의 페이지 순위를 더 잘 이해하는 데**&#x200B;도움이 됩니다.</p><p>**학습한 내용에 따라 여러 가지 작업을 수행할 수 있습니다** 검색 결과의 첫 페이지에 콘텐츠가 표시되도록 SEO 전략을 개선합니다. </p> |
