...
| **모바일** > **모바일 앱 사용** | 평균 세션 길이뿐만 아니라 앱의 사용자 수, 시작 횟수 및 첫 번째 시작 횟수를 봅니다.<p>**앱이 얼마나 사용되고 있는지 이해하는 데**&#x200B;도움이 됩니다. </p><p>**학습한 내용에 따라** 앱 성능을 개선하여 사용량을 늘릴 수 있도록 하는 등 여러 가지 작업을 수행할 수 있습니다.</p><!-- This template uses the --> |
| **모바일** > **모바일 앱 여정** | 모바일 앱에 대한 두드러진 사용 패턴을 봅니다. <p>**사람들이 앱을 사용하는 방법을 이해하는 데 도움이 됩니다**. </p><p>**학습한 내용에 따라** 사람들이 한 화면에서 다른 화면으로 이동하여 가장 일반적인 워크플로를 타깃팅하는 방법을 개선하는 등 여러 가지 작업을 수행할 수 있습니다. </p><!-- This template uses the --> |
| **모바일** > **모바일 앱 지표** | 가장 일반적인 모바일 앱 지표 중 일부를 봅니다. <p>**모바일 앱의 기본 성능을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라 앱의 전반적인 상태 및 성능 평가와 같은 다양한 작업을**&#x200B;할 수 있습니다.</p><!-- This template uses the --> |
| **모바일** > **모바일 앱 메시지** | 앱의 인앱 메시지 및 푸시 메시지에 대한 성능 데이터를 봅니다.<p>**이를 통해** 사람들이 인앱 메시지 기능을 사용하는 방법과 푸시 알림이 앱으로 트래픽을 유도하는 방법을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라 인앱 메시지 푸시 알림 환경을 개선하는 등** 다양한 작업을 수행할 수 있습니다.</p><!-- This template uses the --> |
| **모바일** > **모바일 앱 성능** | 앱이 수행되는 방식과 사용자에게 문제가 발생하는 위치를 봅니다. <p>**앱을 사용하는 사용자의 속도가 느려지거나 성능이 저하되는 경우**&#x200B;더 잘 이해할 수 있습니다. </p><p>**학습한 내용에 따라** 기존 문제를 해결하거나 문제가 발생하기 전에 앱 성능을 개선하는 등 여러 작업을 수행할 수 있습니다.</p><!-- This template uses the --> |
| **모바일** > **모바일 앱 유지** | 앱에서 가장 충성스러운 사용자와 앱 내에서 수행하는 작업을 확인합니다. <p>**가장 충성스러운 사용자가 앱을 사용하는 방법을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용에 따라** 가장 충성스러운 사용자가 사용하고 있는 기능에 대한 마케팅 노력을 개선하는 등 여러 가지 작업을 수행할 수 있습니다.</p><!-- This template uses the --> |
