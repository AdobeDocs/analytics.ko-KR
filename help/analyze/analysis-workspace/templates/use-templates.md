...
| 템플릿 이름 | 이 템플릿 <!-- What do you do with it? What can it help you learn? and What are the potential actions? -->을(를) 사용하는 이유 |
| --- | --- | 
| [!UICONTROL **사람 지표**] | 내 브랜드와 상호 작용하는 사람의 수를 확인할 수 있습니다. <p>**이를 통해** 사이트의 사용 추세를 파악할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 사이트의 새 방문자를 생성하는 데 있어 최근 마케팅 활동의 효과를 측정하는 등 다양한 작업을 수행할 수 있습니다.</p> |
