...
| [!UICONTROL **Adobe Experience Manager**] > [!UICONTROL **양식 성능 개요**] > [!UICONTROL **AEM 양식 성능**] | Adobe Experience Manager 양식에 대한 성능 데이터를 봅니다.  <p>**이를 통해** Adobe Experience Manager의 가치 실현을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** Experience Manager 설정을 최적화하는 등 다양한 작업을 수행할 수 있습니다.</p> |
...
| **범주** | 사이트에서 각 제품 카테고리와 연결된 방문 횟수를 봅니다. 이 기능은 제품 변수를 사용하고 제품 카테고리에 대한 지표를 보려는 구현에 유용합니다. 사이트에 제품이 없는 경우 이 템플릿을 채우는 차원이 의도적으로 비어 있을 수 있습니다.<p>**이를 통해 최다 판매 제품이나 가장 많이 본 제품을 더 잘 이해할 수 있습니다**. </p><p>**학습한 내용에 따라, 특정 제품에 대한 마케팅 캠페인의 효과를 측정하는 것과 같이**&#x200B;할 수 있습니다.</p><p>이 템플릿은 카테고리 차원 및 방문 횟수 지표를 사용합니다. |
...
| [!UICONTROL **판매량**] | 모든 주문 내에서 구매된 상품의 총 개수를 확인할 수 있습니다. 데이터는 일정 기간 동안 표시되며 이전 기간과 비교됩니다. <p>**이를 통해** 시간이 지남에 따라 판매량이 어떻게 증가하거나 감소하는지 더 잘 이해하는 데 도움이 될 수 있습니다. 세그먼트를 적용하여 가장 많은 상품을 구매하는 고객 또는 지역과 시간 경과에 따른 판매량 트렌딩을 파악할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 캠페인이 시작되기 전과 후의 판매량을 비교하여 최근에 시작된 마케팅 캠페인의 효과를 평가하는 등 다양한 작업을 수행할 수 있습니다. 또는 전년 대비 휴일 기간 동안의 판매량을 비교할 수도 있습니다.</p><p>이 템플릿은 [일 차원](/help/components/dimensions/day.md) 및 [단위 지표](/help/components/metrics/units.md)을 사용합니다.</p> |
| [!UICONTROL **Magento: 마케팅 및 상거래**] | 판매 개선에 도움이 되는 상거래 활동에 대한 소매점을 위해 미리 제작된 인사이트를 확인할 수 있습니다. 이는 Magento 사용자를 대상으로 하지만 모든 온라인 소매점에서 활용할 수 있습니다. <p>**이를 통해** 상거래 활동이 매출 수치에 어떻게 기여하는지 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 가장 많은 ROI를 얻는 활동에 대한 예산을 조정하는 등 다양한 작업을 수행할 수 있습니다.</p> |
...
| **방문자 프로필** > **기술** > **기술 개요** | 운영 체제, 브라우저 및 장치와 같이 사용자가 사이트에 액세스하는 데 사용하는 기술과 관련된 정보를 봅니다. <p>**이렇게 하면**&#x200B;사이트에 액세스할 때 가장 자주 사용되는 기술을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라** 사용 중인 기술에 맞게 사이트를 최적화하는 등 여러 가지 작업을 수행할 수 있습니다.</p> |
...
| **보트** | 사이트의 보트 트래픽에 대한 페이지 보기 수 및 트렌드를 봅니다. <p>**이렇게 하면**&#x200B;사용자가 구성한 보트 규칙에 따라 보고에서 필터링되는 보트 트래픽의 양을 더 잘 이해하는 데 도움이 됩니다.</p><p>**학습한 내용에 따라** 새로운 패턴을 식별하기 위해 보트 활동을 계속 모니터링하는 등 여러 가지 작업을 수행할 수 있습니다.</p><!-- This template uses the --> |
