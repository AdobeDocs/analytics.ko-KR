...
또는 **[!UICONTROL Components]** > 를 클릭할 수 **[!UICONTROL New Metric]**&#x200B;있습니다. 이 경우 기존 지표에서 사용자 지정 지표를 작성할 수 있는 [계산된 지표 빌더](https://marketing.adobe.com/resources/help/ko_KR/analytics/calcmetrics/)로 이동합니다.
