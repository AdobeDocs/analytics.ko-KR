...
다음 [!UICONTROL 주석 관리자] 사용자가 소유하거나 사용자와 공유된 모든 주석을 표시합니다. 프로젝트 특정 주석은 여기에 표시되지 않습니다. 이 인터페이스를 사용하여 주석을 공유, 필터링, 태그 지정, 복사, 삭제 및 즐겨찾기에 추가할 수 있습니다. 관리자는 주석을 관리하고 승인할 수 있습니다.
