...
모든 주석에는 타임스탬프가 있지만 시간 또는 시간대 정보가 없습니다. 보고서 시에는 패널 보고서 세트의 시간대가 항상 적용됩니다. 따라서 성탄절을 위해 만든 주석은 현재 어떤 보고서 세트 시간대에 맞추어 12월 25일에 수행됩니다. 또 다른 예는 설날입니다. 매시간마다, 새로운 해가 시작될 때 다른 시간대가 불꽃놀이를 한다. 미 동부 해안지역은 이미 동부시간으로 오전 12시 10분에 불이 붙기 시작했다.
