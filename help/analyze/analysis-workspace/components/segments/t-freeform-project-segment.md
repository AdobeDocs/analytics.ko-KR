...
| 빠른 세그먼트 | [빠른 세그먼트 빌더](/help/analyze/analysis-workspace/components/segments/quick-segments.md) | 프로젝트 수준이지만 저장하고 세그먼트 목록에 추가할 수 있습니다. | 하나 이상의 규칙을 추가/편집할 수 있는 유연성 |
| 임시 세그먼트: |  |  |  |
| - 애드혹 작업 공간 프로젝트 세그먼트 | [프로젝트의 세그먼트 드롭 영역으로 끌어다 놓습니다](/help/analyze/analysis-workspace/components/segments/ad-hoc-segments.md) | 프로젝트 수준이지만 저장하고 세그먼트 목록에 추가할 수 있습니다. | 기본적으로 단일 규칙 세그먼트(제한 없음) |
...
다음은 Analysis Workspace의 세그먼트 사용에 대한 비디오입니다.
...
구성 요소 메뉴 아래의 세그먼트 레일이 표시됩니다
* 사용자 또는 회사가 만든 세그먼트
* Adobe 아이콘으로 표시된 세그먼트 템플릿:

![](assets/segment_icons.png)

이 유형의 세그먼트를 만들려면 두 가지 선택 사항이 있습니다. 두 세그먼트 모두 Adobe Analytics의 [세그먼트 빌더](/help/components/segmentation/segmentation-workflow/seg-build.md)로 이동합니다.

* 왼쪽 레일에서 [!UICONTROL 세그먼트] 옆의 더하기 기호(+)를 클릭합니다.
...
세그먼트 IQ(세그먼트 비교라고도 함)는 다음 기능으로 구성됩니다.
