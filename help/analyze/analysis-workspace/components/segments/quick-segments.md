...
빠른 세그먼트로 사용자는 [세그먼트 빌더](/help/components/segmentation/segmentation-workflow/seg-build.md)에서 보다 복잡한 구성 요소 목록 세그먼트를 만들지 않고도 특정 프로젝트 내에서 데이터를 쉽게 탐색할 수 있습니다.
...
>[!MORELIKETHIS]
>
>[빠른 세그먼트 만들기](/help/components/segmentation/segmentation-workflow/seg-quick.md#create)
...
1. Select **[!UICONTROL Save]**.
   ...
   You can also [share the segment](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/curate.html?lang=ko#concept_4A9726927E7C44AFA260E2BB2721AFC6) with other people in your organization.
