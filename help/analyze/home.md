...
description: Analysis Workspace, Adobe Analytics 대시보드, Activity Map, Report Builder, 보고 API 및 보고 및 분석에 대한 제품 설명서 및 자체 도움말입니다.
...
* **[!UICONTROL Adobe Analytics 대시보드]:** 이 모바일 앱을 사용하면 사용자가 보다 자세한 분류 및 트렌드 보고서를 수행할 수 있는 기능과 주요 지표를 사용하여 직관적인 스코어카드에 모바일로 액세스할 수 있습니다.
...
* **[!UICONTROL Ad Hoc Analysis]:** 강력한 보고 기능을 갖춘 독립 실행형 Java 애플리케이션입니다. 이 도구는 더 이상 업데이트되지 않으며 2021년 3 [월 1일에 일몰이 적용됩니다](https://spark.adobe.com/page/S9Bhp66VJ2fEn/).

## 주요 Analytics 도구 문서

* [Adobe Analytics 대시보드 - 개요](/help/analyze/mobile-app/home.md)
* [Analysis Workspace 시작](analysis-workspace/home.md)
* [Adobe Analytics용 점진적 웹 앱](/help/analyze/pwa/pwa.md)
