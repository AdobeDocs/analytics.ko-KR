...
+ Analysis Workspace {#analysis-workspace}
   ...
   + 시각화 {#visualizations}
      ...
      + 여정 캔버스 {#journey-canvas}
         + {hide-from-toc}[개요](analysis-workspace/visualizations/journey-canvas/journey-canvas.md)
         + {hide-from-toc}[구성](analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md)
         + {hide-from-toc}[문제 해결](analysis-workspace/visualizations/journey-canvas/journey-canvas-troubleshooting.md)
...
+ 레거시 Report Builder {#legacy-report-builder}
   ...
   + 데이터 요청 {#data-requests}
      ...
      + 날짜 범위 {#date-ranges}
         ...
         + 사용자 정의된 날짜 표현식 {#customized-date-expressions}
            ...
            + [개별 시작 또는 종료 일자](legacy-report-builder/data-requests/configuring-report-dates/c-customized-date-expressions/individual-starting-or-ending-dates.md)
   ...
   + 레이아웃 - 요청 마법사 2단계 {#layout}
      ...
      + [날짜 포맷 지정](legacy-report-builder/layout/format-the-data.md)
      + [머리글 표시 포맷 지정](legacy-report-builder/layout/t-format-display-headers.md)
