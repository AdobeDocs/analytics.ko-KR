...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Build a Workspace project {#build-workspace-project}
      ...
      + Column and row settings {#column-row-settings}
         ...
         + [수동 행과 동적 행 비교](analysis-workspace/build-workspace-project/column-row-settings/manual-vs-dynamic-rows.md)
      + [설정 실행 취소 및 다시 실행](analysis-workspace/build-workspace-project/undo-redo.md)
      + [분석 작업 공간에서 사용할 수 있는 핫키](analysis-workspace/build-workspace-project/fa-shortcut-keys.md)
      + [페이지 매김, 표 필터링 및 정렬](analysis-workspace/build-workspace-project/pagination-filtering-sorting.md)
   ...
   + 구성 요소 {#components}
      ...
      + 차원 {#dimensions}
         ...
         + [시간 분할 차원](analysis-workspace/components/dimensions/time-parting-dimensions.md)
   ...
   + 시각화{#visualizations}를 참조하십시오 
      ...
      + 집단 테이블 {#cohort-table}
         + [집단 분석이란 무엇입니까?](analysis-workspace/visualizations/cohort-table/cohort-analysis.md)
      ...
      + 폴아웃 {#fallout}
         ...
         + [차원 폴아웃](analysis-workspace/visualizations/fallout/configuring-interdimensional-fallout.md)
      ...
      + [스택된 영역 및 영역](analysis-workspace/visualizations/area.md)
      + [스택된 막대 및 막대](analysis-workspace/visualizations/bar.md)
   ...
   + 패널 {#panels}
      ...
      + Segment comparison (IQ) {#segment-comparison}
         ...
         + [세그먼트 IQ 사용 사례](analysis-workspace/c-panels/c-segment-comparison/segment-compare-use-cases.md)
         + [세그먼트 비교에 사용된 통계 테스트](analysis-workspace/c-panels/c-segment-comparison/statistical-test.md)
   + Curate or Share projects {#curate-share}
      ...
      + [파일 보내기 - 배달할 프로젝트 예약](analysis-workspace/curate-share/t-schedule-report.md)
      + [예약된 프로젝트 관리자](analysis-workspace/curate-share/schedule-projects.md)
   + 속성 IQ {#attribution-iq}
      + [기여도 IQ 개요](analysis-workspace/attribution-iq/attribution.md)
      + [분석 작업 공간에서 기여도 IQ 사용](analysis-workspace/attribution-iq/use-attribution-iq.md)
      + [계산된 지표에서 기여도 분석 사용](analysis-workspace/attribution-iq/attribution-calcmetrics.md)
   ...
   + 가상 분석가 {#virtual-analyst}
      ...
      + 예외 항목 탐지 {#anomaly-detection}
         ...
         + [분석 작업 공간에서 예외 항목 보기](analysis-workspace/virtual-analyst/c-anomaly-detection/view-anomalies.md)
         + [예외 항목 감지 끄기](analysis-workspace/virtual-analyst/c-anomaly-detection/anomaly-detection-turnoff.md)
   ...
   + [작업 영역 성능 최적화](analysis-workspace/optimizing-performance.md)
   + [Ad Hoc Analysis과 비교한 Analysis Workspace](analysis-workspace/adhocanalysis-vs-analysisworkspace.md)
   + [분석 작업 공간 제한 사항](analysis-workspace/aw-limitations.md)
+ Report Builder {#report-builder}
   + [Adobe Report Builder 도움말](report-builder/home.md)
   + [리포트 빌더의 새로운 기능](report-builder/whats-new-arb.md)
   + Report Builder setup {#report-builder-setup}
      ...
      + [Microsoft Excel 함수에서 리포트 빌더 기능 호출](report-builder/setup/invoke-arb-excel-function.md)
   + [리포트 빌더 도구 모음](report-builder/reportbuilder-toolbar.md)
   + Data requests {#data-requests}
      + [데이터 요청 - 요청 마법사 1 단계](report-builder/data-requests/data-requests.md)
      + [데이터 요청 만들기](report-builder/data-requests/t-create-a-data-request.md)
      + Report suites {#report-suites}
         + [보고서 세트를 선택합니다](report-builder/data-requests/selecting-report-suites/t-select-report-suites.md)
         ...
         + [Excel를 사용하여 보고서 세트 ID 찾기](report-builder/data-requests/selecting-report-suites/use-excel-to-locate-a-report-suite-id.md)
      ...
      + Report types {#report-types}
         ...
         + [리포트 빌더의 경로 및 경로 폴아웃 보고서](report-builder/data-requests/c-report-types/report-path-fallout.md)
      ...
      + [책갈피가 지정된 보고서 및 대시보드 Reportlet 가져오기](report-builder/data-requests/import-bookmarked.md)
      + 날짜 범위 {#date-ranges}
         ...
         + [롤링 날짜](report-builder/data-requests/configuring-report-dates/t-rolling-dates.md)
         + [요청 마법사 정의 - 롤링 날짜](report-builder/data-requests/configuring-report-dates/r-arb-rolling-dates.md)
   ...
   + 레이아웃 - 요청 마법사 2단계 {#layout}
      ...
      + Metrics and dimensions {#metrics-dimension}
         ...
         + [트래픽 및 상거래 지표를 동일한 요청에서 결합](report-builder/layout/c-metrics-dimensions/grouped-metrics.md)
         + [차원 및 지표에 대한 사용자 액세스 권한](report-builder/layout/c-metrics-dimensions/permissions-metrics-dimensions.md)
      ...
      + [예외 검색](report-builder/layout/anomaly-detection.md)
      ...
      + [텍스트를 셀에 프리펜드 및 포스트펜드](report-builder/layout/prepend-and-postpend-text-to-cells.md)
      + [사용자 지정 레이아웃 구성](report-builder/layout/configure-the-custom-layout.md)
      + [지표와 차원을 셀에 매핑](report-builder/layout/map-metrics-and-dimensions-to-cells.md)
      ...
      + Filter dimensions {#filter-dimenson}
         ...
         + [가장 빈도가 높은 필터링](report-builder/layout/c-filter-dimensions/t-most-popular-filtering.md)
         + [특정 필터](report-builder/layout/c-filter-dimensions/t-specific-filters.md)
         + [저장된 필터](report-builder/layout/c-filter-dimensions/saved-filters.md)
   + Manage requests {#manage-requests}
      ...
      + [여러 요청에서 지표 편집](report-builder/manage-requests/edit-multiple-metrics.md)
...
+ Activity Map {#activity-map}
   ...
   + [표준 모드와 라이브 모드](activity-map/activitymap-standard-live.md)
   + [링크 보고서](activity-map/activitymap-links-report.md)
   + [페이지 세부 사항](activity-map/activitymap-page-flow.md)
   ...
   + [사용자 정의 가능한 오버레이](activity-map/activitymap-gainerslosers.md)
   + [오버레이 상세 정보](activity-map/activitymap-overlay-details.md)
   ...
   + 링크 추적 {#link-tracking}
      + [링크 추적 방법](activity-map/activitymap-link-tracking/activitymap-link-tracking-methodology.md)
   ...
   + [Analytics의 Activity Map 보고](activity-map/activitymap-reporting-analytics.md)
...
+ Reports and Analytics {#reports-analytics}
   ...
   + Customize reports {#customize-reports}
      + [보고서 개요 사용자 지정](reports-analytics/reports-customize/customizing-reports-overview.md)
   ...
   + [데이터 웨어하우스 요청](reports-analytics/data-warehouse.md)
   + [FAQ](reports-analytics/frequently-asked-questions.md)
+ Ad Hoc Analysis {#ad-hoc-analysis}
   + Ad Hoc Analysis 프로젝트 변환기 {#aha-project-converter}
      + [애드혹 분석 프로젝트 변환기 개요](ad-hoc-analysis/c-aha-project-converter/aha2aw-overview.md)
      + [애드혹 분석에서 프로젝트 변환](ad-hoc-analysis/c-aha-project-converter/aha2aw-workflow.md)
      + [분석 작업 공간에서 전환된 프로젝트 보기](ad-hoc-analysis/c-aha-project-converter/view-projects-workspace.md)
      + [프로젝트 변환기 FAQ](ad-hoc-analysis/c-aha-project-converter/aha2aw-converter-faq.md)
   + [애드혹 분석 개요](ad-hoc-analysis/adhoc-home.md)
   + [시작하기](ad-hoc-analysis/c-getting-started.md)
   + [관리](ad-hoc-analysis/c-administration.md)
   + [Java 11를 사용하여 애드혹 분석 실행](ad-hoc-analysis/adhoc-java.md)
   ...
   + [사이트 컨텐츠 보고서](ad-hoc-analysis/c-reports-site-content.md)
