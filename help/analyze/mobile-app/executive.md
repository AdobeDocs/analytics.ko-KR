...
이 안내서는 Analytics 대시보드에서 스코어카드를 읽고 해석하는 데 도움이 되도록 구성되었습니다. 이 앱을 사용하면 보유한 모바일 장치에서 중요한 요약 데이터의 광범위한 렌더링을 빠르고 쉽게 볼 수 있습니다.
...
대시보드를 효과적으로 사용하려면 스코어카드 큐레이터가 이를 설정하는 데 도움이 있어야 합니다. 이 섹션에서는 큐레이터의 도움을 받아 설정하는 데 유용한 정보를 제공합니다.
