...
1. 앱에 로그인합니다. 대시보드를 실행하면 로그인 화면이 나타납니다. 기존 Adobe Analytics 자격 증명을 사용하여 화면의 안내에 따릅니다. Adobe ID와 Enterprise/Federated ID를 모두 지원합니다.
...
| 용어 | 정의 |
|--- |--- |
| 소비자 | 모바일 디바이스에서 Analytics를 통해 주요 지표와 인사이트를 확인하는 경영진 페르소나 |
| 큐레이터 | Analytics에서 인사이트를 찾아 배포하고, 소비자가 볼 스코어카드를 구성하는 데이터 활용형 페르소나 |
