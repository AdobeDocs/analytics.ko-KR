...
예를 들어 타일에 드래그 앤 드롭하여 적절한 차원(이 예에서는 **[!DNL Marketing Channel]**)을 **[!UICONTROL 고유 방문자]** 지표에 추가할 수 있습니다. Dimension 분류은 [!UICONTROL 드릴 인] 슬라이드별 세부 정보 섹션 **[!UICONTROL 속성]**. 각 타일에 여러 차원을 추가할 수 있습니다.
...
스코어카드 빌더에서 타일을 클릭하면 오른쪽 레일에 해당 타일과 연관된 속성 및 특성과 세부 슬라이드가 표시됩니다. 이 레일에서 새 항목을 제공할 수 있습니다 **제목** 또는 타일에 대해 세그먼트를 적용하여 타일을 구성합니다.
...
분류는 지표를 차원 항목별로 문자 그대로 분류하여 분석을 세분화합니다.
...
세부 사항 슬라이드에 추가된 각 차원이 앱의 세부 사항 슬라이드 보기에서 드롭다운 목록에 표시됩니다. 그러면 경영진 사용자는 드롭다운 목록에 나열된 옵션 중에서 선택할 수 있습니다.
