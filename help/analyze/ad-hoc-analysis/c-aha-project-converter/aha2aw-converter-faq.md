 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>편집(연필) 아이콘을 클릭하여 <a href="https://docs.adobe.com/content/help/ko-KR/analytics/components/calculated-metrics/cm-overview.html"  >계산된 지표 빌더</a>에서 할당 유형을 편집할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
