...
Adobe Analytics 랜딩 페이지에는 다음 하위 탭이 포함되어 있습니다.
...
**[!UICONTROL 학습]**: 실습형 비디오 둘러보기, 튜토리얼 및 설명서 링크가 포함되어 있습니다.

![랜딩 페이지 왼쪽 레일](assets/aa-landing-page-left-rail.png)
...
## 프로젝트 {#navigate-projects}

왼쪽 레일의 **[!UICONTROL 프로젝트]** 섹션은 [!UICONTROL **Workspace**] 탭의 홈 페이지 역할을 합니다.

Adobe Analytics의 프로젝트에 액세스하려면:

1. [!UICONTROL **Workspace**] 탭을 선택합니다.

1. 왼쪽 레일에서 [!UICONTROL **프로젝트**]&#x200B;를 선택합니다.

프로젝트 섹션에는 회사 폴더, 생성한 모든 개인 폴더, Workspace 프로젝트 및 모바일 스코어카드가 표시됩니다. 이 페이지를 사용하여 폴더, 프로젝트 및 모바일 스코어카드를 보고, 만들고, 수정합니다. 자세한 내용은 [프로젝트](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md)를 참조하십시오.
...
자세한 내용은 [프로젝트](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md)를 참조하십시오.
...
| [!UICONTROL 간단히 표시<br> 자세히 표시] | 배너 표시/숨김 전환: ![상단 배너](assets/top-banner.png) |
...
| 정보(i) 아이콘 | 프로젝트에 대한 유형, 프로젝트 역할, 소유자, 설명, 공유 대상과 같은 정보가 표시됩니다. 또한 누가 이 프로젝트를 [편집 또는 복제](/help/analyze/analysis-workspace/curate-share/share-projects.md)할 수 있는지도 나타냅니다. |
...
## 템플릿 {#navigate-reports}

Adobe Analytics에서 템플릿에 액세스하려면 다음을 수행하십시오.
...
1. Adobe Analytics에서 [!UICONTROL **구성 요소**] > [!UICONTROL **환경 설정**] > [!UICONTROL **일반**]&#x200B;을 선택합니다.
1. 원하는 랜딩 페이지를 선택합니다.
