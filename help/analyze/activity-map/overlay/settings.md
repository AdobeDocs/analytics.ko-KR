...
| **[!UICONTROL 그라데이션 투명도]** | 그라디언트 오버레이의 투명도 수준을 선택합니다. 이 설정은 [!UICONTROL Bubble] 오버레이에 영향을 주지 않습니다. |
...
| 설정 | 설명 |
|---|---|
| **[!UICONTROL 상위 표시]** | **[!UICONTROL 승자]** 또는 **[!UICONTROL 패자]**(또는 둘 다)를 오버레이로 표시하려면 링크 수를 선택하십시오. |
