...
* **[!UICONTROL 하위(%) 제외]**: 링크 변경 사항의 하위 백분율을 필터링하여 관련 손익을 표시할 수 있는 데이터가 충분한 링크만 표시합니다. 백분율은 해당 페이지의 링크 수를 기반으로 계산됩니다. 예를 들어 200개 링크 목록의 하위 10%를 필터링하면 하위 20개 링크가 필터링됩니다.
