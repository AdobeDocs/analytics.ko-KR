...
페이지의 링크 또는 링크 위치에 대한 고유 개체 ID를 작성함으로써 링크 URL보다는 링크 유형 또는 위치에 대한 보고서에서 [!DNL Activity Map] 추적을 개선하거나 [!DNL Activity Map]을 사용할 수 있습니다. s_objectID 변수에 대해 자세히 알려면 [여기](https://marketing.adobe.com/resources/help/en_US/sc/implement/s_objectID.html)를 클릭하십시오.
