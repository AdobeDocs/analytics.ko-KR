---
description: 'Activity Map은 '
seo-description: 'Activity Map은 '
seo-title: 강력한 링크 추적
solution: Analytics
title: 강력한 링크 추적
topic: Activity Map
...
> [!CAUTION] Activity Map 추적을 켜면 개인 식별 정보(PII) 데이터를 수집할 수 있습니다. 이 데이터는 단독으로 사용하거나 다른 정보와 함께 사용하여 한 개인을 식별, 연락 또는 위치를 지정하거나, 혹은 컨텍스트에서의 개인을 식별하는 데 쓰일 수 있습니다.
