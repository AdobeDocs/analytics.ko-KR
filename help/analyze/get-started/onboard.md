---
title: Adobe Analytics 온보딩
description: Adobe Analytics 디지털 경험 온보딩 시리즈에 오신 것을 환영합니다! 귀하와 조직이 성공할 수 있도록 Adobe Analytics를 지원하는 주요 Adobe 플랫폼으로 온보딩합니다.
role: Admin
...
Adobe Analytics 디지털 경험 온보딩 시리즈에 오신 것을 환영합니다!

조직에서 Adobe Analytics를 사용하여 데이터를 수집하고 모든 디지털 고객 상호 작용에서 실행 가능한 인사이트를 얻을 수 있습니다. 심층적인 분석, 다목적 보고 및 예측 인텔리전스를 통해 조직은 더 나은 고객 경험을 구축하는 데 필요한 통찰력을 얻을 수 있습니다.

Adobe Analytics 여정은 올바른 구성 및 사용자 액세스 온보딩으로 시작합니다. 아래 리소스는 이러한 온보딩을 간소화하여 사용자와 조직이 Adobe Analytics을 보다 쉽게 성공할 수 있도록 해 줍니다.

다음 비디오를 통해 문서화 및 지원을 위해 Adobe Admin Console for User 및 Access 설정에서 Adobe Experience League로의 온보딩 여정, 마지막으로 Adobe Analytics 자체를 완료하십시오.
...
* ./onboard.md
  ...
  {image = https://video.tv.adobe.com/v/3476891/?captions=kor&format=jpeg&nocache=1763486440891}
...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="#adobe-experience-league" title="Adobe Experience League" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3476891/?captions=kor&format=jpeg&nocache=1763486440891" alt="Adobe Experience League"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">성공하는 데 도움이 되는 설명서, 튜토리얼 등에 액세스하려면 Adobe Experience League에 온보딩하십시오.</p>
                </div>
                <a href="#adobe-experience-league" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">온보드</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">조직의 제품 자격을 관리하려면 Adobe Admin Console에 온보딩하십시오. 사용자 액세스를 추가, 제거 또는 수정합니다.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Adobe Admin Console User Management">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="#admin-console-user-management" title="Adobe Admin Console 사용자 관리" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3476898/?format=jpeg&nocache=1763486440891" alt="Adobe Admin Console 사용자 관리"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="#admin-console-user-management" target="_blank" rel="referrer" title="Adobe Admin Console 사용자 관리">Adobe Admin Console 사용자 관리</a>
                    </p>
                    <p class="is-size-6">Adobe Admin Console 사용자 관리에 온보딩하여 사용자, 그룹 및 프로필을 관리합니다. 사용자 또는 그룹에 제품 역할을 할당하는 방법을 알아봅니다.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Raise a Support Case">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="#raise-a-support-case" title="지원 사례 올리기" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3476787/?format=jpeg&nocache=1763486440891" alt="지원 사례 올리기"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="#raise-a-support-case" target="_blank" rel="referrer" title="지원 사례 올리기">지원 사례 발생</a>
                    </p>
                    <p class="is-size-6">Adobe Experience League에 온보딩하여 지원 사례를 제기하고 활성 사례 및 이전 사례를 검토하십시오.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Adobe Analytics 여정은 올바른 구성 및 사용자 액세스 온보딩으로 시작합니다. 아래 리소스는 이러한 온보딩을 간소화하여 사용자와 조직이 Adobe Analytics을 보다 쉽게 성공할 수 있도록 해 줍니다.</p>
                </div>
...
>[!VIDEO](https://video.tv.adobe.com/v/3476891/?captions=kor&learn=on&enablevpops)
...
조직의 제품 권한을 관리하려면 [Adobe Admin Console](https://adminconsole.adobe.com/)에 온보딩하십시오. 사용자 액세스를 추가, 제거 또는 수정합니다.

## Adobe Admin Console 사용자 관리

>[!VIDEO](https://video.tv.adobe.com/v/3476898/?learn=on&enablevpops)

[Adobe Admin Console 사용자 관리](https://adminconsole.adobe.com/redirect@AdobeOrg/users)에 온보딩하여 사용자, 그룹 및 프로필을 관리합니다. 사용자 또는 그룹에 제품 역할을 할당하는 방법을 알아봅니다.
...
2. [보고서 세트 이해 및 생성](https://experienceleague.adobe.com/ko/docs/analytics-learn/tutorials/intro-to-analytics/analytics-basics/understanding-and-creating-report-suites)
