...
사용 [!UICONTROL **보고서**] 왼쪽 레일의 영역 [!UICONTROL **작업 영역**] 탭. 자세한 내용은 [Adobe Analytics 랜딩 페이지](/help/analyze/landing.md)에서 *보고서 탭 탐색*&#x200B;을 참조하십시오.
...
2. 다음 제품 기능 중 하나를 선택하여 구성하십시오.
   ...
   | 보고 활동 관리자 | 보고 활동 관리자를 사용하면 조직의 각 보고서 세트에 대한 보고 용량을 확인할 수 있습니다. 보고 사용량에 대해 상세한 가시성을 제공하며, 최대 보고 시간 동안 발생할 수 있는 용량 문제를 쉽게 진단하고 해결할 수 있도록 해 줍니다. | [보고 활동 관리자](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/reporting-activity.html?lang=en) |
