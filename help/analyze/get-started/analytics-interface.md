...
2. 다음 제품 기능 중 하나를 선택하여 구성하십시오.
   ...
   | Advertising Analytics | 모든 Google 및 Bing 유료 검색 데이터를 나란히 표시하도록 Adobe Analytics를 구성합니다. | [Advertising Analytics 구성](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/advertising-analytics-config.html) |
