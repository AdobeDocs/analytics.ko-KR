...
보고서 테이블의 백분율을 그래프로 표시할지 여부를 지정할 수 있습니다.
...
지정된 날짜 범위에서 매주 월요일 동안과 같이 특정 요일에 보고서를 실행할 수 있습니다.
