...
Report Builder for Adobe Analytics은 Microsoft Excel 추가 기능입니다. 이 추가 기능은 다음 플랫폼에서 사용할 수 있습니다.
...
이 Report Builder은 [기존 Report Builder 추가 기능](/help/analyze/legacy-report-builder/home.md)을 대신하며 다음과 같은 몇 가지 이점을 제공합니다.
...
### 레거시 Report Builder 기능은 지원되지 않음

이 Report Builder에서는 기존 Report Builder의 일부 [기능이 지원되지 않습니다](convert-workbooks.md#legacy-report-builder-features-not-supported).
...
[Report Builder 스토어](https://appsource.microsoft.com/en-us/product/office/WA200003101?tab=Overview)에서 Adobe Analytics에서 Microsoft을 다운로드할 수 있습니다.
