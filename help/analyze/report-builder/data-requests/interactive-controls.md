...
1. 드롭다운 **[!UICONTROL Commonly Used Dates]** 옆에서 **[!UICONTROL Control Settings]** 아이콘을 클릭합니다.
...
1. 클릭 **[!UICONTROL OK]**. 지정한 셀 위치에 제어가 나타납니다.
...
1. 요청을 복사하고 마우스 오른쪽 단추를 클릭하여 두 개의 요청 붙여넣기 옵션 중 하나를 사용할 수 있습니다.
   ...
   * **[!UICONTROL Paste Request]** > **[!UICONTROL Use Absolute Input Cell]**. 이것은 복사한 요청이 원본 요청과 동일한 양방향 날짜 범위 제어를 가리키게 됨을 의미합니다.

   * **[!UICONTROL Paste Request]**> **[!UICONTROL Use Relative input Cell]**. 이것은 복사한 요청이 자체 컨트롤을 지시함을 의미합니다.
