...
문제 해결 및 지원 티켓 해결에 도움이 필요하면 Report Builder 요청을 기록할 수 있습니다. **[!UICONTROL Report Builder]** 패널에서:

1. ![설정](/help/assets/icons/Setting.svg)을 선택합니다.
1. **[!UICONTROL 웹 콘솔에 Report Builder 요청 데이터 블록 기록]**&#x200B;을 선택하십시오. <br/>요청을 웹 브라우저 콘솔로 보냅니다. 웹 브라우저 개발자 도구의 일부로 콘솔 로그를 여는 방법은 웹 브라우저의 설명서를 참조하십시오.
