...
1. 추가 기능 도구 모음에서 **[!UICONTROL 옵션]** ![](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Settings_18_N.svg):

| 요소 | 설명 |
|--- |--- |
| [!UICONTROL 기준 날짜] |  |
| 현재 날짜로 설정 | 을(를) 지정하거나 재설정할 수 있도록 해줍니다  [!UICONTROL 기준 날짜] 따라서 Report Builder이 현재 날짜를 사용하거나 새로 고침 시 사용할 날짜를 묻습니다. |
