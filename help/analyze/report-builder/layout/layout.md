...
seo-description: 요청 마법사 2단계 창을 사용하면 출력에 대한 보고서 레이아웃, 머리글 서식 및 차원 필터링을 구성할 수 있습니다. 피벗 레이아웃을 사용하여 요청을 구성할 수 있으며 이것은 Excel 피벗 테이블을 만드는 방식과 유사합니다.
seo-title: 레이아웃 - 요청 마법사 2단계
solution: Analytics
