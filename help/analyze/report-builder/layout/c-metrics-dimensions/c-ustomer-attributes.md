...
seo-description: 사용자 특성은 VisAttr이라는 새로운 유형의 요소에 저장되며 이것은 차원이나 지표로 구성할 수 있습니다.
seo-title: 고객 속성
title: 고객 속성
...
* 지표로 구성된 경우 VisAttr은 "차원"과 지표 모두로 노출됩니다.

   ![](assets/ca_metrics.png) ![](assets/ca_dimension.png)

* eVar와 동일한 분류를 지원합니다(모두를 무엇으로든 분류 가능).
* VisAttr은 모든 eVar 지표를 지원합니다.
* 지표로 된 VisAttr은 "상용화"(사이트에서 보낸 시간 등)를 지원합니다.0 - 30, 31 - 60,..)
