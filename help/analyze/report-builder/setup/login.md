...
1. **[!UICONTROL 로그인]**&#x200B;을 클릭합니다. 다음 방법을 사용하여 서명할 수도 있습니다.
   ...
   * 요청 관리자에서 요청을 선택한 다음 **[!UICONTROL 추가]** 또는 **[!UICONTROL 관리]**&#x200B;를 클릭합니다. 자세한 내용은 [요청 관리자에서 요청 선택](/help/analyze/report-builder/manage-requests/r-arb-manage-requests.md)을 참조하십시오.
