...
포함된 요청이 있는 보고서를 만들 때 다음을 사용하여 저장할 수 있습니다. **파일** > **저장** 또는 **파일** > **다른 이름으로 저장** Excel에서. Report Builder은 보고서에 요청이 포함되어 있는지 여부를 감지합니다. 저장 옵션 중 하나를 선택하면 **다른 이름으로 통합 문서 저장** 양식.
