...
방문자가 사이트로 유입되기 전 있었던 위치에 대한 인사이트를 제공하는 보고서를 포함합니다. 보고서 세트 설정에서 [내부 URL 필터](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/general/internal-url-filter-admin.md)를 올바르게 설정하지 않으면 이러한 보고서가 제대로 작동하지 않습니다.
...
>[!NOTE]
>
>이 도움말 페이지에서 보고서를 찾을 수 없는 경우 관리자의 이름을 바꾸거나 폴더를 조정했을 수 있습니다. 관리 사용 안내서에서 [메뉴 최적화](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/general/customize-menus.md)를 참조하십시오.
