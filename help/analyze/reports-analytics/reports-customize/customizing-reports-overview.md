...
보고서의 현재 구성을 모든 사용자가 볼 수 있도록 새 사용자 지정 보고서로 저장할 수 있습니다.
...
비율을 보고서 테이블에 그래프로 표시하려면 다음을 수행하십시오.
...
보고서에 대한 웹 사이트 페이지에서 특정 페이지를 선택하려면 다음을 수행하십시오.
...
시간별, 일별, 주별, 월별, 분기별 또는 연도별 보고서 합계를 볼 수 있습니다.
