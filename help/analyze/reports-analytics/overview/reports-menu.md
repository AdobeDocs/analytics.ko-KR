---
description: 보고 및 분석의 보고서 메뉴에 대한 개요입니다.
title: 보고서 메뉴
...
보고 및 분석의 보고서 메뉴에 대한 개요입니다.

보고서 메뉴에서는 다음을 제공합니다.

* 전체 보고서 세트에 대한 액세스
* 빠른 액세스를 위해 즐겨 사용하는 보고서를 설정하는 기능
* 자주 본 보고서
* 향상된 검색

![](assets/menu-mainnav.png)

내 즐겨찾기, 자주 조회함 및 보고서 내역은 모두 보고서 세트별로 다릅니다. 보고서 세트를 변경하면 세 개의 목록이 모두 변경됩니다.

보고서는 계층적 열 보기를 사용하여 탐색됩니다. 슬래시 키(/)를 **[!UICONTROL View All Reports]**&#x200B;클릭하거나 누른 다음 아래쪽 화살표 키(?)를 누릅니다. 화살표 키를 사용하여 메뉴를 빠르게 표시하고 탐색합니다. Esc 키를 눌러 현재 보고서를 변경하지 않고 메뉴를 닫거나 Enter 키를 눌러 선택한 보고서를 로드합니다.

![](assets/reports-landing.png){width=&quot;672px&quot;}

개별 보고서에 대한 자세한 내용은 보고서 [설명을 참조하십시오](https://marketing.adobe.com/resources/help/ko_KR/reference/reports_descriptions.html).

## 보고서 검색 {#section_E5EF11E36CB9451AA7B079E585CA7DB6}

보고서 메뉴에서는 향상된 검색 환경을 제공합니다. 을 **[!UICONTROL View All Reports]** 클릭하거나 슬래시 키(/)를 누른 다음 입력을 시작하여 보고서를 빠르게 찾습니다. 보고서 검색이 Analytics 왼쪽 탐색(관리, 구성 요소 등)에 모든 것을 포함하도록 확장되었습니다.

![](assets/menu-search.png)

Tab 키 또는 아래쪽 화살표 키(?)를 누릅니다. 를 클릭하여 보고서 목록을 탐색합니다. Esc 키를 눌러 현재 보고서를 변경하지 않고 검색을 닫거나 Enter 키를 눌러 선택한 보고서를 로드합니다.

>[!NOTE] 이제 prop, eVar 및 이벤트 번호로 보고서 목록을 검색할 수도 있습니다. 검색 막대에서 prop, eVar 또는 이벤트 번호를 입력합니다.
...
<table id="table_3BA295966BBC4C94ABDC3718D1894698"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 이 단추를 클릭하면 보고서 메뉴가 확장되거나 축소되어 브라우저 창의 전체 너비를 사용하여 보고서를 볼 수 있습니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 필요한 리소스를 검색할 수 있습니다. "퍼지" 검색을 사용하므로 원하는 단어를 정확하게 입력할 필요가 없습니다. 검색 결과는 위쪽, 아래쪽 및 측면 화살표를 사용하여 탐색할 수 있는 직선 목록에 표시됩니다. 검색 결과에서 <span class="uicontrol">Enter</span> 키를 누르면 해당 보고서가 바로 표시됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="uicontrol">내 즐겨찾기</span> </td> 
   <td colname="col2">이 영역에서 <span class="uicontrol">즐겨찾기로 지정</span>으로 표시한 보고서를 쉽게 검색할 수 있습니다. 사용자 및 보고서 세트별로 10개의 즐겨찾기와 <span class="uicontrol">더 보기...</span> 링크(즐겨찾기가 10개가 넘을 때)가 표시됩니다. <p>내 즐겨찾기에서 보고서의 이름을 변경할 수는 있지만 대시보드에는 이름을 변경할 수 없습니다. </p> <p>즐겨찾기는 책갈피와 비슷하지만 책갈피처럼 폴더에 저장하거나 책갈피 관리자를 통해 <a href="/help/analyze/reports-analytics/bookmarks.md"  > 관리되지는</a> 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="uicontrol"> 자주 조회함</span> </td> 
   <td colname="col2"> Adobe Analytics는 지난 90일 동안 가장 자주 실행한 10개의 보고서를 추적하여 여기에 표시하고, 실행 빈도별로 정렬합니다. 이 보고서 세트에 90일 이상 있지 않은 경우, 10개의 인기 있는 보고서의 일반 목록으로 채워집니다. </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="uicontrol"> 보고서 내역</span> </td> 
   <td colname="col2"> 여기에서 지난 90일 동안 액세스한 최근 10개의 보고서나 대시보드를 확인할 수 있습니다. 분석 또는 보고에서 이전 단계로 돌아가는 방법을 쉽게 찾을 수 있습니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 다음 작업 전부 또는 일부를 수행할 수 있습니다.인쇄, 데이터 추출, 경고 추가, 사용자 지정 보고서 만들기, 그래프 복사, 이 보고서에 대한 링크, 새 창 열기 </td> 
  </tr> 
  <tr> 
...
관리자는 보고서 메뉴에 포함된 보고서를 변경할 수 있습니다. 관리 [도움말의 메뉴 사용자](https://marketing.adobe.com/resources/help/ko_KR/reference/customize_menus.html) 지정을 참조하십시오.
