...
* 상단 Analytics 메뉴 변경 사항: **[!UICONTROL 보고서]** 상단 메뉴는 더 이상 존재하지 않습니다. 대부분의 보고서는 이제 왼쪽 레일의 [!UICONTROL 보고서] 메뉴에 있습니다.
* 왼쪽 레일에는 [!UICONTROL 프로젝트], [!UICONTROL 보고서], [!UICONTROL 학습] 등 세 가지 탭이 있습니다. 다음 섹션에서 각각의 탭에 대해 보다 자세히 살펴보겠습니다.

### 용어

용어에 대한 몇 가지 변경 사항 참고:
...
| 간단히/자세히 표시 | 배너 표시 안 함과 표시 간 전환: ![](assets/top-banner.png) |
...
| 이름 | 프로젝트의 이름입니다 |
| 고정 아이콘 | **새로운 기능** 이제 항목을 고정할 수 있으며 *항상* 목록의 맨 위에 나타납니다. |
...
다음은 새로운 메뉴와 해당 하위 메뉴입니다. 특정 보고서를 찾을 수 없는 경우 “페이지에서 검색”을 수행하여 찾습니다.
...
| 관리자가 사용자를 위해 이 새 랜딩 페이지를 지정할 수 있습니까? | 아니요, 관리자는 사용자를 대신하여 새 랜딩 페이지를 지정할 수 없습니다. 개별 사용자가 직접 토글을 켜야 합니다. |
