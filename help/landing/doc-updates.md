...
* [!UICONTROL Customer Journey Analytics]에 대한 자세한 내용은 [여기를](https://docs.adobe.com/content/help/ko-KR/analytics-platform/using/cja-landing.html)참조하십시오.
...
| 날짜 | 설명 |
|---|---|
| 2020년 7월 21일 | 크로스 디바이스 Analytics의 주요 업데이트 및 [수정 사항](/help/components/cda/overview.md). 필드 [기반 스티칭이 추가되었습니다](/help/components/cda/field-based-stitching.md). |
...
| 2020년 2월 7일 | [교차 장치 분석 설정](../components/cda/setup.md) 및 [FAQ](../components/cda/faq.md)에 대한 업데이트 |
