...
보고서에 고유 값이 많으면 Adobe은 보고서에 가장 중요한 값이 표시되도록 하는 기능을 제공합니다. 약 50만 개의 기존 값 이후에 수집된 고유 변수 값은 **(낮은 트래픽)**&#x200B;이라는 라인 항목 아래에 나열됩니다.
...
* 변수가 이 첫 번째 임계값인 50만에 도달하면 데이터가 낮은 트래픽에서 그룹화되기 시작합니다. 이 임계값을 초과하는 각 값은 다음 논리를 거칩니다.
   ...
   * 값이 보고에 아직 없는 경우 &quot;본 숫자 값&quot; 임계값은 백엔드 구성에 따라 달라집니다. 그것들은 눈에 보이는 정확한 &quot;10&quot; 또는 &quot;100&quot;을 구성하지 않습니다.
