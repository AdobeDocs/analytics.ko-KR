...
이전에 조직의 다운로드 키([!DNL `authorized_keys`]1단계: 데이터 다운로드를 위해 조직의 SSH 키 생성[에서 생성한 키)를 추가한 것과 동일한 &#x200B;](#step-1-generate-your-organizations-ssh-keys-for-downloading-data) 파일에 이 공개 키를 추가해야 합니다.
