...
귀하는 데이터 제어자로서 Adobe가 귀하를 대신하여 처리하고 저장하는 개인 데이터를 결정합니다. Adobe CX 엔터프라이즈 솔루션을 사용하는 경우 Adobe은 사용하는 솔루션 및 Adobe CX 엔터프라이즈 계정에 전송하기로 선택한 정보에 따라 개인 데이터를 호스팅할 수 있습니다. 예제 목록은 [Adobe CX Enterprise 개인 정보](https://www.adobe.com/kr/privacy/marketing-cloud.html#collect)를 참조하십시오.

![](assets/privacy_ready.png)

## Adobe에서 GDPR 데이터를 처리하는 방법

Adobe CX Enterprise는 사용자 브랜드의 데이터 거버넌스 인프라와 이 인프라가 소비자 경험을 생성하고 관리하는 데 사용하는 Adobe 도구를 연결하는 통합 솔루션을 제공합니다. Adobe CX Enterprise의 데이터 거버넌스 기능을 사용하면 데이터 거버넌스 정책을 데이터 사용과 직접 연결할 수 있습니다.

GDPR 준비 단계 및 Adobe CX Enterprise GDPR API와 통합하는 방법에 대해 나와 있는 [Adobe Analytics에서 GDPR을 처리하는 방법](https://www.adobe.com/kr/data-analytics-cloud/analytics/general-data-protection-regulation.html)을 숙지하십시오.

## GDPR 준비 및 Adobe Analytics 데이터

사용자가 보고서 세트의 사용자 정의 데이터를 가장 잘 알고 있기 때문에 Adobe는 사용자에게 데이터 거버넌스 설정 및 환경 설정을 정의할 수 있는 기회를 제공하고 있습니다.

이를 위해 Adobe Analytics는 사용자가 데이터 제어자로서 Analytics 보고서 세트와 그러한 보고서 세트의 모든 차원과 지표에 대한 [개인정보 레이블](/help/admin/tools/privacy-labeling/labels.md#data-governance-labels)을 설정할 수 있는 데이터 거버넌스 사용자 인터페이스를 제공합니다. 직접 또는 간접적으로 식별 가능한 데이터가 포함된 데이터 세트에서 열을 식별하여 해당 데이터를 해결하기 위한 액세스 및 삭제 요청을 제출할 수 있습니다. 각 요청에 대해 Analytics 데이터 거버넌스 사용자 인터페이스에 정의된 레이블은 해당 요청에 해당하는 특정 식별자에 적용됩니다.
