...
* **프로덕션에 릴리스 (RTP)**: Analysis Workspace에서 기능 가시성이 해제되어 있는 상태로 코드가 프로덕션에 릴리스됩니다. 이 기능은 때로 2.0 Analytics API에서 사용할 수 있습니다.
...
기능 플래그는 릴리스 중 새로운 기능의 가시성을 제어하는 데 사용됩니다. Adobe은 릴리스 중 최적의 환경을 위해 `app.launchdarkly.com`을 방화벽의 [허용 목록](/help/technotes/ip-addresses.md)에 추가할 것을 권장합니다. GA에 도달한 직후 플래그가 제거됩니다.
...
| 이 릴리스 전략은 기능 액세스에 영향을 줍니까? | 아니요. 기능이 GA에 도달하면 Analytics 패키지에 포함된 경우 이 기능에 액세스할 수 있습니다.<br>Analytics 패키지에 대한 세부 사항은  [기능 액세스 수준](/help/admin/company/feature-access-levels.md)에서 볼 수 있습니다. |
