...
+ 관리 도구 {#admin-tools}
   ...
   + 처리 규칙 {#processing-rules}
      ...
      + [처리 규칙에 사용할 수 있는 차원](admin/c-processing-rules/processing-rule-dimensions.md)
      + Processing rules examples {#processing-rules-examples}
         + [처리 규칙의 예](admin/c-processing-rules/processing-rules-examples/processing-rules-examples.md)
   ...
   + Server-side forwarding {#server-side-forwarding}
      + [서버측 포워딩 개요](admin/c-server-side-forwarding/ssf.md)
      + [서버측 전달을 위한 요구 사항](admin/c-server-side-forwarding/ssf-requirements.md)
      + [서버측 포워딩 데이터 및 코드 참조](admin/c-server-side-forwarding/ssf-reference.md)
      + [서버측 전달 구현을 확인하는 방법](admin/c-server-side-forwarding/ssf-verify.md)
   ...
   + [타임스탬프 옵션](admin/timestamp-optional.md)
...
+ 회사 설정 {#company-settings}
   ...
   + [리포트 빌더 보고서](company/report-builder-reports-admin.md)
...
+ Manage report suites {#manage-report-suites}
   ...
   + Report suite templates {#report-suite-templates}
      ...
      + [통합 포털 포털](c-manage-report-suites/c-report-suite-templates/aggregator-portal.md)
      ...
      + [채용 포털](c-manage-report-suites/c-report-suite-templates/job-portal.md)
...
+ User and Product Management (Legacy) {#user-product-management}
   ...
   + Customize report access {#customize-report-access}
      ...
      + [분석 도구 권한 사용자 정의](user-management2/c-customize-report-access/groups-analytics-tools.md)
      ...
      + [차원 권한 사용자 정의](user-management2/c-customize-report-access/groups-dimensions.md)
...
+ 데이터 거버넌스 {#data-governance}
   ...
   + [보고서 세트 데이터 레이블 지정](c-data-governance/gdpr-setup-reportsuite.md)
   + [액세스 권한 제출 및 요청 삭제](c-data-governance/gdpr-submit-access-delete.md)
   ...
   + [레이블 예](c-data-governance/gdpr-labeling-example.md)
...
+ 서버 호출 사용량 {#server-call-usage}
   + [서버 호출 사용 개요](c-server-call-usage/overage-overview.md)
   + [현재 서버 호출 사용 보기](c-server-call-usage/server-call-usage-dashboard.md)
   + [보고서 세트 사용량 보기](c-server-call-usage/report-suite-usage.md)
   + [서버 호출 사용량 경고](c-server-call-usage/scu-alerts.md)
   + [서버 호출 사용 FAQ](c-server-call-usage/overage-faq.md)
