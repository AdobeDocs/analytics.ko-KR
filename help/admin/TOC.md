...
+ Adobe Admin Console {#admin-console} {#admin-console}
   ...
   + Analytics 도구 권한 요약 {#permissions} {#permissions}
...
+ Analytics 관리 도구 {#admin-tools} {#admin-tools}
   ...
   + [로그](admin/logs.md)
   + 보고 활동 관리자 {#reporting-activity-manager} {#reporting-activity-manager}
   ...
   + 구성 요소 마이그레이션 {#component-migration} {#component-migration}
   ...
   + 보고서 세트 관리자 {#manage-report-suites} {#manage-report-suites}
      + 보고서 세트의 설정 편집 {#edit-report-suite} {#edit-report-suite}
         + 일반 {#report-suite-general} {#report-suite-general}
            ...
            + 유료 검색 감지 {#paid-search-detection} {#paid-search-detection}
            ...
            + 처리 규칙 {#c-processing-rules} {#c-processing-rules}
               + [처리 규칙 개요](admin/c-manage-report-suites/c-edit-report-suites/general/c-processing-rules/processing-rules.md)
               + 처리 규칙 {#c-processing-rules-configuration} {#c-processing-rules-configuration}
               ...
               + 처리 규칙 예 {#processing-rules-examples} {#processing-rules-examples}
            ...
            + 서버측 전달 {#server-side-forwarding} {#server-side-forwarding}
         ...
         + 트래픽 {#traffic-variables} {#traffic-variables}
         ...
         + 전환 {#conversion-variables} {#conversion-variables}
            ...
            + 고유 방문자 변수 {#unique-visitor-variable} {#unique-visitor-variable}
         ...
         + 마케팅 채널 {#marketing-channels} {#marketing-channels}
         ...
         + 트래픽 관리 {#traffic-management} {#traffic-management}
         ...
         + 앱 관리 {#app-management} {#app-management}
         ...
         + Document Cloud 관리 {#doc-cloud-mgt} {#doc-cloud-mgt}
         ...
         + 실시간 {#real-time-reports} {#real-time-reports}
      ...
      + 새 보고서 세트 {#c-new-report-suite} {#c-new-report-suite}
      ...
      + 보고서 세트 템플릿 {#report-suite-templates} {#report-suite-templates}
   ...
   + 회사 설정 {#company-settings} {#company-settings}
   ...
   + 데이터 거버넌스 개인 정보 보호 라벨링 {#data-governance} {#data-governance}
      ...
      + 데이터 레이블 지정 {#data-labels} {#data-labels}
   ...
   + 서버 호출 사용량 {#server-call-usage} {#server-call-usage}
   ...
   + 사용자 및 제품 관리(기존) {#user-product-management} {#user-product-management}
      + [사용자 및 제품 관리(기존)](admin/user-management2/user-management.md)
      + [기존 사용자 계정, 자산 및 만료 관리](admin/user-management2/users-assets.md)
      + Adobe Admin Console로 사용자 마이그레이션 {#migrate-users} {#migrate-users}
