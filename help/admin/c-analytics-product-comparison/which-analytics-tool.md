...
* **[!UICONTROL Live Stream]**:부분적으로 처리된 히트 수준 Analytics 데이터 스트림을 수집 후 몇 초 내에 원하는 경우 30초 이내에 사용할 수 있는 부분적으로 처리된 데이터입니다. Analytics Premium에서만 사용할 수 있습니다. 일반적으로 엔지니어링 서비스 계약을 통해 데이터를 시각화할 수 있는 방법이 필요합니다.
