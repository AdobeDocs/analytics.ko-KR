---
description: Adobe Analytics 사용자 인터페이스에서 보고서 세트를 숨길 수 있도록 해줍니다.
keywords: 보고서 세트 삭제
seo-description: Adobe Analytics 사용자 인터페이스에서 보고서 세트를 숨길 수 있도록 해줍니다.
seo-title: 보고서 세트 숨기기
solution: Analytics
title: 보고서 세트 숨기기
topic: 관리 도구
...
Adobe Analytics 사용자 인터페이스에서 보고서 세트를 숨길 수 있도록 해줍니다.
...
>[!IMPORTANT]
>
>사이트에서 숨겨진 보고서 세트로 전송된 데이터는 계속 수집, 처리 및 청구됩니다. 즉, 보고서 세트는 완전히 삭제되지 않습니다.

To hide the report suite, go to **[!UICONTROL Analytics]** &gt; **[!UICONTROL Admin]** &gt; **[!UICONTROL Company Settings]** &gt; **[!UICONTROL Hide Report Suites]**. 보고서 세트 이름의 왼쪽에 있는 **[!UICONTROL 숨김]확인란을 선택하십시오.**
