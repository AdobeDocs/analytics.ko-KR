...
요청에 이 옵션을 포함시키는 방법에 대한 예는 [샘플 JSON 요청](../../admin/c-data-governance/gdpr-submit-access-delete.md#section_DB9DE6492FE740918F91D413E7BAB88F)을 참조하십시오. 자세한 내용은 [GDPR API 문서](https://www.adobe.io/apis/experienceplatform/gdpr.html)를 참조하십시오.
...
>[!NOTE]
>[GDPR API](https://www.adobe.io/apis/experienceplatform/gdpr.html) 를 통해 시간 민감도인 GDPR 요청을 처리할 수 있습니다. 다른 용도로 이 API를 사용하는 것은 Adobe에서 지원하지 않으며, Adobe는 높은 &gt; 우선 순위, 사용자가 시작한 GDPR 요청을 다른 Adobe 고객에게 적시에 제공할 수 있는 기능에 영향을 줄 수 있습니다. Adobe는 사용자가 대규모 방문자 그룹에서 실수로 제출한 데이터 지우기와 같은 기타 목적을 위해 GDPR API를 사용하지 않기를 요청합니다.
>
