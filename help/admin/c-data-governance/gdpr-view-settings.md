...
<table id="table_448292730FF0475E9DCB731882F9A29B"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Analytics 데이터 개인 정보 구현을 사용하려면 데이터 유지 정책이 있어야 합니다. </p> <p>이 설정은 다음을 표시합니다. </p> 
    ...
    </ul> <p>참고: Adobe Analytics는 데이터 보존 기간이 설정되지 않은 경우, 데이터 개인 정보 API에 대한 요청 처리(즉, 최종 사용자로부터 받은 액세스 또는 삭제 요청 처리)를 지원할 수 없습니다. 데이터 보존 기간을 설정하려면 Customer Success Manager에 문의하십시오. </p> </td> 
  </tr> 
  <tr> 
