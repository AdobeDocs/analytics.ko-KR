...
**[!UICONTROL 관리자]** &gt; **[!UICONTROL 사용자 관리]** &gt; **[!UICONTROL 그룹]**

> [!NOTE] 가능한 사용 권한 조합의 수가 많기 때문에 모든 권한 조합에서 사용할 수 있는 모든 API 메서드를 설명하는 설명서를 제공할 수 없습니다. 일반적으로 웹 서비스 액세스 권한이 부여된 비 관리자 사용자에게는 API 메서드에 대한 읽기 액세스 권한만 있으며, 쓰기 액세스 권한은 없습니다.
...
<table id="table_D1DB0DE37752450BBCCA44DB760BB505"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p id="reportaccess"><span class="uicontrol">보고서 액세스 권한</span>(사용자 지정 그룹) 변경 </p> </td> 
   <td colname="col2"> <p> <span class="uicontrol"> 새 그룹 추가</span> &gt; <span class="uicontrol">보고서 액세스 권한</span> </p> <p><span class="wintitle">사용자 그룹 정의</span> 페이지의 <span class="wintitle">보고서 액세스 권한</span> 섹션은 네 개의 카테고리로 간소화되었으며, 따라서 더 세분화된 수준에서 권한을 사용자 지정할 수 있습니다. </p> <p><img  src="assets/report-access.png" id="image_CB83E5C7DB4343619421A1FAA61478D0"> </img> </p> <p>이전 항목 </p> 
    <ul id="ul_16D5EF18D57D4608AEEDEC40D90D8828"> 
     <li id="li_F29E84C6228A464C8807F09205AEAAC6"> <p> <a href="/help/admin/user-management2/c-customize-report-access/groups-analytics-tools.md"> Analytics 도구</a>: 일반 항목(청구, 로그 등), 회사 관리, 도구, 웹 서비스 액세스, Report Builder 및 Data Connectors 통합에 대한 사용자 권한을 활성화합니다. </p> <p> <b>참고:</b> Admin Console 사용자 지정 카테고리의 회사 설정이 Analytics 도구로 이동되었습니다. </p> </li> 
     ...
     <li id="li_8DAE87D1DEF54803A9C6FE31C01F0FB0"> <p> <a href="/help/admin/user-management2/c-customize-report-access/groups-dimensions.md"> 차원</a>: eVar, 트래픽 보고서, 솔루션 보고서 및 경로 지정 보고서를 포함하여 세분화된 수준에서 사용자 액세스를 사용자 지정합니다. </p> </li> 
...
<table id="table_1E93F45C66E841E6882FB602509F30A3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Admin Console을 사용하여 사용자를 관리하거나, 기존 Analytics 사용자 관리를 사용해야 합니까? </p> </td> 
   <td colname="col2"> <p>Analytics &gt; 관리자 &gt; 사용자 관리에서 변경한 사항이 Admin Console에 반영되지 않습니다. 따라서 사용자 및 그룹 관리에 이미 Admin Console을 사용하는 새로운 고객만 계속 Admin Console을 사용해야 합니다. 기존 Analytics 그룹 관리를 Admin Console로 마이그레이션할 계획입니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>현재 <span class="wintitle">관리 도구</span> 인터페이스에 대한 다음과 같은 향상된 기능을 사용할 수 있습니다. </p> <p> 
     <ul id="ul_2A31E8DC17A94B7FABDBA9C87C3947EF"> 
      <li id="li_AE2ECCA01CC64D30B109BE74379EE474"><a href="/help/admin/user-management2/c-user-management/permissions-changes.md"> 관리 변경 사항 - 2016년 가을</a>에 설명된 권한 변경 사항입니다. </li> 
      <li id="li_33CB2B6A2E5F45BE97CC5E0983AF280E">작동하지 않는 트래픽 보고서가 제거되었으며, 메뉴에 더 이상 없습니다. </li> 
      <li id="li_57234CF27E1D405987DE89312CD62C52">분류 권한: 분류에 대한 액세스는 분류가 사용될 변수에 대한 액세스 권한에 의해 결정됩니다. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B68FD00FC5D24823A86BB69558C0327C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Admin Console(사용자를 만들어 Analytics <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/admin_getting_started.html"> 제품 구성</a>에 사용자를 추가해도 Analytics에 사용자 계정이 만들어짐). </p> <p> <a href="/help/admin/user-management2/c-user-management/t-add-user-account.md"> 관리 도구</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Admin Console - Experience Cloud 사용자용 </p> <p>관리 도구 - 모든 사용자용이지만 Experience Cloud 사용자인 경우 Experience Cloud 계정이 아닌 매핑된 Analytics 사용자만 삭제합니다. </p> </td> 
   <td colname="col3"> <p>Admin Console - 마이그레이션된 사용자용. </p> <p>관리 도구 - Analytics 사용자 전용. </p> </td> 
   <td colname="col4"> <p>Admin Console </p> <p> 관리 도구 - Experience Cloud 사용자를 삭제하거나 Admin Console에서 해당 계정의 링크를 해제한 후에 관리 도구에서 Analytics 로그인을 삭제할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Admin Console(<a href="https://marketing.adobe.com/resources/help/en_US/mcloud/admin_getting_started.html"> 제품 구성 만들기</a>) </p> </td> 
   <td colname="col4"> <p>Admin Console(<a href="https://marketing.adobe.com/resources/help/en_US/mcloud/admin_getting_started.html"> 제품 구성 만들기</a>) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 그룹의 사용자 편집 </td> 
   <td colname="col2"> <p>Admin Console - Experience Cloud 사용자 전용 </p> <p>관리 도구 - Analytics 전용 사용자와 그룹의 Experience Cloud 사용자 구성원을 모두 관리 도구에서 편집할 수 있습니다. 하지만 Experience Cloud 사용자가 Admin Console의 그룹에 속하지 않으면 관리 도구의 그룹에서 제거할 수 없습니다. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Admin Console - Admin Console에서 만든 그룹을 편집할 수 있습니다. </p> <p>관리 도구 - 그룹에 대한 권한을 편집할 수 있습니다. </p> </td> 
   <td colname="col3"> <p>Admin Console </p> </td> 
   <td colname="col4"> <p>Admin Console </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 그룹 삭제 </td> 
   <td colname="col2"> <p>Admin Console - Admin Console에서 만든 그룹만 삭제할 수 있습니다. </p> <p>관리 도구 - 관리 도구에서 생성된 그룹만 삭제할 수 있습니다. </p> </td> 
   <td colname="col3"> <p>Admin Console </p> </td> 
   <td colname="col4"> <p>Admin Console </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 사용자의 관리 상태 변경 </td> 
   <td colname="col2"> <p>Admin Console - Experience Cloud 사용자 전용. </p> <p>관리 도구 </p> </td> 
   <td colname="col3"> <p>Admin Console - Experience Cloud 사용자 전용. </p> <p>관리 도구 - Analytics 사용자 전용. </p> </td> 
   <td colname="col4"> <p>Admin Console </p> </td> 
  </tr> 
 </tbody> 
</table>
