...
1. Admin Console에서 Admin Console 사용자 목록을 다운로드합니다. 
   ...
   1. [Admin Console](http://adminconsole.adobe.html/#) &gt; **[!UICONTROL 사용자]**&#x200B;로 이동한 다음 [사용자 목록을 CSV로 내보내기](https://helpx.adobe.com/kr/enterprise/using/users.html)를 클릭합니다.
...
<table id="table_1B5EEFDB5BD8436EB760BE5FFAB1CF02"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> 도메인</span> 및 <span class="term"> 이메일</span> 열이 <a href="/help/admin/user-management2/user-migration/c-migration-tool/migrate-enterprise.md#prereqs"  > 사전 요구 사항</a>에 설정된 도메인과 일치합니다. </p> </td> 
  </tr> 
  <tr> 
