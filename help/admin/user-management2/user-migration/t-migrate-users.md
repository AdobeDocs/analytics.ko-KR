...
1. [!DNL Users] 페이지에서 마이그레이션할 사용자를 선택한 다음 **[!UICONTROL 마이그레이션]**&#x200B;을 클릭합니다.
   ...
   **[!UICONTROL 마이그레이션]**&#x200B;을 클릭하면 사용자는 초대를 받으며(마이그레이션이 시작됨) 이를 수락해야 합니다. 이렇게 하면 사용자 ID가 마이그레이션 완료됨으로 이동합니다. You can then turn off their legacy access to `[!DNL my.omniture.com].`

   ![](assets/user-info.png)

1. 사용자를 마이그레이션할 ID 유형 지정(Adobe ID 또는 Enterprise ID)
