...
이 카테고리에는 [사용자 지정 이벤트](https://marketing.adobe.com/resources/help/ko_KR/sc/implement/events.html) 외에 Experience Manager(AEM), Advertising Cloud(AMO), 모바일, 비디오 및 소셜을 포함한 Analytics 솔루션 이벤트가 포함되어 있습니다. 지표를 사용한 모든 사용자 지정 그룹에는 모든 Analytics 솔루션 이벤트가 새 지표로 추가됩니다.
