...
1. **[!UICONTROL Analytics]** &gt; **[!UICONTROL 관리자]** &gt; **[!UICONTROL 보고서 세트]**&#x200B;를 클릭하여 보고서 세트 관리자를 엽니다.
1. 보고서 세트를 선택합니다.
1. **[!UICONTROL 설정 편집]** &gt; **[!UICONTROL 트래픽 관리]** &gt; **[!UICONTROL 영구 트래픽]**&#x200B;을 클릭합니다.
1. **[!UICONTROL 새로운 예상 일별 페이지 보기 개수]** 필드에서 새로운 트래픽 수준에 대한 총 예상 일별 페이지 보기 횟수를 지정합니다.

   추가 페이지 보기 횟수가 아닌 총 예상 페이지 보기 횟수를 지정해야 합니다.
1. **[!UICONTROL 유효 날짜]** 필드에서 새 트래픽 수준이 시작될 것으로 예상되는 날짜를 지정하고 **[!UICONTROL 제출]**&#x200B;을 클릭합니다.

   >[!NOTE]
   >
   >영구 트래픽 증가를 예약하려면 필요한 경우 Adobe가 연락할 수 있도록 사용자 연락처 정보에 전화 번호를 포함하십시오.
