...
* Adobe Admin Console: 이 영역을 사용하여 Experience Cloud 도구를 프로비저닝하고 사용자 권한을 관리할 수 있습니다. It is located at [adminconsole.adobe.com](https://adminconsole.adobe.com).
...
본 안내서에서는 Adobe Admin Console에서 제공하는 다양한 일반 기능을 다루지 않습니다. 대신 Enterprise [사용 안내서의](https://helpx.adobe.com/enterprise/using/admin-console.html) Admin Console을 참조하십시오.
