...
* **데이터 수집 관리자:** 이 사용자는 게시 권한, 컨테이너 만들기 및 사용자 권한 등 데이터 수집 UI(이전의 Experience Platform Launch UI)의 모든 기능에 액세스할 수 있습니다. 이러한 사용자가 반드시 프로그래머일 필요는 없지만 적어도 HTML, CSS 및 JavaScript에 대한 초보 지식이 있는 것이 유용합니다. 조직은 사이트에 Experience Platform 태그를 구현하기 위해 조직의 웹 사이트 소유자와 함께 작업하는 책임이 있습니다. 조직의 구현 담당자를 최소 한 명 이상 확인하고, 여기서 다른 데이터 수집 관리자를 초대할 수 있습니다.
...
* **웹 사이트 소유자:** 이 역할을 맡는 개인이나 팀은 웹 사이트의 코딩 및 개발을 담당합니다. 이들은 계정이 필요하지 않지만 데이터 수집 관리자와 함께 태그 코드를 받아서 웹 사이트에 구현해야 합니다.
...
1. Adobe ID 자격 증명으로 [Adobe Admin Console](https://adminconsole.adobe.com)에 로그인합니다.
1. 맨 위에 있는 **[!UICONTROL 제품]** 탭을 클릭합니다. 조직에서 구입한 모든 제품은 왼쪽에 있습니다. **[!UICONTROL Experience Platform Launch]**&#x200B;을 클릭한 다음 **[!UICONTROL 새 프로필]**&#x200B;을 클릭합니다.
1. 이 프로필의 이름을 &#39;데이터 수집 전체 관리자 액세스 권한&#39;으로 지정한 다음 **[!UICONTROL 완료]**&#x200B;를 클릭합니다.
...
1. [!UICONTROL Experience Platform Launch] 타일에서 **[!UICONTROL 사용자 할당]**&#x200B;을 클릭합니다.
