...
이 표에는 Adobe Admin Console에서 제품 프로필을 구성할 때 보고서 세트 도구 아래의 모든 권한 항목이 나열되어 있습니다. 이러한 권한 항목은 동일한 제품 프로필에 포함된 보고서 세트에만 적용됩니다. 현재 제품 프로필에 보고서 세트가 포함되어 있지 않으면 이러한 권한을 포함해도 아무 작업도 수행되지 않습니다.
...
| [!UICONTROL 데이터 복구 API] | 데이터 복구 API에 대한 액세스 권한을 부여합니다. |
...
| [!UICONTROL 내 권장 보고서] | 사용되지 않습니다 |
| [!UICONTROL 유료 검색] | 보고서 세트 관리자의 일반 > 유료 검색 감지에 대한 액세스 권한을 부여합니다. |
| [!UICONTROL 처리 규칙] | 보고서 세트 관리자의 일반 > 처리 규칙 및 일반 > 봇 규칙에 대한 액세스 권한을 부여합니다. |
...
| [!UICONTROL R&amp;A 대시보드 테스트 Reportlet] | 사용되지 않습니다 |
| [!UICONTROL R&amp;A 대시보드 사용 요약 리포트릿] | 사용되지 않습니다 |
