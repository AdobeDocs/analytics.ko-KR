...
| 코드 관리자 | 기존 용도로 계속 사용할 수 있습니다. 관리 > 모든 관리 > 코드 관리자에 대한 액세스 권한을 부여합니다. 대부분의 경우 Adobe Experience Platform Launch에 포함된 라이브러리를 대신 사용합니다. |
| 코드 관리자 - 웹 서비스 | 1.4 API를 통해 코드 관리자에 대한 액세스 권한을 부여합니다. |
| 로그 | 관리 > 모든 관리 > 로그에 대한 액세스 권한을 부여합니다. |
| 로그 - 웹 서비스 | 1.4 API를 통해 로그 가져오기에 대한 액세스 권한을 부여합니다. |
| 트래픽 관리 | 관리 > 모든 관리 > 트래픽 관리에 대한 액세스 권한을 부여합니다. |
| 권한 관리 | 더 이상 사용되지 않습니다. 관리 > 모든 관리 > 사용자 관리 아래의 기존 사용자 관리 인터페이스에 대한 액세스 권한을 부여합니다. |
...
| 보안 | 관리 > 모든 관리 > 회사 설정 > 보안 관리자에 대한 액세스 권한을 부여합니다. |
| 지원 | 관리 > 모든 관리 > 회사 설정 > 지원 정보에 대한 액세스 권한을 부여합니다. |
| 웹 서비스 | 관리 > 모든 관리 > 회사 설정 > 웹 서비스에 대한 액세스 권한을 부여합니다. |
| Single Sign-On | 더 이상 사용되지 않습니다. 더 이상 사용되지 않는 Single Sign-On 서비스에 대한 액세스 권한을 부여합니다. |
| 보류 중인 작업 | 관리 > 모든 관리 > 회사 설정 > 보류 중인 작업에 대한 액세스 권한을 부여합니다. |
| 공동 브랜딩 | 더 이상 사용되지 않습니다. 관리 > 모든 관리 > 회사 설정 > 공동 브랜딩에 대한 액세스 권한을 부여합니다. |
| 기본 설정 | 사용되지 않습니다. |
| 보고서 세트 숨기기 | 관리 > 모든 관리 > 회사 설정 > 보고서 세트 숨기기에 대한 액세스 권한을 부여합니다. 보고서 세트 액세스 권한에 상관없이 조직에서 보고서 세트를 숨길 수 있는 권한을 부여합니다. |
...
| 통합 (생성) | 관리 > 모든 관리 > 데이터 커넥터에 대한 액세스 권한을 부여하고 사용자가 데이터 커넥터를 만들 수 있도록 합니다. |
| 통합 (업데이트) | 관리 > 모든 관리 > 데이터 커넥터에 대한 액세스 권한을 부여하고 사용자가 기존 커넥터 구성을 수정할 수 있도록 합니다. |
| 통합 (삭제) | 관리 > 모든 관리 > 데이터 커넥터에 대한 액세스 권한을 부여하고 사용자가 데이터 커넥터를 삭제할 수 있도록 합니다. |
