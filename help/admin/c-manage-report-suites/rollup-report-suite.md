...
롤업 보고서는 중복 제거나 세그먼트 또는 데이터 분류 없이 여러 보고서 세트의 데이터를 간단히 집계한 것입니다. 롤업에는 코드 구현이 필요하지 않습니다. 롤업 보고서를 사용하려면 [하위 보고서 세트를 구현](/help/admin/c-manage-report-suites/c-new-report-suite/t-create-a-report-suite.md)한 다음 [!UICONTROL 관리 도구]를 사용하여 [롤업 보고서로 결합](/help/admin/c-manage-report-suites/t-rollups.md)합니다.
