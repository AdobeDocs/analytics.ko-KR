...
| 주 서버 호출 | 웹 사이트 방문자 브라우저 또는 데이터 삽입 API에서 직접 받은 요청입니다. 기본 히트(페이지 조회수), 기본 사용자 정의 이벤트, 기본 다운로드 이벤트 및 기본 종료 이벤트를 포함합니다. |
...
| 다운로드 | 각 보고서 세트에 대한 다운로드 합계. 사이트 콘텐츠 > 링크 > 파일 다운로드에서 다운로드 값을 확인할 수 있습니다. |
| 사용자 정의 링크 | 각 보고서 세트에 대한 사용자 정의 링크 합계. 사이트 콘텐츠 > 링크 > 사용자 정의 링크에서 사용자 정의 링크 값을 확인할 수 있습니다. |
| 종료 링크 | 각 보고서 세트에 대한 종료 링크 합계. 사이트 콘텐츠 > 링크 > 종료 링크에서 종료 링크 값을 확인할 수 있습니다. |

>[!NOTE]
>
>의 작업 사본을 가져오려면 [!UICONTROL 월별 청구서] 보고서를 클립보드에 복사한 다음 Microsoft Excel 등의 스프레드시트 프로그램에 붙여넣습니다.&#42;.
