...
> [!NOTE] IP 주소로 제외된 히트는 [서버 호출로](https://marketing.adobe.com/resources/help/en_US/reference/primary_server_calls.html)청구됩니다.
...
와일드카드 표시기(*)를 사용하여 주소 범위를 제외할 수 있습니다. For example, `[!DNL 0.0.*.0]` would exclude all IP addresses between `[!DNL 0.0.0.0]` and `[!DNL 0.0.255.0]`. 최대 50개의 서로 다른 IP 주소를 제외할 수 있습니다.
