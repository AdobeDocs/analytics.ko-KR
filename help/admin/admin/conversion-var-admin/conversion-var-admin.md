...
예를 들어 eVar 만료를 30일에서 90일로 변경하면 수집된 eVar 값은 새 만료 세트의 기간(이 경우 90일)에 계속 유지됩니다. 시스템은 현재 만료 설정 및 수집된 eVar 값의 마지막 세트 타임스탬프를 보고 만료를 결정합니다. 재설정 **[!UICONTROL 옵션만]** 값이 만료되고 즉시 만료됩니다.
