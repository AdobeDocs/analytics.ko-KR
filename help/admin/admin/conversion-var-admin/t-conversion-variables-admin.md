...
1. 보고서 세트를 선택합니다.
1. **[!UICONTROL 설정 편집]** &gt; **[!UICONTROL 전환]** &gt; **[!UICONTROL 전환 변수]**&#x200B;를 클릭합니다.
...
1. 수정할 전환 변수 필드를 선택합니다.
   ...
   [전환 변수 - 설명](/help/admin/admin/conversion-var-admin/conversion-var-admin.md#section_7C317BB0287A4B8EB0A1A4ECC40627BF)을 참조하십시오. 일부 필드에는 직접 입력할 수 있습니다. 다른 필드의 경우 드롭다운 목록에서 지원되는 값을 선택할 수 있습니다.
