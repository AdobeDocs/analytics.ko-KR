...
분류는 값을 그룹으로 분류하고 그룹 수준으로 보고하는 데 사용됩니다. 예를 들어 모든 [!UICONTROL 유료 검색] 캠페인을 *팝 뮤직 용어*&#x200B;와 같은 카테고리로 분류하고 인스턴스(클릭스루)와 같은 지표와 관련한 해당 카테고리의 성공 및 성공 이벤트로의 전환을 보고합니다. 변수에 최대 255개의 분류를 추가할 수 있습니다.
