...
<table id="table_E25612E32A03449A8E5DA00B88FCEB9E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>일부 고객은 ID를 <a href="https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/evar.html?lang=ko">사용자 정의 트래픽 변수(props) 또는 사용자 정의 전환 변수(eVars)</a>에 배치합니다. 가장 일반적인 것은 CRM ID이지만 이메일 주소, 사용자 로그인 이름, 고객 충성도 번호 또는 이러한 값의 해시를 포함합니다. </p> 
