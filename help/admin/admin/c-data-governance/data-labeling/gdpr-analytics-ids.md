...
I1, I2, S1 및 S2 레이블은 Adobe Experience Platform에서 대응적으로 명명된 DULE 레이블과 동일한 의미를 갖습니다. 하지만, 그것들은 매우 다른 목적으로 사용됩니다. Adobe Analytics 내에서 이러한 레이블은 Privacy Service 요청의 결과로 익명으로 처리되어야 하는 필드를 식별하는 데 사용됩니다. Adobe Experience Platform 내에서 액세스 제어, 동의 관리 및 레이블이 지정된 필드에 마케팅 제한을 적용하는 데 사용됩니다. Adobe Experience Platform은 Adobe Analytics에서 사용하지 않는 많은 추가 레이블을 지원합니다. Analytics Data Connector를 사용하여 Adobe Analytics 데이터를 Adobe Experience Platform으로 가져오는 경우 Adobe Analytics 내에서 적용한 모든 I1, I2, S1 및 S2 레이블이 가져온 보고서 세트에서 사용하는 Adobe Experience Platform의 스키마에도 적용되었는지 확인해야 합니다.
