---
description: 이 기능을 사용하면 보고 및 분석에서 사용자가 보는 보고서 메뉴를 사용자 지정할 수 있습니다. 보고서를 표시하거나 숨길 수 있을 뿐만 아니라 모든 사용자 간에 다른 폴더로 이동할 수 있습니다. 이 기능은 조직에서 특정 보고서만 사용하고 사용되지 않거나 관련이 없는 데이터로 왼쪽 메뉴를 정리하지 않으려는 경우에 특히 유용합니다.
title: 메뉴 사용자 지정
topic: Admin tools
...
이 기능을 사용하면 보고 및 분석에서 사용자가 보는 보고서 메뉴를 사용자 지정할 수 있습니다. 보고서를 표시하거나 숨길 수 있을 뿐만 아니라 모든 사용자 간에 다른 폴더로 이동할 수 있습니다. 이 기능은 조직에서 특정 보고서만 사용하고 사용되지 않거나 관련이 없는 데이터로 왼쪽 메뉴를 정리하지 않으려는 경우에 특히 유용합니다.
...
<table id="table_E609632569EB499184E56618C2CEF742"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 현재 선택한 항목 위에 새 폴더를 추가합니다. 폴더가 표시되기 전에 하나 이상의 보고서를 폴더에 추가해야 합니다. </p> </td> 
  </tr> 
  <tr> 
