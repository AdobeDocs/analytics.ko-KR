...
표준 및 사용자 지정 보트 필터링 방법은 모두 **[!UICONTROL Analytics]** &gt; **[!UICONTROL 관리자]** &gt; **[!UICONTROL 보고서 세트]** &gt; **[!UICONTROL 설정 편집]** &gt; **[!UICONTROL 일반]** &gt; **[!UICONTROL 보트 규칙]**&#x200B;에서 지원됩니다.
...
보트처럼 행동하는 방문자, 즉 분당 수십 또는 수백 개의 히트를 보내는 방문자를 제거하는 [s.hitGovernor 구현 플러그인](https://docs.adobe.com/content/help/ko-KR/analytics/implementation/javascript-implementation/plugins/hitgovernor.html)을 사용합니다.
