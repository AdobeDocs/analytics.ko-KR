...
보트 규칙을 업데이트하거나 업로드하려면 **[!UICONTROL Analytics]** &gt; **[!UICONTROL 관리자]** &gt; **[!UICONTROL 보고서 세트]**&#x200B;로 이동합니다. 올바른 보고서 세트를 선택한 다음 **[!UICONTROL 설정 편집]** &gt; **[!UICONTROL 일반]** &gt; **[!UICONTROL 보트 규칙]**&#x200B;으로 이동합니다.
...
1. **[!UICONTROL Analytics]** &gt; **[!UICONTROL 관리]**&#x200B;로 이동하고, 보고서 세트를 한 개 이상 선택한 다음 **[!UICONTROL 일반]** &gt; **[!UICONTROL 보트 규칙]**&#x200B;을 클릭합니다.
