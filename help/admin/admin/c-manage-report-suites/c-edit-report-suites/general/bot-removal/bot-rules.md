...
와일드카드(&#42;). 일치시킬 IP 주소의 숫자 값을 제공합니다. 대체 &#42; 와일드카드를 사용하여 일치시킬 값에 대해 다음 목록은 IP 주소 일치 문자열의 예를 포함합니다.
...
일치시킬 IP 주소의 시작 및 끝 범위를 제공합니다. 대체 &#42; 와일드카드를 사용하여 일치시킬 값에 대해
...
VISTA 규칙은 보트 규칙 다음에 적용됩니다. 자세한 내용은 [처리 순서](/help/technotes/processing-order.md) 을 참조하십시오.
...
마지막 옥텟이 제거되면 IP 필터링 전에 변경이 수행됩니다. 따라서 마지막 옥텟은 0으로 대체되고, IP 제외 규칙은 끝에 0이 있는 IP 주소와 일치하도록 업데이트해야 합니다. 일치 &#42; 0과 일치해야 합니다.
