...
일반적으로 보트 트래픽을 제거하면 트래픽 양과 전환 지표가 줄어듭니다. 대부분의 고객이 보트 트래픽을 제거하면 전환율이 증가하고 기타 유용성 지표도 증가함을 확인할 수 있습니다. 보트 트래픽을 제거하기 전에 관련자들과 소통하여 이러한 변경의 결과로 주요 성과 지표(KPI)에 필요한 조정을 할 수 있음을 확인하십시오. 가능하면 작은 보고서 세트에서 먼저 보트 트래픽을 제거하여 잠재적 영향을 추정하는 것이 좋습니다.

보트 트래픽 데이터는 개별 저장소에 저장되어 보트 및 보트 페이지 보고서에 표시됩니다. 보트 필터링을 활성화하는 다음 두 가지 옵션이 있습니다.
...
사용자 정의 보트 규칙을 사용하여 사용자가 정의한 조건을 기준으로 트래픽을 필터링할 수 있습니다.
