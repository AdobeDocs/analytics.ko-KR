...
>[!NOTE]
>
>다음 [가상 보고서 세트 설명서](/help/components/vrs/c-workflow-vrs/vrs-create.md) 가상 보고서 세트를 만드는 방법을 보여 줍니다.
