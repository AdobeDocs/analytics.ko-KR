...
**[!UICONTROL 관리]** 보고서 **[!UICONTROL 세트]** &gt; 보고서 **[!UICONTROL [세트]]** &gt; 설정 편집 &gt; **[!UICONTROL 일반]** **** **[!UICONTROL &gt; 일정 사용자 지정]**

>[!CAUTION]
>
>달력을 변경하면 데이터가 처리되는 방식이 변경됩니다(예: 주별 및 월별 고유 방문자 정의). 달력의 주 및 월 정의가 변경되어도 내역 데이터는 바뀌지 않습니다.
