...
| **[!UICONTROL 상태]** | 4가지 가능한 상태 표시기: <ul><li>**빨간색 - 용량**: 보고서 세트는 보고 용량 측면에서 제한을 받습니다.</li><li>**노란색 - 거의 용량**: 이 보고서 세트는 최대 용량에 도달할 위기에 있습니다.</li><li>**녹색 - 모두 좋습니다.**: 보고 용량은 충분합니다.</li><li>**[!UICONTROL 상태 보류 중]**: ?</li><li>**회색 - 사용할 수 없음**: 보고서 세트가 보고 용량에 대해 구성되지 않았습니다.</li></ul> |
