...
1. 각 보고서 세트에 대한 사용률 정보를 봅니다. 표에 표시된 데이터는 페이지가 마지막으로 로드되었을 때 보고서 세트에 대한 보고 활동을 나타냅니다.
   ...
   | UI 요소 | 설명 |
   | --- | --- |
   | **[!UICONTROL 보고서 세트]** | 모니터링 중인 보고 활동의 기본 보고서 세트입니다. |
   ...
   | **[!UICONTROL 용량 사용률]** | 실시간으로 사용 중인 보고서 세트의 보고 용량의 비율입니다. <p>**참고** 사용 용량이 100%라고 해서 보고 요청 취소를 즉시 시작해야 하는 것은 아닙니다. 평균 대기 시간이 적절하다면 100% 사용 용량은 적절할 수 있습니다. 반면에 100% 사용 용량은 큐에 있는 요청 수가 증가하는 경우에도 문제를 시사할 수 있습니다.</p> |
...
1. Adobe Analytics에서 [!UICONTROL **관리자**] > [!UICONTROL **보고 활동 관리자**]&#x200B;를 선택합니다.
