...
Analytics 2.0 API에 액세스하려면 Analytics 회사의 글로벌 회사 ID가 필요합니다. **API 액세스** 섹션의 맨 위에 있는 [!UICONTROL bold]에서 글로벌 회사 ID를 찾을 수 있습니다. 예제: &quot;현재 로그인한 Analytics 회사의 글로벌 회사 ID는 **adobe1234**&#x200B;입니다.&quot;
