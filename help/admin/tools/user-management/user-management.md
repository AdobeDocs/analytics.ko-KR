...
| Adobe Admin Console 시작 | 사용자 계정이 마이그레이션되면 Adobe Admin Console의 모든 솔루션에서 사용자와 제품을 관리할 수 있습니다. `https://adminconsole.adobe.com/enterprise/`로 이동합니다. [Experience Cloud 사용자 및 제품 관리](https://experienceleague.adobe.com/docs/core-services/interface/administration/admin-getting-started.html)도 참조할 수 있습니다. |
