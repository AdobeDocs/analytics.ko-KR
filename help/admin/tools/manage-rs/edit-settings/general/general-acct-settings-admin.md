...
데모 비디오를 보려면 ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [일반 계정 설정 구성](https://video.tv.adobe.com/v/332330/?quality=12&learn=on){target="_blank"}을 참조하십시오.
...
| 기본 URL | 보고서 세트의 주 웹 사이트를 지정합니다. 기본 URL은 참조 필터링에 영향을 주지 않습니다. 대신 [내부 URL 필터](/help/admin/tools/manage-rs/edit-settings/general/internal-url-filter-admin.md)를 사용하십시오. |
