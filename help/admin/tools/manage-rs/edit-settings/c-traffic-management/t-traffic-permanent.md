...
예상되는 트래픽 수준을 변경하면 Adobe에서 리소스를 재할당하여 새 트래픽 수준을 처리할 수 있습니다. 또는 일시적으로 리소스를 재할당하고자 하는 경우 [트래픽 스파이크를 예약](/help/admin/tools/manage-rs/edit-settings/c-traffic-management/t-traffic-schedule-spike.md)할 수 있습니다.
