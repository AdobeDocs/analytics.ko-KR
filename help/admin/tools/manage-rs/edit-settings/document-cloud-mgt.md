...
* [!UICONTROL **Document Cloud 보고**]
  ...
  스트리밍 미디어 서비스와 관련된 보고서는 미디어 보고 페이지에서 사용할 수 있습니다. 미디어 보고에 대한 자세한 내용은 [Document Cloud 보고 구성](/help/admin/tools/manage-rs/edit-settings/document-cloud-config.md)을 참조하십시오.

* [!UICONTROL **Document Cloud 분류**]

  Document Cloud 관련 분류는 [Document Cloud 분류] 페이지에서 사용할 수 있습니다. 분류에 대한 자세한 내용은 [전환 분류](/help/admin/tools/manage-rs/edit-settings/conversion-var-admin/conversion-classifications.md)를 참조하십시오.
