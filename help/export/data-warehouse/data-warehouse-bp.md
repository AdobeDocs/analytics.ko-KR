...
| 지침 | 설명 |
|--- |--- |
| 보고 및 분석에서 페이지 보기, 방문, 방문자 및 기타 표준 보고서 실행 | 데이터 웨어하우스 보고서를 만들기 전에, 찾고 있는 정보를 보고서에서 이미 사용할 수 있는지 확인하십시오. 이러한 경우, 일반적인 지표에 대해 보고 및 분석에서 수행한 사전 처리 때문에 보고서가 훨씬 더 빨리 배달됩니다. |
