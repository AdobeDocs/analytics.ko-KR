...
1. (조건부) Adobe Analytics에 이미 구성되어 있는 클라우드 계정에 대한 액세스 권한이 없는 경우에 다음 중 하나를 구성할 수 있습니다.
   ...
   1. [!UICONTROL **계정 속성**] 섹션에서 선택된 계정 유형과 관련된 정보를 지정합니다.
      ...
      **참고:** 데이터 피드, Data Warehouse 및 분류에 Amazon S3를 사용할 경우 SSE-S3 암호화만 지원됩니다.
