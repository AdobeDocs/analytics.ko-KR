...
| `mobileappperformanceappid` | Apteligent 데이터 커넥터에서 사용됩니다. Apteligent에서 사용되는 앱 ID입니다. | varchar(255) |
| `mobileappperformancecrashid` | Apteligent 데이터 커넥터에서 사용됩니다. Apteligent에서 사용되는 충돌 ID입니다. | varchar(255) |
| `mobileappstoreobjectid` | Appfigures 데이터 커넥터에서 사용됩니다. 앱스토어 개체 ID | varchar(255) |
...
| `mobilerelaunchcampaignmedium` | 모바일 서비스 시작 미디어 | varchar(255) |
| `mobilerelaunchcampaignsource` | Mobile Services 시작 소스 | varchar(255) |
| `mobilerelaunchcampaignterm` | Mobile Services 출시 기간 | varchar(255) |
| `mobilerelaunchcampaigntrackingcode` | 컨텍스트 데이터 변수 a.launch.campaign.trackingcode에서 수집됩니다. 시작 캠페인에 대한 추적 코드로 획득에 사용됩니다. | varchar(255) |
