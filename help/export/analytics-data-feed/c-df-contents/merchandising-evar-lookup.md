...
# post_product_list에서 머천다이징 eVar 인스턴스 조회

Data Feed의 [post_product_list](datafeeds-reference.md) 열에는 머천다이징 eVar 인스턴스가 포함되어 있을 수 있습니다. 각 eVar는 숫자로 표시됩니다.

post_product_list에 대한 머천다이징 eVar 인스턴스 조회가 Data Feed의 event_list 조회 열과 다릅니다.
