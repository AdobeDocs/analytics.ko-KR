...
| **의 EOL [!UICONTROL 사람] 지표** | 2023년 3월 9일 | 의 사용 중단 시 [[!DNL Device Co-op]](https://experienceleague.adobe.com/docs/discontinued/using/device-co-op.html), Device Co-op 관련 사용자 지표는 더 이상 관련이 없습니다. 2023년 5월 8일에 [!UICONTROL 사람] 지표. 이 시점에서 해당 데이터를 [!UICONTROL 고유 방문자] 지표 를 사용하십시오.<p>**참고**: [[!UICONTROL 사람] 크로스 디바이스 분석에 연결된 지표](/help/components/metrics/people.md) 은(는) 이 발표의 영향을 받지 않습니다. |
