...
| **동적 드롭다운 필터** | 패널의 보고 범위 내에 있는 데이터와 다른 드롭다운 필터의 값을 기반으로 사용 가능한 값을 결정하는 새로운 유형의 드롭다운 필터를 소개합니다. 을 누른 채로 차원을 패널 드롭 영역으로 드래그하여 동적 드롭다운 필터를 사용할 수 있습니다 [!UICONTROL Shift]. 정적 드롭다운 필터는 을 누른 채 차원 항목 그룹을 패널 드롭 영역으로 드래그하여 변경되지 않은 상태로 유지됩니다 [!UICONTROL Shift]. [자세히 알아보기](/help/analyze/analysis-workspace/c-panels/panels.md) |  | 2023년 6월 14일 |
| **업데이트된 Analytics 학습 페이지** | 이제 Adobe Analytics 랜딩 페이지의 학습 탭에 다음과 같은 개선 사항이 포함됩니다.<ul><li>탐색 기능이 개선된 단일 페이지에 더 많은 학습 콘텐츠를 표시하는 디자인 개선</li><li>경험 수준별 학습 콘텐츠 개인화 기능(초급, 중급 및 고급)</li></ul>[자세히 알아보기](/help/analyze/landing.md) |  | 30,2023년 6월 |
