...
| ----------- | ---------- | ------- | ---- |
| **새로운 Report Builder에서 보안 대상 지원** | Report Builder 추가 기능에 새로운 내보내기 대상이 추가되었습니다. 지원되는 클라우드 스토리지 대상은 다음과 같습니다. <ul><li>Amazon S3 Role ARN</li><li>Google Cloud 플랫폼</li><li>Azure SAS</li><li>Azure RBAC</li></ul> 보안 관련 문제로 인해 FTP는 더 이상 지원되지 않습니다. (참조할 설명서 링크) |  | 2025년 6월 19일(원래 6월 18일) |
