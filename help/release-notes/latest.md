...
# 현재 Adobe Analytics 릴리스 정보 (2022년 10월/11월)
...
* Report Builder의 “고정 날짜” 날짜 범위 문제가 해결되었습니다. (AN-303684)
* 데이터 피드 UI가 로드되지 않는 문제가 해결되었습니다. (AN-303803, AN-303784)
...
| 공지 | 추가 또는 업데이트 일자 | 설명 |
| ----------- | ---------- | ---------- |
| **트래픽 스파이크 알림에 대한 지침을 업데이트했습니다** | 2022년 11월 18일 | 이전 지침은 히트 볼륨을 엄격히 기준으로 했습니다. 다음 [새 지침](https://experienceleague.adobe.com/docs/analytics/admin/traffic-management/traffic-lead-time.html?lang=en) 보고서 세트 크기와 증가율의 조합을 기반으로 합니다. |
