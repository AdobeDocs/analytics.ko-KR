...
| **[!UICONTROL 게시 목록] 기능의 EOL** | 2023년 12월 13일 목요일 | Reports &amp; Analytics 서비스 중단의 일환으로 [!UICONTROL 게시 목록] 수명이 다할 예정이다. **2024년 1월 17일**. [!UICONTROL Analysis Workspace] 프로젝트를 보내거나 예약하기 위해 새 게시 목록을 만들거나 기존 [!UICONTROL 게시 목록]에 액세스할 수 없습니다. |
