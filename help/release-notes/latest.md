...
| **Analytics 처리 규칙에서 사용할 수 있는 모바일 서비스 처리 규칙** | Adobe Mobile Services 수명 종료 날짜는 2022년 12월 31일입니다. Adobe Mobile Services에서 만들거나 생성한 기존 처리 규칙은 자동으로 Adobe Analytics 처리 규칙으로 마이그레이션됩니다. 관리할 수 있지만, 제품이 종료될 때까지 Mobile Services에서 더 이상 편집할 수 없습니다. 추가 질문이 있거나 지원이 필요한 경우 Adobe 고객 지원 센터에 문의하십시오. [자세히 알아보기](https://experienceleague.adobe.com/docs/mobile-services/using/eol.html?lang=en) | 2022년 6월 15일 |
