...
| **거래 ID 보존 기간** | `transactionID` 변수는 Data Sources를 통해 업로드된 데이터에 히트가 연결할 수 있도록 거래를 고유하게 식별합니다. ID의 기본 보존 기간인 90일은 2025년 1월에 25개월로 연장됩니다. |  | 2025년 1월 22일 목요일 |
