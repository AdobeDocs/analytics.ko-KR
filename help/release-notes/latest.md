...
| **Data Workbench용 EOL** | 2022년 9월 14일 | Adobe는 **2023년 12월 31일**&#x200B;부로 Data Workbench의 서비스를 종료할 예정입니다. Data Workbench에 대한 대체 솔루션이나 질문이 있는 경우 고객 지원 담당자에게 문의하십시오. [자세히 알아보기](https://experienceleague.adobe.com/docs/data-workbench/using/eol.html) |
