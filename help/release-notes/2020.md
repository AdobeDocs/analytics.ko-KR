...
* **Experience Cloud Audience Optimization**: 이 기능을 사용하여 세그먼트를 8시간 이내에(이전의 48시간 처리 시간이 아니라) Experience Cloud에 게시할 수 있습니다. [자세히 알아보기...](https://experienceleague.adobe.com/docs/analytics/components/segmentation/segmentation-workflow/seg-publish.html)
