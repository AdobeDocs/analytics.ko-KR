...
* 스트리밍 미디어 컬렉션 추가 기능에 대한 자세한 내용은 [Analytics에서 오디오 및 비디오 측정](https://experienceleague.adobe.com/ko/docs/media-analytics/using/media-overview.html)을 참조하십시오.
