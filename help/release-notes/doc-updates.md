...
| --- | --- |
| **2022년 9월** |  |
| 처리 순서 | 다양한 도움말 페이지를 집계하여 [처리 순서](/help/technotes/processing-order.md). |
| **2022년 6월** |  |
...
| **2022년 5월** |  |
| Experience Edge를 통해 라이프사이클 차원 및 지표 채우기 | 이제 Experience Edge를 통해 전송된 모바일 라이프사이클 데이터가 Analytics 보고에 나타납니다. 자세한 내용은 [Analytics 변수 매핑](/help/implement/aep-edge/variable-mapping.md) 를 참조하십시오. |
| **2022년 4월** |  |
