...
| 거래 ID 보존 기간 변경 | 90일이었던 거래 ID 보존 기간이 25개월로 연장되었습니다. transactionID 변수는 데이터 소스를 통해 업로드된 데이터에 히트가 연결될 수 있도록 거래를 고유하게 식별합니다. [여기](/help/implement/vars/page-vars/transactionid.md) 및 [여기](/help/import/data-sources/transactionid.md)에서 자세히 알아보십시오. |
...
| 2021년 6월 3일 | [데이터 피드 구현](/help/export/analytics-data-feed/create-feed.md) 및 [여기](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl)에서 확인할 수 있는 내용을 더 잘 설명하도록 설명서가 업데이트되었습니다. |
