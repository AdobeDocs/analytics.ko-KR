...
| **2023년 7월** | |
| ADOBE EXPERIENCE PLATFORM EDGE NETWORK API | [Adobe Experience Platform Edge Network API](../implement/aep-edge/api/overview.md)를 사용하여 Adobe Analytics을 통해 데이터 수집을 구현하는 시기와 방법에 대한 포괄적인 설명서를 추가했습니다. 예를 들어 데스크탑 애플리케이션, IoT 디바이스, 셋톱 박스에서 Adobe Analytics로 데이터 수집을 구현합니다. |
