...
| --- | --- |
| **2023년 11월** | |
| Activity Map 지원 주제에 대한 업데이트 | 추가됨 [웹 SDK](https://experienceleague.adobe.com/docs/analytics/analyze/activity-map/getting-started/activitymap-enable.html?lang=en) (수동 및 Adobe Experience Platform 태그 확장 사용) 컨텐츠. |
| **2023년 10월** | |
