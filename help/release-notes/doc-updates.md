...
| --- | --- |
| **2025년 11월** | |
| VISTA 규칙에 대한 중요 고려 사항 | [Vista 규칙](/help/technotes/vista.md)과 관련된 중요 고려 사항이 업데이트되었습니다. |
| 대화형 AI 도구에 대한 데이터 열 ID가 추가되었습니다. | ref_type 열에 대화형 AI 도구에 대한 [데이터 열 참조 ID](/help/export/analytics-data-feed/c-df-contents/datafeeds-reference.md)을(를) 추가했습니다. |
| **2025년 10월** | |
| 분류 설정 | [분류 설정](/help/components/classifications/sets/overview.md) 설명서에 대한 업데이트. |
| 기여도 구성 | 모델, 컨테이너 및 전환 확인 기간에 대한 새 기여도 구성 옵션을 반영하도록 추가 업데이트. |
| 추가 방문자 식별 개선 사항 | 모든 구현 유형 전반에서 방문자를 식별하는 데 권장되는 방법을 요약하여 [방문자 식별](/help/implement/id/overview.md) 섹션을 추가했습니다. |
| **2025년 9월** | |
...
| **2025년 8월** | |
| 데이터 피드 이름은 고유해야 함 | [데이터 피드 이름이 고유해야 하는 이유](/help/export/analytics-data-feed/df-faq.md#must-feed-names-be-unique)를 명확히 했습니다. |
...
| 특정 정보는 관리자만 사용할 수 있음을 명시했습니다. | 시스템 관리자만 사용할 수 있는 [계산된 지표 관리자](/help/components/calculated-metrics/workflow/cm-manager.md) 및 [세그먼트 관리자](/help/components/segmentation/segmentation-workflow/seg-manage.md)에 “마지막 사용” 및 “다음에서 사용” 열에 대한 정보가 추가되었습니다. |
...
| **2023년 10월** | |
| 보고 활동 관리자에 로그 정보가 추가되었습니다. | 보고 활동 관리자에서 [보고 활동의 취소 및 이후 제한 사항](/help/admin/tools/reporting-activity-manager/reporting-activity-cancel-requests.md)이 [로그](/help/admin/tools/logs.md)에 캡처된다는 정보를 추가했습니다. |
...
| 트래픽 변수(prop) 개요 | 문서의 내용을 명확히 하고 개선하기 위해 섹션과 단계별 절차를 추가했습니다. “트래픽 변수 보고서 사용”이라는 제목의 문서의 콘텐츠를 병합하고 해당 문서를 제거했습니다. [트래픽 변수(prop) 개요](/help/admin/tools/manage-rs/edit-settings/c-traffic-variables/traffic-var.md) 보기 |
| 내부 URL 필터 | 문서의 내용을 명확히 하고 개선하기 위해 섹션과 단계별 절차를 추가했습니다. [내부 URL 필터 설정](/help/admin/tools/manage-rs/edit-settings/general/internal-url-filter-admin.md) 보기 |
...
| 2021년 6월 3일 | [데이터 피드 구현](/help/export/analytics-data-feed/create-feed.md) 및 [여기](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl)에서 확인할 수 있는 내용을 더 잘 설명하도록 설명서를 업데이트했습니다. |
| 2021년 5월 25일 | [보고의 eVar 대소문자 구분](/help/components/dimensions/evar.md)에 대한 설명서를 업데이트했습니다. |
...
| 2020년 11월 2일 | [분류용 FTP](/help/export/ftp-and-sftp/c-set-up-ftp-accounts/ftp-saint.md)에 대한 설명서를 업데이트했습니다. |
| **2020년 10월** | |
...
| 2019년 11월 21일 | LiveStream에서의 가용성을 나타내기 위해 [Audience Analytics 워크플로 FAQ](/help/integrate/c-audience-analytics/mc-audiences-faqs.md)를 업데이트했습니다. |
