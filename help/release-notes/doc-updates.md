...
| --- | --- |
| **2025년 7월** | |
| 처리 규칙 | 처리 규칙 설명서가 완전히 다시 작성되어 인터페이스 및 현재 사용 사례에 대한 자세한 정보가 제공됩니다. |
...
| 2019년 7월 18일 | Analysis Workspace에 대한 [“Magento: 마케팅 및 상거래”](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=ko)라는 새 작업 영역 템플릿에 대한 설명서입니다. Magento 전자 상거래 고객을 위해 특별히 고안되었지만 모든 소매업체는 이를 통해 상거래 활동에 대한 고유한 통찰력을 얻을 수 있습니다. |
