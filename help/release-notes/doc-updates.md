...
* Adobe 스트리밍 미디어 서비스에 대한 자세한 내용은 [Analytics에서 오디오 및 비디오 측정](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html?lang=ko)을 참조하십시오.
...
| --- | --- |
| **2025년 8월** | |
| 데이터 피드 이름은 고유해야 합니다. | [데이터 피드 이름이 고유해야 하는 이유](/help/export/analytics-data-feed/df-faq.md#must-feed-names-be-unique)를 명확히 설명했습니다. |
