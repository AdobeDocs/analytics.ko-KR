...
| --- | --- |
| **2025년 9월** | |
| 방문자 식별 개선 사항 | AppMeasurement에서 [`trackingServer`](/help/implement/vars/config-vars/trackingserver.md) 및 [`trackingServerSecure`](/help/implement/vars/config-vars/trackingserversecure.md) 변수의 목적에 중점을 두고 방문자 식별에 대한 모범 사례를 명확히 했습니다. |
| **2025년 8월** | |
