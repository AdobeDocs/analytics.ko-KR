...
| EOL 제품 또는 기능 | 추가 또는 업데이트 일자 | 설명 |
| --- | --- | --- |
| **[!DNL Reports & Analytics]**&#x200B;에 대한 EOL | 2024년 1월 10일 | **2024년 1월 17일**&#x200B;부로 Adobe는 [!DNL Reports & Analytics] 및 관련 보고서와 기능에 대한 서비스를 중단했습니다. [!DNL Reports & Analytics]가 제공하는 보고서, 시각화 및 기반 기술은 더 이상 Adobe의 기술 표준을 충족하지 않았습니다. 대부분의 [!DNL Reports & Analytics] 기능은 [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=ko)에서 사용할 수 있습니다. 2015년 Analysis Workspace가 출시된 이후 [!DNL Reports & Analytics] 기능이 Analysis Workspace로 이전되면서 워크플로 패리티의 한계점에 도달했습니다. [이 공지 사항](https://spark.adobe.com/page/6WnF8JK6IRDhf/)은 서비스 종료 프로세스에 대해 설명합니다.<p>2024년 1월 17일에 Adobe은 다음을 포함하여 관련된 많은 Reports &amp; Analytics 기능을 종료했습니다.</p><ul><li>예약된 보고서</li><li>데이터 추출</li><li>DL 보고서</li><li>기존 대시보드</li><li>사용자 정의 보고서</li><li>사용자 지정 전환 보고서</li><li>게시 위젯</li><li>경로 탐색 보고서</li><li>전체 경로 보고서</li><li>보고서 세트 롤업</li><li>ASI 보고서 세트</li></ul><p>2024년 1월 17일 이후에는 이러한 기능을 사용하는 모든 예약된 보고서가 더 이상 전송되지 않습니다. 또한 2024년 1월 17일부터는 이러한 기능을 사용하여 향후 보고서를 더 이상 예약할 수 없습니다.</p> |
...
AppMeasurement 릴리스(버전 2.25.0)에 대한 최신 업데이트는 [JavaScript용 AppMeasurement 릴리스 정보](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ko)를 참조하십시오.
