...
| **대소문자를 구분하지 않는 다중 값 변수** | 대소문자를 구분하지 않는 다중 값 변수의 경우, 데이터 피드의 `mvvar1 - mvvar3` 및 `post_mvvar1 - post_mvvar3`에 저장된 값은 더 이상 자동으로 소문자로 변환되지 않습니다. 대신 데이터 피드 및 Analytics 소스 커넥터를 통해 Adobe Experience Platform 및 Customer Journey Analytics로 전달된 데이터는 페이지에서 전달된 원래의 사례를 반영하게 됩니다. | 해당 없음 | 2022년 10월 24일 |
...
AppMeasurement 릴리스(버전 2.23.0)에 대한 최신 업데이트는 [JavaScript용 AppMeasurement 릴리스 정보](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ko)를 참조하십시오.
...
| ----------- | ---------- | ------- |
| 작업 영역의 콤보 차트 시각화 | 콤보 차트를 사용하면 작업 영역 내에서 서로 다른 지표를 더욱 쉽고 직관적으로 비교할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/combo-charts.html?lang=ko) | 2022년 9월 14일부터 단계적으로 롤아웃 |
...
| 기능 | 설명 | [목표 일자](releases.md) |
| ----------- | ---------- | ------- |
| Edge Collection용 XDM에서의 목록 변수 지원 | Web SDK를 사용하여 데이터를 수집하는 고객이 XDM을 사용하여 목록 변수 콘텐츠를 지정할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/list.html?lang=ko#list-variables-using-the-web-sdk) | 2022년 8월 18일 |
| 제품 문자열 변수를 설정할 때 Edge Collection용 XDM의 SKU 필드 사용 | Web SDK를 사용하여 데이터를 수집하는 고객이 SKU 값을 사용하여 제품 변수의 제품 필드를 설정할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/products.html?lang=ko#products-using-the-web-sdk) | 2022년 8월 18일 |
...
| 기능 | 설명 | [목표 일자](releases.md) |
| ----------- | ---------- | ------- |
| Edge Collection용 XDM에서의 머천다이징 변수 지원 | Web SDK를 통해 데이터를 수집하는 고객이 XDM을 사용하여 머천다이징 변수(eVar)에 대한 다양한 값을 지정할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/evar-merchandising.html?lang=ko) | 2022년 6월 29일 |
