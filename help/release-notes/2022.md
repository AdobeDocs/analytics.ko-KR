...
| 기능 | 설명 | [목표 일자](releases.md) |
| ----------- | ---------- | ------- |
| Edge Collection용 XDM에서의 머천다이징 변수 지원 | Web SDK를 통해 데이터를 수집하는 고객이 XDM을 사용하여 머천다이징 변수(eVar)에 대한 다양한 값을 지정할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/evar-merchandising.html) | 2022년 6월 29일 |
