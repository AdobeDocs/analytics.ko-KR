...
* 작업 영역 프로젝트가 열리지 않는(제한 시간을 초과하고 열리는) 문제를 해결했습니다. (AN-247248)
...
* [보고의 eVar 대소문자 구분](https://experienceleague.adobe.com/docs/analytics/components/dimensions/evar.html)에 대한 설명서를 업데이트했습니다. (AN-246438)
* [데이터 피드 구현](https://experienceleague.adobe.com/docs/analytics/export/analytics-data-feed/create-feed.html?lang=ko) 및 [여기](https://experienceleague.adobe.com/docs/analytics/export/analytics-data-feed/df-faq.html#BucketOwnerFullControl)를 더 잘 설명하도록 설명서를 업데이트했습니다. (AN-219485)
...
| 기능 | [일반 가용성](releases.md) - 대상 날짜 | 설명 |
| ----------- | ---------- | ------- |
| 작업 영역: 이전 프로젝트 버전 | 2021년 5월 20일 | 이전 버전의 작업 영역 프로젝트를 로드하여 원하지 않는 변경 내용을 실행 취소하거나 간단히 이전 버전으로 되돌릴 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/save-projects.html?lang=ko#previous-version) |
...
| 맞춤형 날짜 범위에 대한 Analytics 대시보드 지원 | 2021년 4월 22일 | 스코어카드 작성자는 모바일 스코어카드 프로젝트에 맞춤형 날짜 범위를 만들고 적용할 수 있습니다. 작성자는 익숙한 작업 영역 및 모바일 날짜 범위 사전 설정에서 선택하거나 맞춤형 날짜 범위를 만들 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/curator.html?lang=ko#mobapp) |
...
* [!UICONTROL 작업 영역]에서 A4T [!UICONTROL 산정된 지표]와 관련된 오류가 발생하는 문제를 해결했습니다. (AN-247082)
