...
| 공지 | 추가 또는 업데이트 일자 | 설명 |
| ----------- | ---------- | ---------- |
| **Adobe Experience Platform Edge Network에 대한 전체 IP 난독화** | 2023년 9월 27일 | Adobe은 2023년 10월에 Edge Network에서 발생한 히트에 대한 IP 난독화를 업데이트할 계획입니다. 지난 4월, Edge Network는 IP 주소를 난독화하는 기능을 추가했습니다. 당시 Adobe Analytics은 Analytics가 Edge Network의 히트를 처리하는 방식으로 인해 IP의 부분 난독화만 지원했습니다. 고객이 Edge Network에 대해 전체 난독화를 선택한 경우 Analytics는 부분적으로 난독화된 IP만 수신했습니다. 이 변경 사항이 구현되면 Analytics는 완전히 난독화된 IP를 수신합니다. |
...
| 공지 | 추가 또는 업데이트 일자 | 설명 |
| ----------- | ---------- | ---------- |
| **난독화된 IP 주소 수신 지원** | 2023년 9월 27일 | Adobe은 Adobe Experience Platform Edge Network에서 발생하는 히트에 대해 IP 난독화를 업데이트할 계획입니다. 2023년 4월에 Edge Network가 IP 주소 난독화 기능을 추가했습니다. 당시 Adobe Analytics은 Analytics가 에지 네트워크의 히트를 처리하는 방식으로 인해 IP의 부분 난독화만 지원했습니다. 고객이 Edge Network에 대해 전체 난독화를 선택한 경우 Analytics는 부분적으로 난독화된 IP만 수신했습니다. 이 변경 사항으로 인해 이제 Analytics가 완전히 난독화된 IP를 수신합니다. |
