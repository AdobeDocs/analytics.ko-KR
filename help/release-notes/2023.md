...
| 공지 | 추가 또는 업데이트 일자 | 설명 |
| ----------- | ---------- | ---------- |
| **난독화된 IP 주소 수신 지원** | 2023년 9월 27일 | Experience Edge에서 발생하는 히트에 대한 IP 난독화가 업데이트됩니다. 2023년 4월에 Experience Edge에서 IP 주소 난독화 기능이 추가되었습니다. 당시 Adobe Analytics은 Analytics가 Experience Edge의 히트를 처리하는 방식으로 인해 IP의 부분 난독화만 지원했습니다. 고객이 Experience Edge에 대해 전체 난독화를 선택한 경우 Analytics는 부분적으로 난독화된 IP만 수신했습니다. 이 변경 사항으로 인해 이제 Analytics에서 완전히 난독화된 IP를 수신하게 됩니다. |
