...
| 기능 | 설명 | [롤아웃 시작](releases.md) | [일반 가용성](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **데이터 개인정보 보호 레이블에 대한 업데이트된 사용자 인터페이스** | 인터페이스를 업데이트하면 보고서 세트 구성 요소에 대한 데이터 개인정보 보호 레이블을 생성, 관리 및 편집하는 프로세스를 간소화합니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/data-labels/gdpr-setup-reportsuite.html) | 해당 사항 없음 | 2023년 2월 8일 |
