...
| **데이터 피드 내보내기를 위한 보안 대상** | 이제 데이터 피드를 다음 클라우드 스토리지 대상으로 보낼 수 있습니다.<ul><li>Amazon S3</li><li>Azure RBAC</li><li>Azure SAS</li><li>Google Cloud Platform</li></ul>이전에 사용할 수 있었던 대상(FTP, SFTP, S3 및 Azure Blob)은 더 이상 권장되지 않습니다. [자세히 알아보기](/help/export/analytics-data-feed/create-feed.md) | 2023년 6월 12일 화요일 | 2023년 7월 13일 금요일 |
...
| **데이터 피드 내보내기를 위한 보안 대상** | 이제 데이터 피드를 다음 클라우드 스토리지 대상으로 보낼 수 있습니다.<ul><li>Amazon S3</li><li>Azure RBAC</li><li>Azure SAS</li><li>Google Cloud Platform</li></ul>이전에 사용할 수 있었던 대상(FTP, SFTP, S3 및 Azure Blob)은 더 이상 권장되지 않습니다. [자세히 알아보기](/help/export/analytics-data-feed/create-feed.md) |  | 2023년 6월 12일 화요일 |
...
| 기능 | 설명 | [롤아웃 시작](releases.md) | [일반 가용성](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **데이터 개인정보 보호 레이블에 대한 업데이트된 사용자 인터페이스** | 인터페이스를 업데이트하면 보고서 세트 구성 요소에 대한 데이터 개인정보 보호 레이블을 생성, 관리 및 편집하는 프로세스를 간소화합니다. [자세히 알아보기](/help/admin/tools/privacy-labeling/labeling-overview.md) | 해당 사항 없음 | 2023년 2월 8일 |
...
| **프로젝트 관리자 페이지가 더 이상 사용되지 않음** | 새 랜딩 페이지 릴리스로 **[!UICONTROL Adobe Analytics]** > **[!UICONTROL 구성 요소]**&#x200B;에 나열된 것처럼 **[!UICONTROL 프로젝트 관리자]**&#x200B;는 더 이상 사용되지 않습니다. 새 랜딩 페이지에는 이전 프로젝트 관리자 페이지의 모든 기능들이 있습니다. 자세히 알아보기 | 해당 사항 없음 | 2023년 1월 11일 목요일 |
