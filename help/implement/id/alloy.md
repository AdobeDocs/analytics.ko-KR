...
ID 데이터는 XDM의 [`identityMap`](https://experienceleague.adobe.com/ko/docs/experience-platform/collection/identity/identity-map)을(를) 사용하여 사용자 지정 ID 및 여러 네임스페이스를 지원하도록 확장할 수 있습니다. Adobe에서는 고급 시나리오에 다른 ID 관리 옵션을 사용하여 ECID를 Analytics의 기본 식별자로 사용하는 것이 좋습니다.
