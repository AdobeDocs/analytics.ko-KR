...
Adobe Experience Platform의 태그를 사용하면 웹 사이트(Analytics 포함)에 CX 엔터프라이즈 솔루션을 통합할 수 있습니다. 이 페이지에서는 태그 관리자가 기본 Adobe Analytics 구현을 올바르게 구성하는 방법을 간략하게 설명합니다.
...
1. CX 엔터프라이즈 조직 ID 를 포함한 모든 설정은 이미 작성되어 있어야 합니다. **[!UICONTROL 저장을]** 클릭합니다.
