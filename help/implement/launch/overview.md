...
* [Launch 설명서](https://experienceleague.adobe.com/docs/launch/using/overview.html?lang=ko-KR): 인터페이스 작동 방식과 사용 가능한 확장에 대해 알아봅니다.
* [Adobe Analytics 확장](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/analytics-extension/overview.html?lang=ko-KR): Analytics 확장을 사용하여 데이터를 Adobe Analytics에 보냅니다.
