...
1. Analytics 변수를 Analytics 확장에서 구성된 것과 동일한 해당 값으로 설정합니다.
   ...
   * 사용자 지정 코드의 Analytics 구성 변수 및 메서드 호출에는 수정된 구현 논리가 필요할 수 있습니다. 각 [변수](/help/implement/vars/overview.md)을(를) 참조하여 Web SDK를 사용하여 이와 동등한 기능을 달성하는 방법을 결정하십시오.
1. Web SDK 확장을 사용하여 모든 규칙 논리가 복제되면 **[!UICONTROL 변경 내용 유지]**&#x200B;를 선택합니다.
