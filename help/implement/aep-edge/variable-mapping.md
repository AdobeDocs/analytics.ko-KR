...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list[].value` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list[].value` | 모두 연결 `value` 각 `list[]` 해당 [목록 변수](../vars/page-vars/list.md). |
