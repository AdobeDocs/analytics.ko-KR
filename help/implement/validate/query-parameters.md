...
| `pe` | [`linkType`](../vars/config-vars/linktype.md) | 사용자 지정 링크의 유형을 결정합니다. [사용자 지정 링크](/help/components/dimensions/custom-link.md), [다운로드 링크](/help/components/dimensions/download-link.md) 및 [종료 링크](/help/components/dimensions/exit-link.md)에 필요합니다. |
