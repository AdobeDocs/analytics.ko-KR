---
title: 기존 디버거
description: 기존 디버거를 설치합니다. 이 디버거는 Analytics, Target, Advertising, Identity Service 및 데이터 수집 태그를 검사합니다.
...
3. 이름 필드에서 &quot;Legacy Debugger&quot;로 레이블을 지정하고 코드 스니펫을 URL 필드에 붙여넣습니다.
...
2. 구성 > 새 책갈피를 클릭합니다.
3. 이름 필드에서 &quot;Legacy Debugger&quot;로 레이블을 지정하고 코드 스니펫을 위치 필드에 붙여넣습니다. 태그 및 키워드 필드는 필수가 아닙니다.
