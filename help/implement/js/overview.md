...
AppMeasurement for JavaScript는 지금까지 Adobe Analytics를 구현하는 일반적인 방법이었습니다. 그러나 Tag Management 시스템의 인기가 높아짐에 따라 Adobe Experience Platform](../launch/overview.md)에서 [태그를 사용하는 것이 좋습니다.
