...
**장치 간 방문자 식별과 장치 간 분석의 차이점은 무엇입니까?**
...
크로스 디바이스 분석은 Adobe의 최신 크로스 디바이스 방문자 식별 방법입니다. 여기에서는 Experience Cloud ID 서비스 및 장치 그래프를 사용하여 서로 다른 장치들에서의 방문을 소급하여 통합합니다. CDA를 사용하려면 동일한 방문자가 사용하는 장치를 판별하는 `setCustomerIDs` 함수를 사용해야 합니다.
