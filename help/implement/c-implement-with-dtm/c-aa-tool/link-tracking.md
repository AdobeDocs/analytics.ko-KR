...
<table id="table_F23FB0B284E74B66A107B1D69D22A51C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>방문자 클릭 맵 데이터를 모으는지 여부를 결정합니다. </p> <p><a href="/help/implement/js-implementation/c-variables/configuration-variables.md"  >s.trackInlineStats</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 다운로드 링크 추적 </td> 
   <td colname="col2"> <p>사이트의 다운로드 가능 파일에 대한 링크를 추적합니다. </p> <p><a href="/help/implement/js-implementation/c-variables/configuration-variables.md">구성 변수</a>를 참조하십시오.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 확장 기능 다운로드 </td> 
   <td colname="col2"> <p>나열된 확장자를 가진 파일에 대한 링크가 사이트에 포함된 경우 해당 링크의 URL이 보고에 나타납니다. </p><a href="/help/implement/js-implementation/c-variables/configuration-variables.md">구성 변수</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 아웃바운드 링크 추적 </td> 
   <td colname="col2"> <p>클릭한 링크가 종료 링크인지 여부를 결정합니다. </p> <p><a href="/help/implement/js-implementation/c-variables/configuration-variables.md">구성 변수</a>를 참조하십시오. </p> <p><b>단일 페이지 앱 고려 사항: </b>일부 SPA 웹 사이트의 코딩 방식 때문에 SPA 사이트의 페이지에 대한 내부 연결이 아웃바운드 링크로 보일 수 있습니다. </p> <p>다음 방법 중 하나를 사용해 SPA 사이트에서 유래한 아웃바운드 링크를 추적할 수 있습니다. </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>쿼리 문자열을 유지합니다. </p> <p><a href="/help/implement/js-implementation/c-variables/configuration-variables.md">구성 변수</a>를 참조하십시오. </p> </td> 
  </tr> 
 </tbody> 
</table>
