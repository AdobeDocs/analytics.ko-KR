...
이때 Switcher 플러그인을 이용하면 가장 쉽게 테스트할 수 있습니다. 자세한 내용은 다이내믹 태그 관리 제품 설명서의 [Search Discovery 플러그인](https://marketing.adobe.com/resources/help/ko_KR/dtm/search_discovery_plugins.html)을 참조하십시오.
