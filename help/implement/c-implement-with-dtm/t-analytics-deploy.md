...
1. [!UICONTROL 다이내믹 태그 관리에서]웹 속성을 [만듭니다](../../implement/c-implement-with-dtm/t-create-web-property.md#task_960467FBB7A54499AC228CB3AA3C4123).
...
1.  Analytics 도구를 속성에 추가합니다. 
   ...
   1. **[!UICONTROL 개요]** 탭에서 도구 **[!UICONTROL 추가를]**&#x200B;클릭합니다.
...
1. **[!UICONTROL 일반을 클릭하고]** 핵심 Appmeasurement 코드를 [삽입합니다](../../implement/c-implement-with-dtm/c-aa-tool/t-appmeasurement-code.md#task_068D72664B2743359A64ADB8692D3658).
...
1. (Optional) Click **[!UICONTROL Settings]** ![](assets/settings_gear.png) on the Options tab, and configure the Adobe Analytics code.
   ...
   >[!NOTE]
   >
   >[!UICONTROL Adobe Analytics] 페이지의 설정 (일반, 쿠키 등) 는 `s_code`의 설정을 무시합니다. 이러한 설정이 `s_code`에 있을 경우에는 여기에서 반복할 필요가 없습니다.
