...
[!DNL Android] SDK 버전 4.13.4 (2017 년 2 월 16 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
[!DNL Android] SDK 버전 4.13.3 (2017 년 1 월 19 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
[!DNL Android] SDK 버전 4.13.2 (2016 년 11 월 10 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
[!DNL Android] SDK 버전 4.13.1 (2016 년 10 월 20 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
[!DNL Android] SDK 버전 4.13.0 (2016 년 9 월 15 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
<table frame="all" colsep="1" rowsep="1" id="table_6DE145BC30154B9FADCE584A9737018D"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   <td colname="1"> 옵트아웃 및 개인 정보 설정 </td> 
   <td colname="2"> <p><span class="keyword"> Android</span> SDK 4.8.3 부터 시작하여 <code> setprivacystatus</code> 메서드를 통해 설정된 개인 정보 설정은 <span class="keyword"> Analytics</span>, <span class="keyword"> Target</span> 및 <span class="keyword"> Audience Manager의 활동에 영향을</span>줍니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
[!DNL Android] SDK 버전 4.8.0 (2015 년 11 월 2 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
[!DNL Android] SDK 버전 4.6 (2015 년 9 월 17 일) 에는 다음 변경 내용이 포함되어 있습니다.
...
[!DNL Android] SDK 버전 4.5 에는 다음 변경 사항이 포함되어 있습니다.
...
<table frame="all" colsep="1" rowsep="1" id="table_BF98A1E904EB4314828AC58A2A6E7016"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p><span class="keyword"> Android</span> SDK 버전 4.5 부터 새로운 <span class="keyword"> Android</span> 확장 기능을 사용하면 <span class="keyword"> Android</span> Wearable 앱의 데이터를 수집할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
[!DNL Android] SDK 버전 4.4 에는 다음 변경 사항이 포함되어 있습니다.
...
[!DNL Android]Marketing Cloud 솔루션용 SDK 4.x는 현재 다음과 같은 새로운 기능을 제공합니다.
...
* [!DNL Android] 3. x 및 4. x 호환성을 추가했습니다.
