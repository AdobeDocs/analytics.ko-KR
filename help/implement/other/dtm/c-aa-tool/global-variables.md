...
| 요소 | 설명 |
|--- |--- |
| 서버 | 사전 정의된 변수가 Adobe Analytics의 서버 차원을 채웁니다. See [Server](../../../vars/page-vars/server.md). |
...
| 동적 변수 접두사 | 값의 시작 앞부분에 붙는 특수한 접두사입니다. 기본 접두사는 &quot;D=&quot;입니다. [동적 변수]를 참조하십시오(../../../vars/page-vars/dynamic-variables.md) |
