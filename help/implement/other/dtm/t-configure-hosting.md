...
호스팅에 대한 자세한 내용은 다이내믹 태그 관리 제품 문서에서 [내장 코드 및 호스팅 옵션](https://marketing.adobe.com/resources/help/ko_KR/dtm/deployment.html)을 참조하십시오.
...
<table id="table_229298207DB64838B6F2477DFFAE073F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 가장 간단히 구현할 수 있는 호스팅 옵션입니다. </p> <p>글로벌하게 분산된 게재 네트워크입니다. </p> <p>추가적인 타사 인프라 종속성(DNS 조회, Akamai 가용성)을 추가합니다. </p> <p>자세한 내용은 Dynamic Tag Management 제품 설명서에서 <a href="https://marketing.adobe.com/resources/help/ko_KR/dtm/akamai.html">Akamai</a>를 참조하십시오. </p> </td> 
   <td colname="col3"> 
