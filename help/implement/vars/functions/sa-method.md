...
1. 아래 [!UICONTROL 데이터 스트림]를 눌러 각 환경의 드롭다운 목록에서 원하는 데이터 스트림을 선택합니다.
...
자세한 내용은 [웹 SDK 구성](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/configuring-the-sdk.html?lang=ko-KR) 를 참조하십시오.
