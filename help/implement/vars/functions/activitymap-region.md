...
description: Activity Map이 클릭한 영역을 수집하는 방법을 사용자 지정합니다.
feature: Variables
...
* 클릭한 HTML 요소를 받습니다.
* 문자열 값을 반환합니다. 이 문자열 값은 [Activity Map 영역](/help/components/dimensions/activity-map-region.md) 차원에 사용되는 최종 값입니다.
