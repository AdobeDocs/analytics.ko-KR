...
쿠키 라이프타임은 아래 드롭다운 목록입니다. [!UICONTROL 쿠키] Adobe Analytics 확장을 구성할 때 아코디언

1. AdobeID 자격 증명을 사용하여 [Adobe Experience Platform 데이터 수집](https://experience.adobe.com/data-collection)에 로그인합니다.
1. 원하는 태그 속성을 클릭합니다.
1.  [!UICONTROL 확장] 탭으로 이동한 다음, Adobe Analytics 아래의 **[!UICONTROL 구성]** 버튼을 클릭합니다.
1. 확장 [!UICONTROL 쿠키] 아코디언 - [!UICONTROL 쿠키 수명] 드롭다운 목록입니다.
...
* **초**: 지정된 초 수가 경과하면 쿠키가 만료됩니다. 예를 들어 이 드롭다운 목록을 다음으로 설정 [!UICONTROL 초] 및 배치 `86400` 를 사용자 지정 필드에 입력하면 쿠키가 정확히 24시간 후에 만료됩니다.
