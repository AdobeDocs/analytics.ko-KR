...
통화 전환은 각 히트에 대해 다음 논리를 사용합니다. 이 단계는 [`products`](../page-vars/products.md) 변수로 설정된 매출 값과 보고서 세트 설정의 [성공 이벤트](/help/admin/tools/manage-rs/edit-settings/conversion-var-admin/c-success-events/success-event.md)에서 &#39;통화&#39;로 나열된 모든 이벤트에 적용됩니다.
