...
이 필드를 비워 두면 기본값은 `[rsid]sc.adobedc.net`로 설정됩니다.
...
조직에서 이미 `sc.adobedc.net` 또는 도메인에서 타사 추적 서버를 사용하고 있을 수 `2o7.net` 있습니다.  이러한 템플릿은 주로 이전 버전의 Adobe Analytics에서 사용되었으며 여전히 유효합니다.
