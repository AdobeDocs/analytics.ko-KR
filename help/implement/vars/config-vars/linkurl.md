...
Analysis Workspace에는 이 변수에 대해 보고하는 차원이 없습니다. [데이터 피드](/help/export/analytics-data-feed/data-feed-overview.md)에서 `page_event_var1` 열을 채웁니다. 클릭한 링크의 URL을 추적하려면 [Prop](../page-vars/prop.md)과 같은 사용자 지정 변수를 사용하는 것이 좋습니다. [Activity Map](/help/analyze/activity-map/overview.md)을 사용하면 클릭한 링크에 대한 데이터 수집을 간소화할 수 있습니다.
