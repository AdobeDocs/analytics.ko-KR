...
Adobe에서는 Adobe Analytics를 구현하는 방법을 여러 가지 제공합니다. 각 페이지에는 Adobe Experience Platform 및 AppMeasurement for JavaScript에서 태그를 사용하여 변수를 구현하는 방법에 대한 섹션이 있습니다.
...
2. 데이터 계층을 사용하여 Analytics 변수를 채웁니다. Adobe Experience Platform에서 태그를 사용하는 경우 데이터 요소를 사용한 다음, 데이터 요소를 변수에 할당하여 이 작업을 쉽게 수행할 수 있습니다. [데이터 요소](https://experienceleague.adobe.com/docs/experience-platform/tags/ui/data-elements.html)를 참조하십시오.
