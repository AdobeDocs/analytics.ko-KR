...
Adobe Analytics®는 온라인 전략 및 마케팅 이니셔티브에 대하여 실용적인 실시간 인텔리전스를 조직에 제공합니다. Adobe Analytics는 Datran과 결합하여 행동 타깃팅을 기반으로 리마케팅을 제공합니다. Datran 및 Adobe Analytics 웹 분석 데이터의 원활한 통합을 통해 타깃 마케팅을 향상시키고 캠페인 효과를 파악할 수 있습니다.
