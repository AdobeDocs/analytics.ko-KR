...
1. 데이터 **커넥터 UI** 왼쪽에 있는 **파트너 목록** 상단에 있는 알파벳 탭을 클릭한 다음 **Datran** 아이콘을 찾습니다.
1. 데이터 커넥터 통합 마법사를 시작하려면 **Adobe Analytics 보고서 세트의 빈 플러그인 슬롯으로 Datran** 아이콘을 드래그합니다.

1. Datran 통합 소개 페이지에서 텍스트를 검토하고 이 확인란을 선택하여 통합과 연관된 요금을 수락한 후 **다음을 클릭합니다**.
...
<table id="table_74EC1EEBE7A548AB878AA40187EBCD30"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>Datran 계정 ID (Datran에서 조직에 할당된 고유 식별자) 를 지정하고 <b>다음을</b> 클릭하여 마법사의 3 단계로 진행합니다. </p> </td> 
  </tr> 
  <tr valign="top"> 
