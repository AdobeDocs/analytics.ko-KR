...
seo-description: 다음 지표는 Appfigures 통합의 일부로 동기화됩니다.
seo-title: 지표 및 차원
title: 지표 및 차원
...
다음 지표는 Appfigures 통합의 일부로 동기화됩니다.
...
다음 예약된 분류 차원은 Appfigures 개체 ID 예약된 evar의 데이터 커넥터 마법사에서 만듭니다.

| 분류 차원 | 설명 |
|---|---|
| 국가 이름 | 앱스토어 활동과 관련된 국가의 이름입니다. |
| 장치 이름 | 앱스토어 활동과 관련된 모바일 장치의 이름입니다. |
| Appstore 이름 | 활동을 보고한 Appstore의 이름. |
| 애플리케이션 이름 | 모바일 애플리케이션의 이름입니다. |
| 인앱 이름 | 애플리케이션 내에서 구매한 항목. |
| 카테고리 이름 | App Store에서 앱의 기본 카테고리. |
| 리뷰 제목 | 검토 제목입니다. |
| 리뷰 댓글 | 검토 주석 |
| 애플리케이션 버전 | 검토를 생성하는 데 사용한 응용 프로그램의 버전. |
| 앱스토어 사용자 | 검토 작성자 (사용자 이름). |

다음 계산된 지표는 데이터 커넥터 마법사에서 만듭니다.

<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> 계산된 지표 </th> 
   <th colname="col2" class="entry"> 설명 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> 앱스토어 평균 등급 (숫자) </td> 
   <td colname="col2"> <p>평균 앱 순위. 이 계산된 지표는 다음 공식을 사용하여 정의됩니다. </p> <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; 등급] &amp; amp; nbsp; /amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; 등급 및 amp; nbsp; 분류기] </code> <p>참고: 카테고리별로 등급이 매겨진 애플리케이션 수는 앱 스토어에 따라 다릅니다. 애플리케이션의 등급이 이 임계값보다 낮은 경우 애플리케이션 등급을 사용할 수 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 앱스토어 평균 등급 </td> 
   <td colname="col2"> 평균 앱 등급. 이 계산된 지표는 다음 공식을 사용하여 정의됩니다. <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; 등급 (&amp; amp); nbsp; /amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; 등급 및 AMP; nbsp; 분류기] </code> </td> 
  </tr> 
 </tbody> 
</table>
...
다음 표는 어떤 보고서 차원이 지표와 관련이 있는지 보여줍니다.
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   ...
   <td> 앱스토어 등급 분류기 </td> 
   <td> 앱스토어 매출 (인앱) </td> 
   <td colname="col9"> 앱스토어 매출 (일회성) </td> 
   <td colname="col10"> 앱스토어 평균 등급 </td> 
   <td colname="col11"> 앱스토어 평균. 등급 </td> 
  </tr> 
  <tr> 
   <td> 국가 이름 </td> 
