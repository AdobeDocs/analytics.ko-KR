...
* ** [!DNL ~파트너~]: ** 통합을 사용하려면 Analytics 변수 (evar) 내에서 이메일 주소를 캡처하여 저장해야 합니다. " [!DNL ~파트너~]"는 사이트의 다운스트림 방문자 행동과 관련되어 있습니다 (장바구니 포기, 구매 등). [!DNL ~파트너~] 시스템으로 가져와 리마케팅용으로 활용할 수 있습니다. 설정 프로세스의 일부로 마법사에서 메시지가 표시되었을 때 이러한 용도로 Evar를 식별해야 합니다.
