...
이 통합에서 사용할 이벤트 및 eVar를 식별한 후 Adobe Analytics 관리 콘솔에서 활성화되어야 합니다(지침은 [보고서 세트](https://experienceleague.adobe.com/docs/analytics/admin/manage-report-suites/report-suites-admin.html) 참조).
