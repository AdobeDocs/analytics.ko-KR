...
Adobe Analytics 데이터 소스를 사용하면 추가적인 온라인 또는 오프라인 데이터를 가져와서 보고에 사용할 수 있습니다. 웹 사이트 외부의 비즈니스 측면과 사이트와의 상호 작용 방식을 이해하는 데 도움이 됩니다. 데이터 소스를 사용하는 일반 워크플로우는 다음 단계로 구성됩니다.
