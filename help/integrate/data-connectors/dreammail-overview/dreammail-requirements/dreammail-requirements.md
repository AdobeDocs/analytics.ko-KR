...
* **사용 가능하고 구성된 Analytics 변수:** 이 통합을 사용하려면 사용자 지정 이벤트와 사용자 지정 Evar 및 선택적으로 추가 이벤트와 추가 evar가 필요합니다. [Analytics 통합 변수를 참조하십시오](../../dreammail-overview/dreammail-requirements/dreammail-variables.md#concept-8ebd2bde4a1c4b0aad2987e050ffbbfc).
