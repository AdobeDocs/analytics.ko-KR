...
* Analytics 공유 세그먼트를 MCA 차원과 다시 Experience Cloud에 공유하시겠습니까?
...
아니요. Audience Manager 대상 지원 중 또는 후에 그리고 세그먼트 자격 조건 중/후에 사이트를 방문한 사람과 관련된 데이터만 제공합니다.

+++

+++ 이렇게 하면 세그먼트당 총 주소 지정 가능한 대상이 제공됩니까?

실제로 그렇지 않습니다. 세그먼트 자격 조건 중 또는 후에 사이트로 돌아온 해당 세그먼트의 방문자 수를 알려 줍니다.
