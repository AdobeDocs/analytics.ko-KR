  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_71E0ECD5981D4B65BCDA065BE07A43AA"> 
     ...
     <li id="li_57A8B4C7BB784FFCBC1DC363B35D9FF7">해당 국가에서 IP 주소 PII로 고려하는 경우 <a href="https://marketing.adobe.com/resources/help/ko_KR/reference/exclude_IP.html"  >IP 난독화를 켭니다</a>. </li> 
...
<table id="table_15B44592161240BDA79F3B020EA9CC9D"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <a href="https://marketing.adobe.com/resources/help/en_US/aam/create-analytics-destination.html"  >AAM에서 Analytics 대상 구성</a>을 참조하십시오. </td> 
  </tr> 
  <tr> 
...
이 항목에 대한 자세한 FAQ는 [서버측 전달 FAQ](/help/admin/admin/c-server-side-forwarding/ssf-faq.md)를 참조하십시오.
...
<table id="table_1F7C0C785F9C472286A96F8C25E8440B"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>자세한 내용은 <a href="/help/integrate/c-audience-analytics/aam-analytics-segments.md"  > Analytics 및 Audience Manager의 세그먼트 이해 </a>. </p> <p>AAM 대상이 전송되어 Analytics에서 사용할 "차원" 구성 요소로 공유됩니다. 세그먼트 빌더에서는 세그먼트로 표시되지 않지만, 세그먼트를 만들 수 있는 차원으로 표시됩니다. </p> </td> 
  </tr> 
  <tr> 
