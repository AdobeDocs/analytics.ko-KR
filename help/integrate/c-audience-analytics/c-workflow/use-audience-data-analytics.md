...
1. **[!UICONTROL 차원]** 목록에서 **[!UICONTROL 대상 ID]** 또는 **[!UICONTROL 대상 이름]** 차원을 선택합니다. 이름은 ID를 친숙한 방식으로 분류합니다.
...
1. **[!UICONTROL 구성 요소]** 메뉴에서 [!UICONTROL 대상 이름]을(를) 검색합니다.
...
1. [!UICONTROL 대상 이름] 차원을 흐름 빌더로 끌어 옵니다.
1. **[!UICONTROL 작성을 클릭합니다]**.
...
대상자는 [폴아웃 시각화](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md)에서도 사용할 수 있습니다.

## Analysis Workspace의 벤 시각화 {#venn}

[벤 시각화](/help/analyze/analysis-workspace/visualizations/venn.md)는 최대 3개의 세그먼트 간 겹침을 표시합니다.

1. **[!UICONTROL 작업 영역]**&#x200B;으로 이동하여 왼쪽 레일에서 **[!UICONTROL 벤]** 시각화를 선택합니다.

1. 구성 요소 메뉴에서 [!UICONTROL 대상 이름]을(를) 검색합니다.
1. 관련 차원 항목이 표시되도록 [!UICONTROL 대상 이름]을 여십시오.
...
1. 세그먼트 이름을 지정한 후 [!UICONTROL 대상 이름] 차원을 정의 패널로 드래그합니다.
