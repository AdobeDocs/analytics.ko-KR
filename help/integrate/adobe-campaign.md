...
>[!IMPORTANT]
>이 문서는 Adobe Campaign **Standard** 보고에만 적용됩니다. Adobe Campaign **Classic** 보고를 추가하려면 [여기](/help/integrate/analytics-to-campaign-classic.md)를 참조하십시오.
...
* **[!UICONTROL Adobe Campaign 실행 배달 ID]**: Adobe Campaign에서 보낸 전자 메일에 대해 Adobe Campaign에서 가져온 데이터를 표시합니다. |
...
Adobe Analytics 보고서 세트의 Campaign에서 다음 **지표**&#x200B;을(를) 사용할 수 있습니다.

* Adobe Campaign 전송됨
* Adobe Campaign 열림
* Adobe Campaign 클릭됨
* Adobe Campaign 전달됨
* Adobe Campaign 고유 오픈
* Adobe Campaign 고유 클릭
* Adobe Campaign 구독 취소됨
* Adobe Campaign 총 바운스 수
* Adobe Campaign 수행된 게재 ID 인스턴스 수

Adobe Analytics 보고서 세트의 Campaign에서 다음 **차원**&#x200B;을(를) 사용할 수 있습니다.

| Dimension 이름 | 정의 |
| --- | --- |
| 캠페인 ID | 해당 기간 동안 KPI가 전송된 모든 캠페인의 ID |
| 캠페인 레이블 | 캠페인 ID 레이블 |
