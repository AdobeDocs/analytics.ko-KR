...
+ Audience Analytics {#audience-analytics}
   ...
   + Audience Analytics 워크플로우 {#audience-analytics-workflow}
      ...
      + [서버 측 전달 개요 - 관리 안내서](/help/admin/admin/c-server-side-forwarding/ssf.md)
      + [GDPR/ePrivacy 준수 및 서버 측 전달 - 관리 가이드](/help/admin/admin/c-server-side-forwarding/ssf-gdpr.md)
