...
* Google/Bing 검색 데이터를 보려는 Analytics 보고서 세트는 [Experience Cloud 조직에 매핑](https://experienceleague.adobe.com/docs/core-services/interface/about-core-services/report-suite-mapping.html?lang=ko-KR)되어 있어야 합니다.
