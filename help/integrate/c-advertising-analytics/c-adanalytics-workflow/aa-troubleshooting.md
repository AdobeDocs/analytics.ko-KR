...
[새 Advertising 계정을 설정](/help/integrate/c-advertising-analytics/c-adanalytics-workflow/aa-create-ad-account.md)하려고 하는데 보고서 세트가 **[!UICONTROL 매핑된 보고서 세트]** 드롭다운 목록에 표시되지 않습니다. 여기에는 두 가지 가능한 이유가 있습니다.
...
<table id="table_271D7E817B4C44818717A47C3223E592"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>1. 보고서 세트가 로그인 사용자의 CX Enterprise 조직 ID에 매핑되지 않았습니다. </p> </td> 
   <td colname="col2"> <p>보고서 세트를 조직 ID에 매핑하려면 고객 지원 센터에 문의하십시오.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>2. 보고서 세트가 Advertising Analytics 보고에 프로비저닝되지 않습니다. </p> </td> 
